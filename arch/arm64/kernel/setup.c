...
-------------------------------------------------------------------------
|-----------------------------------------------------------------------|
| Channel A (128M)      | 0x28000000 ~ 0x2D5FFFFF |  86M | ?????        |
...
static void hisi_reserve(void)
{
	...
	memblock_remove(0, 0x200000);
	//memblock_remove(HISI_RESERVED_MEM_START, HISI_RESERVE_MEM_SIZE);
	memblock_remove(HISI_RESERVED_MEM_START, hisi_reserved_graphic_phymem - HISI_RESERVED_MEM_START);
	memblock_reserve(hisi_reserved_graphic_phymem, (hisi_reserved_smmu_phymem - hisi_reserved_graphic_phymem));
	memblock_remove(hisi_reserved_smmu_phymem, 0x40000000 - hisi_reserved_smmu_phymem);
}
#endif
