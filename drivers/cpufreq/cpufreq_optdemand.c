...
unsigned int hmp_slower_domain_min_load = 0xff;
int hmp_min_load_ctrl_flag = 0;
#endif
...
#ifdef CONFIG_SCHED_HMP
    hmp_slower_domain_min_load = min_load;
#endif
					    ...
					    unsigned int code, int value)
{
	...
	struct dbs_data *dbs_data;
        /* get policy of cpu 0,because of HMP,only cluster0 has cpufreq */
 	unsigned int cpu = 0;
