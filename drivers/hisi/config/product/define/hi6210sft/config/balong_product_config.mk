...
CFG_PRODUCT_CFG_VERSION_STR                  :="V800R100C00B020"
CFG_PRODUCT_CFG_FULL_VERSION_STR             :="Balong V800R100C00B020"
...
CFG_CHIPSET_PATH :=platform/hi6210sft
...
CFG_GU_NV_XML_PATH :=config/nvim/data/gu/hi6210
CFG_GU_XNV_PATH :=config/nvim/data/gu/v8r1/sft
...
CFG_LPHY_PRV_DTCM_BASE		:=0xff2c0000
CFG_LPHY_PRV_ITCM_BASE		:=0xff238000
...
CFG_GU_FEATURE_CONFIG_PATH :=config/product/include/hi6210sft
CFG_MCU_INCLUDE                         := YES
...
CFG_MCORE_COMPONENTS			:=bsp_ccore.o gumsp_mcore.o nas_ccore.o rabm_ccore.o gas_ccore.o was_ccore.o ttf_ccore.o ascomm_ccore.o pscomm_ccore.o taf_ccore.o lps_NAS_mcore.o lps_AS_mcore.o lmsp_mcore.o gudsp_mcore.o gudsp_comm_RT.o gudsp_mcore_RT.o  modemcore1_union.o os_ccore.o
CFG_RTOSCK_MCORE_COMPONENTS     :=bsp_ccore.o gumsp_mcore.o nas_ccore.o rabm_ccore.o gas_ccore.o was_ccore.o ttf_ccore.o ascomm_ccore.o pscomm_ccore.o taf_ccore.o lps_NAS_mcore.o lps_AS_mcore.o lmsp_mcore.o gudsp_mcore.o gudsp_comm_RT.o gudsp_mcore_RT.o  modemcore1_union.o
