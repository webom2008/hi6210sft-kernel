...
static struct partition partitions[] = {
        ...
        {"recovery2",               16*1024},             /* recovery2            16M  p21*/
        {"reserved2",               48*1024},             /* reserved2            48M  p22*/
        ...
        {"system",                  1792*1024},           /* system               1792M p38*/
        {"cust",                    768*1024},            /* cust                 768M p39*/
...
static struct partition partitions[] = {    	
        ...
        {PART_RECOVERY2,        16*1024},     /* 21 recovery2         16M    */
        {PART_RESERVED2,        48*1024 },    /* 22 reserved2         48M    */
        ...
        {PART_RECOVERY,         32*1024 },    /* 29 recovery          32M    */
        ...
        {PART_3RDMODEM,         64*1024 },    /* 34 3rdmodem          16M    */
        ...
        {PART_SYSTEM,           1792*1024 },  /* 39 system            1792M  */
        {PART_CUST,             768*1024 },   /* 40 cust              768M   */  
        {PART_USERDATA,         3720*1024 },  /* 41 usrdata           3720M  */  
