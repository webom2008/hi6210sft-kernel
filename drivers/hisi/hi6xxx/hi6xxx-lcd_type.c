...
#define LCD_TYPE_STR_TM_R61318_LCD        "TM_R61318_LCD"
...
/*add tm-hx8394 lcd driver*/
#define LCD_TYPE_STR_TM_HX8394_LCD "TM_HX8394_LCD"
static char lcd_type_buf[20];
int get_lcd_type(void)
{
    ...
    }else if (0 == strncmp(lcd_type_buf, LCD_TYPE_STR_TM_R61318_LCD, strlen(LCD_TYPE_STR_TM_R61318_LCD))) {
        printk("%s : found TM_R61318_LCD.\n", __func__);
        return TM_R61318_LCD;
