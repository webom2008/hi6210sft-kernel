...
/*jinguojun for pioneer to pilot 20140326
...
/*****************************************************************************
 ...
 返 回 值  : 0 为OK。
*****************************************************************************/
extern int BSP_MNTN_OmExchFileSave(void * address, unsigned int length,unsigned char IsFileEnd,unsigned char type);
...
extern void BSP_XO_Fre_Compensate(XO_COMPENSATE_ID xo_compensate_id, BSP_U32 value);
#define DRV_XO_FRE_COMPENSATE(xo_ompensate_id,value) BSP_XO_Fre_Compensate(xo_ompensate_id,value)
