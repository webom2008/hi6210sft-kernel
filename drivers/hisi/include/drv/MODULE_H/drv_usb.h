...
/*Added by luyansheng, 20130117,starts
sync from v7r1*/
/*  SIM  state*/
...
*
*****************************************************************************/
extern int bsp_crypto_decrypt (char *cipher_data,int cipher_len,CRYPTO_ENCRYPT_ALGORITHM algorithm, char *key, int klen, char *data, int *len);
#define CRYPTO_DECRYPT(cipher_data,cipher_len,algorithm, key, klen, data, len)  \
bsp_crypto_decrypt(cipher_data,cipher_len,algorithm, key, klen, data, len)
