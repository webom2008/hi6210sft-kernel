...
/*****************************************************************************
 枚举名    :UCOM_NV_WBBP_HARQ_OUT_TYPE_ENUM_UINT16
 协议表格  :
 ASN.1描述 :
 枚举说明  :HARQ外移类型区分,0表示不支持外移, 1表示外移到DDR, 2表示外移到片内内存
*****************************************************************************/
enum UCOM_NV_WBBP_HARQ_OUT_TYPE_ENUM
{
    UCOM_NV_WBBP_HARQ_OUT_NOT_SUPPORT       = 0,                                /* 不支持HARQ外移 */                                                           /* 上行仅存在DPCH */
    UCOM_NV_WBBP_HARQ_OUT_IN_DDR            = 1,                                /* HARQ外移到DDR */                                                             /* 上行存在RACH */
    UCOM_NV_WBBP_HARQ_OUT_IN_CHIP           = 2,                                /* HARQ外移到片内内存 */
    UCOM_NV_WBBP_HARQ_OUT_BUTT
};
typedef VOS_UINT16 UCOM_NV_WBBP_HARQ_OUT_TYPE_ENUM_UINT16;
...
typedef struct
{
    ...
    VOS_UINT32                          uwReservedWords[7];         /* 保留用于以后自行扩展 */
...
typedef struct
{
    VOS_UINT32                              uwWcdmaAntDefaultCtrlWord;          /* 天线不交换时的GPIO控制字 */
...
/*****************************************************************************
 结构名    : UCOM_NV_W_HARQ_OUT_CONFIG_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : HARQ外移配置NV结构
*****************************************************************************/
typedef struct
{
    UCOM_NV_WBBP_HARQ_OUT_TYPE_ENUM_UINT16  enHarqOutType;                      /* HARQ外移类型 */
    VOS_UINT16                              uwReserve;
}UCOM_NV_W_HARQ_OUT_CONFIG_STRU;
...
typedef struct
{
    ...
    VOS_UINT32                           uwGsmDualAntPriCtrlWord;               /* 主天线的GPIO控制字 */
    VOS_UINT32                           uwGsmDualAntSecCtrlWord;               /* 辅天线的GPIO控制字 */
...
typedef struct
{
    VOS_UINT16                              uhwGsmDualAntEn;                    /* 双天线切换使能标志 */
