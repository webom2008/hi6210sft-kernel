...
/*****************************************************************************
 ...
 返 回 值  : BSP_OK:编码目的通道设置成功。
             other:编码目的通道设置失败错误码。
*****************************************************************************/
extern VOS_UINT32 BSP_SOCP_CoderSetSrcChan(SOCP_CODER_SRC_ENUM_U32 enSrcChanID,SOCP_CODER_SRC_CHAN_STRU *pSrcAttr);
...
*****************************************************************************/
extern VOS_UINT32 BSP_SOCP_CoderSetDestChanAttr(VOS_UINT32 u32DestChanID, SOCP_CODER_DEST_CHAN_STRU *pDestAttr);
...
*****************************************************************************/
extern  VOS_UINT32 BSP_SOCP_GetWriteBuff( VOS_UINT32 u32SrcChanID, SOCP_BUFFER_RW_STRU *pBuff);
...
*****************************************************************************/
extern  VOS_UINT32 BSP_SOCP_GetRDBuffer( VOS_UINT32 u32SrcChanID,SOCP_BUFFER_RW_STRU *pBuff);
...
extern VOS_UINT32 BSP_SOCP_GetSDLogCfg(VOS_UINT32 *pulEnable, VOS_UINT32 *pulTimerLen, VOS_UINT32 *pulBufferSize);

extern VOS_VOID BSP_SOCP_SetLogIntTimeOutDefautl(VOS_VOID);

extern VOS_VOID BSP_SOCP_SetLogIntTimeOut(VOS_VOID);
