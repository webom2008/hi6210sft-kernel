...
CALLER_DECLARE(modem_panic_sh, modem_panic, "/system/etc/log/modem_panic.sh", HIMNTN_ALWAYS_RESETLOG)
CALLER_DECLARE(modem_reboot_sh, modem_reboot, "/system/etc/log/modem_reboot.sh", himntn_modem_resetlog)
CALLER_DECLARE(modem_freeze_sh, modem_freeze, "/system/etc/log/modem_freeze.sh", HIMNTN_ALWAYS_RESETLOG)
