...
/*卡0的PID定义*/
    ...
    DEFINE_PID(WUEPS_PID_OM_BBP_MASTER)

    DEFINE_PID(DSP_PID_RCM)
    DEFINE_PID(DSP_PID_STARTUP)

    DEFINE_PID(MSP_PID_DRX)
    /*add by fuxin00221597 for volte*/
    DEFINE_PID(VOLTE_PID_DIAG)

    DEFINE_PID(MSPS_PID_1X_RLAC)
    DEFINE_PID(MSPS_PID_1X_RMAC)
    DEFINE_PID(MSPS_PID_1X_RRLP)
    DEFINE_PID(MSPS_PID_1X_MARKOV)
    DEFINE_PID(MSPS_PID_1X_LOOPBACK)
    DEFINE_PID(MSPS_PID_1X_FLAC)
    DEFINE_PID(MSPS_PID_1X_FMAC)
    DEFINE_PID(MSPS_PID_1X_FRLP)

    /* y58851 csdr 1x begin */
    DEFINE_PID(DSP_PID_PROCSTUB)
    DEFINE_PID(CPROC_PID_1X_CM)
    DEFINE_PID(CPROC_PID_1X_SM)
    DEFINE_PID(CPROC_PID_1X_DSP)
    DEFINE_PID(CPROC_PID_EVDO)
    /* y58851 csdr 1x end */

    DEFINE_PID(UEPS_PID_1XCASM)
    DEFINE_PID(UEPS_PID_1XCMEAS)
    DEFINE_PID(UEPS_PID_1XCSRCH)

    DEFINE_PID(UEPS_PID_XREG)
    DEFINE_PID(UEPS_PID_XSD)
    DEFINE_PID(UEPS_PID_XCC)
