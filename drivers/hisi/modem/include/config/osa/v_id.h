...
#undef DEFINE_PRODUCT_FID_TABLE
#if (VOS_WIN32 == VOS_OS_VER)    /* for LLT */
    #if (FEATURE_ON == FEATURE_UE_MODE_TDS)
        #if (FEATURE_ON == FEATURE_UE_MODE_CDMA)
            #if ( FEATURE_MULTI_MODEM == FEATURE_ON )
                /*++++++++++ multi modem with td and cdma ----------*/
                #define DEFINE_PRODUCT_FID_TABLE \
                    ...
                    {PS_FID_IMSVA,          "IMSVA_FID",    VOS_NULL_PTR,           VOS_START_THIRD,    8192,   0  },\
                ...
                #define DEFINE_PRODUCT_FID_TABLE \
                    ...
                    {UEPS_FID_CNAS,         "CNAS_FID",     CNAS_FidInit,           VOS_START_THIRD,    16384,  0  },
            #endif
        #else    /*(FEATURE_OFF == FEATURE_UE_MODE_CDMA)*/
            #if ( FEATURE_MULTI_MODEM == FEATURE_ON )
                /*++++++++++ multi modem with td, without cdma ----------*/
                #define DEFINE_PRODUCT_FID_TABLE \
                    {WUEPS_FID_OM,          "OM",           WuepsOMFidInit,         VOS_START_THIRD,    6144,   0  },\
                    {I0_MAPS_USIMM_FID,     "USIMM_FID",    USIMM_FID_Init,         VOS_START_THIRD,    8192,   0  },\
                    {I0_MAPS_SI_FID,        "SI_FID",       WuepsSIFidInit,         VOS_START_THIRD,    0,      0  },\
                    ...
                    {WUEPS_FID_CSIMA,       "CSIMA_FID",    CSIMA_FidInit,          VOS_START_THIRD,    8192,   0  },\
                    {WUEPS_FID_CMMCA,       "CMMCA",        CMMCA_FidInit,          VOS_START_THIRD,    4096,   0  },\
                    {UEPS_FID_CAS1X,        "CAS1X_FID",    VOS_NULL_PTR,           VOS_START_THIRD,    16384,  0  },\
                    {MSPS_FID_CTTF_1X_REV,  "1X_R_FID",     VOS_NULL_PTR,           VOS_START_THIRD,    0,      0  },\
                    {MSPS_FID_CTTF_1X_FWD,  "1X_F_FID",     VOS_NULL_PTR,           VOS_START_THIRD,    0,      0  },\
                    {DSP_FID_CPROC,         "CPROC_STUB",   VOS_NULL_PTR,           VOS_START_THIRD,    0,      0  },\
                    {CPROC_FID_1X,          "CPROC_1X",     VOS_NULL_PTR,           VOS_START_THIRD,    8192,   0  },\
                    {CPROC_FID_EVDO,        "CPROC_EVDO",   VOS_NULL_PTR,           VOS_START_THIRD,    8192,   0  },\
                    {UEPS_FID_CNAS,         "CNAS_FID",     VOS_NULL_PTR,           VOS_START_THIRD,    16384,  0  },
            #else
                /*++++++++++ single modem with td, without cdma ----------*/
                #define DEFINE_PRODUCT_FID_TABLE \
                    {WUEPS_FID_OM,          "OM",           WuepsOMFidInit,         VOS_START_THIRD,    6144,   0  },\
                    {I0_MAPS_USIMM_FID,     "USIMM_FID",    USIMM_FID_Init,         VOS_START_THIRD,    8192,   0  },\
                    {I0_MAPS_SI_FID,        "SI_FID",       WuepsSIFidInit,         VOS_START_THIRD,    0,      0  },\
        ...
        /*++++++++++ we think on PC, td and cdma will be both on, now ----------*/
        #if (FEATURE_OFF == FEATURE_UE_MODE_CDMA)
            #if ( FEATURE_MULTI_MODEM == FEATURE_ON )
                /*++++++++++ multi modem without cdma, without td ----------*/
                #define DEFINE_PRODUCT_FID_TABLE \
                    {WUEPS_FID_OM,          "OM",           WuepsOMFidInit,         VOS_START_THIRD,    6144,   0  },\
                    {I0_MAPS_USIMM_FID,     "USIMM_FID",    USIMM_FID_Init,         VOS_START_THIRD,    8192,   0  },\
                    {I0_MAPS_SI_FID,        "SI_FID",       WuepsSIFidInit,         VOS_START_THIRD,    0,      0  },\
                    ...
                    {UEPS_FID_CNAS,         "CNAS_FID",     VOS_NULL_PTR,           VOS_START_THIRD,    16384,  0  },
            #else
                /*++++++++++ single modem without cdma, without td ----------*/
                #define DEFINE_PRODUCT_FID_TABLE \
                    {WUEPS_FID_OM,          "OM",           WuepsOMFidInit,         VOS_START_THIRD,    6144,   0  },\
                    {I0_MAPS_USIMM_FID,     "USIMM_FID",    USIMM_FID_Init,         VOS_START_THIRD,    8192,   0  },\
                    {I0_MAPS_SI_FID,        "SI_FID",       WuepsSIFidInit,         VOS_START_THIRD,    0,      0  },\
                    ...
                    {UEPS_FID_CNAS,         "CNAS_FID",     VOS_NULL_PTR,           VOS_START_THIRD,    16384,  0  },
            #endif
        #endif    /* end for FEATURE_UE_MODE_CDMA */
    #endif    /* end for FEATURE_UE_MODE_TDS */

#elif (OSA_CPU_CCPU == VOS_OSA_CPU)    /* on board */
    #if (RAT_MODE == RAT_GU)    /* GU version */
        /*++++++++++ now to this version, it's without cdma ----------*/
        #if ( FEATURE_MULTI_MODEM == FEATURE_ON )
            /*++++++++++ multi modem with gu, without cdma ----------*/
            #define DEFINE_PRODUCT_FID_TABLE \
                {WUEPS_FID_OM,          "OM",           WuepsOMFidInit,         VOS_START_THIRD,    6144,   0  },\
                {I0_MAPS_USIMM_FID,     "USIMM_FID",    USIMM_FID_Init,         VOS_START_THIRD,    8192,   0  },\
                {I0_MAPS_SI_FID,        "SI_FID",       WuepsSIFidInit,         VOS_START_THIRD,    0,      0  },\
                ...
                {UEPS_FID_CNAS,         "CNAS_FID",     VOS_NULL_PTR,           VOS_START_THIRD,    16384,  0  },
         #else
             /*++++++++++ single modem with gu, without cdma ----------*/
             #define DEFINE_PRODUCT_FID_TABLE \
                {WUEPS_FID_OM,          "OM",           WuepsOMFidInit,         VOS_START_THIRD,    6144,   0  },\
                {I0_MAPS_USIMM_FID,     "USIMM_FID",    USIMM_FID_Init,         VOS_START_THIRD,    8192,   0  },\
                {I0_MAPS_SI_FID,        "SI_FID",       WuepsSIFidInit,         VOS_START_THIRD,    0,      0  },\
                ...
                {UEPS_FID_CNAS,         "CNAS_FID",     VOS_NULL_PTR,           VOS_START_THIRD,    16384,  0  },
    ...
    #elif (RAT_GU != RAT_MODE)    /* GUTL version */
        #if (FEATURE_ON == FEATURE_UE_MODE_TDS)
            #if (FEATURE_ON == FEATURE_UE_MODE_CDMA)
                #if ( FEATURE_MULTI_MODEM == FEATURE_ON )
                    /*++++++++++ multi modem with gutl, cdma ----------*/
                    #define DEFINE_PRODUCT_FID_TABLE \
                        {WUEPS_FID_OM,          "OM",           WuepsOMFidInit,         VOS_START_THIRD,    6144,   0  },\
                        {I0_MAPS_USIMM_FID,     "USIMM_FID",    USIMM_FID_Init,         VOS_START_THIRD,    8192,   0  },\
                        {I0_MAPS_SI_FID,        "SI_FID",       WuepsSIFidInit,         VOS_START_THIRD,    0,      0  },\
            ...
            #else    /* (FEATURE_OFF == FEATURE_UE_MODE_CDMA) */
                #if ( FEATURE_MULTI_MODEM == FEATURE_ON )
                    /*++++++++++ multi modem with gutl, without cdma ----------*/
                    #define DEFINE_PRODUCT_FID_TABLE \
                        {WUEPS_FID_OM,          "OM",           WuepsOMFidInit,         VOS_START_THIRD,    6144,   0  },\
                        {I0_MAPS_USIMM_FID,     "USIMM_FID",    USIMM_FID_Init,         VOS_START_THIRD,    8192,   0  },\
                        {I0_MAPS_SI_FID,        "SI_FID",       WuepsSIFidInit,         VOS_START_THIRD,    0,      0  },\
                        ...
                        {UEPS_FID_CNAS,         "CNAS_FID",     VOS_NULL_PTR,           VOS_START_THIRD,    16384,  0  },
                #else
                    /*++++++++++ single modem with gutl, without cdma ----------*/
                    #define DEFINE_PRODUCT_FID_TABLE \
                        {WUEPS_FID_OM,          "OM",           WuepsOMFidInit,         VOS_START_THIRD,    6144,   0  },\
                        {I0_MAPS_USIMM_FID,     "USIMM_FID",    USIMM_FID_Init,         VOS_START_THIRD,    8192,   0  },\
                        {I0_MAPS_SI_FID,        "SI_FID",       WuepsSIFidInit,         VOS_START_THIRD,    0,      0  },\
            ...
            #if (FEATURE_ON == FEATURE_UE_MODE_CDMA)
                #if ( FEATURE_MULTI_MODEM == FEATURE_ON )
                    /*++++++++++ multi modem with gul, cdma, without td ----------*/
                    #define DEFINE_PRODUCT_FID_TABLE \
                        {WUEPS_FID_OM,          "OM",           WuepsOMFidInit,         VOS_START_THIRD,    6144,   0  },\
                        {I0_MAPS_USIMM_FID,     "USIMM_FID",    USIMM_FID_Init,         VOS_START_THIRD,    8192,   0  },\
                        {I0_MAPS_SI_FID,        "SI_FID",       WuepsSIFidInit,         VOS_START_THIRD,    0,      0  },\
                        ...
                        {UEPS_FID_CNAS,         "CNAS_FID",     CNAS_FidInit,           VOS_START_THIRD,    16384,  0  },
                #else
                    /*++++++++++ single modem with gul, cdma, without td ----------*/
                    #define DEFINE_PRODUCT_FID_TABLE \
                        {WUEPS_FID_OM,          "OM",           WuepsOMFidInit,         VOS_START_THIRD,    6144,   0  },\
                        {I0_MAPS_USIMM_FID,     "USIMM_FID",    USIMM_FID_Init,         VOS_START_THIRD,    8192,   0  },\
                        {I0_MAPS_SI_FID,        "SI_FID",       WuepsSIFidInit,         VOS_START_THIRD,    0,      0  },\
                    ...
                    /*++++++++++ multi modem with gul, without cdma ----------*/
                    #define DEFINE_PRODUCT_FID_TABLE \
                        {WUEPS_FID_OM,          "OM",           WuepsOMFidInit,         VOS_START_THIRD,    6144,   0  },\
                        {I0_MAPS_USIMM_FID,     "USIMM_FID",    USIMM_FID_Init,         VOS_START_THIRD,    8192,   0  },\
                        {I0_MAPS_SI_FID,        "SI_FID",       WuepsSIFidInit,         VOS_START_THIRD,    0,      0  },\
                        ...
                        {UEPS_FID_CNAS,         "CNAS_FID",     VOS_NULL_PTR,           VOS_START_THIRD,    16384,  0  },
                #else
                    /*++++++++++ single modem with gul, without cdma ----------*/
                    #define DEFINE_PRODUCT_FID_TABLE \
                        {WUEPS_FID_OM,          "OM",           WuepsOMFidInit,         VOS_START_THIRD,    6144,   0  },\
                        {I0_MAPS_USIMM_FID,     "USIMM_FID",    USIMM_FID_Init,         VOS_START_THIRD,    8192,   0  },\
                        {I0_MAPS_SI_FID,        "SI_FID",       WuepsSIFidInit,         VOS_START_THIRD,    0,      0  },\
                ...
                #endif
            #endif
        #endif    /* endif FEATURE_UE_MODE_TDS */
    #endif    /* endif RAT_GU */
#endif    /* endif on broad */
...
#define DEFINE_PRODUCT_FID_TABLE \
    ...
    {PS_FID_APP_NDIS_PPP_DIPC,  "NDIS_PPP_DIPC",    APP_NDIS_FidInit,   VOS_START_THIRD,    16384, 0  },\
