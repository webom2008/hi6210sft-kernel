...
typedef struct tagCIPHER_RD_INFO_S
{
...
int BSP_CIPHER_Disable(void);
int BSP_CIPHER_Enable(void);

/*****************************************************************************
* 函 数 名  : BSP_CIPHER_GetRdInfo
*
* 功能描述  : 批量获取cipher的rd信息
*
* 输入参数  : u32Ch     : cipher通道号
            : pstRdNum  : 获取rd个数
* 输出参数  : pstRd     : cipher rd数组
            : pstRdNum  : 获取rd个数
* 返 回 值  : 成功:CIPHER_SUCCESS
*           : 失败:CIPHER_NOT_INIT
                   CIPHER_INVALID_CHN
                   ...
                   CIPHER_RDQ_NULL
*****************************************************************************/
BSP_S32 BSP_CIPHER_GetRdInfo(BSP_U32 u32Chn, CIPHER_RD_INFO_S *pstRd, BSP_U32 *pstRdNum);
