...
#define DRV_CACHEDMAM_ALLOC(bytes) OSAL_CacheDmaMalloc(bytes)  /* malloc from memory uncached */
#else
...
Return:
    free mem size
*******************************************************************/
extern unsigned int free_mem_size_get(void);
...
/*****************************************************************************
 ...
 返 回 值  : 无
*****************************************************************************/
#define BSP_DMB_INSTRUCTION     asm volatile("dmb" : : : "memory")
