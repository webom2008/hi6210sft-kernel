...
/*****************************************************************************
 ...
 返 回 值  : 0 ：OK  非 0 ：Error
            ...
            4 其他未知错误
*****************************************************************************/
extern  unsigned int  BSP_SDMMC_ATProcess(SD_MMC_OPRT_ENUM_UINT32 ulOp,
                unsigned int dev_addr,  unsigned int ulData,unsigned char *pucBuffer,unsigned int *pulErr);
#define DRV_SDMMC_AT_PROCESS(ulOp,dev_addr,ulData,pucBuffer,pulErr)   \
                     BSP_SDMMC_ATProcess (ulOp,dev_addr,ulData,pucBuffer,pulErr)
...
/*****************************************************************************
 ...
 返 回 值  :
            ...
            2: 上次操作失败
*****************************************************************************/
extern unsigned int BSP_SDMMC_GetOprtStatus(void);
