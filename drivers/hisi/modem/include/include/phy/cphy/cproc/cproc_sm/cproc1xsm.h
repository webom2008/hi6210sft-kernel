 ...
 * -  Output: Measurement Report with measured values per pilot. Frequency:
 *    Once per 80ms when in continuous states, at most once per DRX period in
 *    slotted mode (L1 gates reports in slotted mode).
...
{
    ID_CAS_CPROC_1X_IDLEACCESS_MEAS_REQ = 0x2100, /* _H2ASN_MsgChoice CAS_CPROC_1X_IDLEACCESS_MEAS_REQ_STRU*/ /**< @sa CAS_CPROC_1X_IDLEACCESS_MEAS_REQ_STRU */
    ID_CPROC_CAS_1X_IDLEACCESS_MEAS_CNF = 0x2101, /* _H2ASN_MsgChoice CPROC_CAS_1X_IDLEACCESS_MEAS_CNF_STRU*/ /**< @sa CPROC_CAS_1X_IDLEACCESS_MEAS_CNF_STRU */
    ID_CPROC_CAS_1X_IDLEACCESS_MEAS_IND = 0x2102, /* _H2ASN_MsgChoice CPROC_CAS_1X_IDLEACCESS_MEAS_IND_STRU*/ /**< @sa CPROC_CAS_1X_IDLEACCESS_MEAS_IND_STRU */
    ID_CAS_CPROC_1X_TCH_MEAS_REQ        = 0x2103, /* _H2ASN_MsgChoice CAS_CPROC_1X_TCH_MEAS_REQ_STRU*/ /**< @sa CAS_CPROC_1X_TCH_MEAS_REQ_STRU */
    ID_CPROC_CAS_1X_TCH_MEAS_CNF        = 0x2104, /* _H2ASN_MsgChoice CPROC_CAS_1X_TCH_MEAS_CNF_STRU*/ /**< @sa CPROC_CAS_1X_TCH_MEAS_CNF_STRU */
    ID_CPROC_CAS_1X_TCH_MEAS_IND        = 0x2105, /* _H2ASN_MsgChoice CPROC_CAS_1X_TCH_MEAS_IND_STRU*/ /**< @sa CPROC_CAS_1X_TCH_MEAS_IND_STRU */
    ID_CPROC1XSM_MSG_TYPE_ENUM_BUTT     = 0xFFFF
};
...
/** ****************************************************************************
 * Name        : CPROC_1X_MEAS_RPT_TYPE_ENUM_UINT16
 * Description : This enum is used to tell layer 1 whether the measurement
 * report is one shot or periodic.
 *******************************************************************************/
enum CPROC_1X_MEAS_RPT_TYPE_ENUM
{
    CPROC_1X_MEAS_RPT_TYPE_ONCE         = 0x0000,
    CPROC_1X_MEAS_RPT_TYPE_PERIOD       = 0x0001,
    CPROC_1X_MEAS_RPT_TYPE_AUTO         = 0x0002,
    CPROC_1X_MEAS_RPT_TYPE_BUTT         = 0x0003
};
typedef VOS_UINT16 CPROC_1X_MEAS_RPT_TYPE_ENUM_UINT16;
...
enum CPROC_1X_NEIGH_SRCH_PRIORITY_ENUM
{
    ...
    CPROC_1X_NEIGH_SRCH_PRIORITY                            = 0x0004,
    CPROC_1X_NEIGH_SRCH_PRIORITY_BUTT                       = 0x0005
};
typedef VOS_UINT16 CPROC_1X_NEIGH_SRCH_PRIORITY_ENUM_UINT16;

/** ****************************************************************************
 * Name        : CPROC_1X_STATUS_ENUM_UINT16
 * Description : 
 *******************************************************************************/
enum CPROC_1X_STATUS_ENUM
{
    CPROC_1X_STATUS_IDLE                = 0x0000,
    CPROC_1X_STATUS_ACCESS              = 0x0001,
    CPROC_1X_STATUS_BUTT                = 0x0002
};
typedef VOS_UINT16 CPROC_1X_STATUS_ENUM_UINT16;
...
typedef struct
{
    VOS_UINT16                          usBandClass;    /**<  0..31, frequency on which the pilot is */
    VOS_UINT16                          usFrequency;    /**<  0..2047, frequency on which the pilot is */
    VOS_UINT16                          usPNOffset;     /**<  0..511. PN Offset of the pilot. */
    VOS_UINT16                          usPNPhase;      /**<  0..16535. PN Phase in chips of the first used path. */
    VOS_INT16                           sPilotStrength; /**<  -25..-1, Ec/No of the pilot */
    VOS_INT16                           sTotalRxPower;  /**<  -110..0, RSSI of the serving frequency */
...
typedef struct
{
    CPROC_1X_MEAS_RPT_TYPE_ENUM_UINT16  enRptType;         /**<  for once report;for period report;for auto report */
    VOS_UINT16                          usRefPN;           /**<  0..511, PNOffset of the reference pilot */
    VOS_INT16                           sSFTotalRxPower;   /**<  -110..0, RSSI of the frequency */
    ...
    VOS_UINT16                          usNumOfNeighMeas;  /**<  1..CPROC_1X_MAX_REPORT_NUM, number of pilot in the report */
    CPROC_1X_NEIGH_MEAS_INFO_STRU       stSFNeighMeasInfo[CPROC_1X_MAX_REPORT_NUM];
...
typedef struct
{
    ...
    VOS_INT16                           sSFTotalRxPower;    /**<  -110..0, RSSI of the serving frequency */
    VOS_INT16                           sCFTotalRxPower;    /**<  -110..0, RSSI of the candidate frequency */
    VOS_INT16                           sCFTotalEcIo;       /**<  -25..20, Total EcIo of the candidate frequency */
    VOS_UINT16                          usNumOfNeighMeas;   /**<  Number of CF pilots in th report */
    CPROC_1X_NEIGH_MEAS_INFO_STRU       astCFNeighMeasInfo[CPROC_1X_MAX_REPORT_NUM];
...
typedef struct
{
    ...
    CPROC_1X_BOOL_ENUM_UINT16                               enSrchOffsetFlag;
...
typedef struct
{
    ...
    VOS_UINT16                                              usSrchWinR;        /**<  0..15, see table 2.6.6.2.1-1. Search window size for remaining set. SRCH_WIN_R */
    VOS_UINT16                                              usPilotIncrement;  /**<  1..15 for remaining set search, PILOT_INC */
    CPROC_1X_NEIGH_SRCH_MODE_ENUM_UINT16                    enNeighSearchMode; /**<  Use win size and or offset */
    CPROC_1X_BOOL_ENUM_UINT16                               enSetpointFlag;    /**<  TRUE means send OLPM on each update, INCL_SETPT. Allowed in TCH only. */
...
typedef struct
{
    ...
    VOS_UINT16                          usTFWaitTime;           /**<  0..15, max time to get good frame in target freq after Handoff. TF_WAIT_TIME */
...
typedef struct
{
    ...
    CPROC1XSM_MSG_TYPE_ENUM_UINT16      enMsgId;        /* _H2ASN_Skip */
    VOS_UINT16                          usOpId;
    CPROC_1X_MEAS_TYPE_ENUM_UINT16      enMeasmentType; /**<  setup, reconfig or release */
    CPROC_1X_STATUS_ENUM_UINT16         enStatus;       /**<  idle, access */
 ...
 * In idle slotted mode, the measurement report is sent only when triggered
 * according to the rules below:
 * * A Serving Frequency Neighbour Set Pilot Ec/Io becomes 3dB better than the
 * Ec/Io of the serving pilot (see C.S0011, section 3.2.1.2 and 3.2.1.3)
 * * All Active Set and Neighbour set cells on Serving Frequency are below
 * SOME_SPECIFIED_THRESHOLD (see C.S0011, section 3.2.1.4)
 * * All Active Set and Neighbour set cells on Serving Frequency are below
 * SOME_OTHER_SPECIFIED_THRESHOLD and are less than the Ec/Io of at least one
 * pilot on a Candidate Frequency (see C.S0011, section 3.2.1.4)
 * * \x{0096}20 log10 (Ec/Io) > EC_IO_THRESHs and pilot_power < EC_THRESHs -115 for
 * the serving pilot. (See C.S0005, section 2.6.2.1.6)
 *******************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                       /* _H2ASN_Skip */
...
*******************************************************************************/
/** ****************************************************************************
 * Name        : CPROC1XSM_MSG_DATA
 * Description : H2ASN top level message structure definition
 *******************************************************************************/
typedef struct
{
    CPROC1XSM_MSG_TYPE_ENUM_UINT16      enMsgId;     /* _H2ASN_MsgChoice_Export CPROC1XSM_MSG_TYPE_ENUM_UINT16 */
    VOS_UINT8                           aucMsgBlock[2];

    /* _H2ASN_MsgChoice_When_Comment CPROC1XSM_MSG_TYPE_ENUM_UINT16 */
}CPROC1XSM_MSG_DATA;
