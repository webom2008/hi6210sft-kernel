 ...
 */
#define CSDR_1X_ECNO_NOT_INCLUDED                           ( 0x7fff )
/**
 * Max number of cell search results in one CSDR_CPROC_1X_CELL_SEARCH_IND.
 */
#define CSDR_1X_MAX_CELL_SEARCH_RESULTS_NUM                 ( 32 )
/**
...
{
    ID_CPROC_CSDR_1X_CONTINUE_REQ                           = 0x00A0, /* _H2ASN_MsgChoice CPROC_CSDR_1X_CONTINUE_REQ_STRU*/ /**< @sa CPROC_CSDR_1X_CONTINUE_REQ_STRU */
    ID_CPROC_CSDR_1X_START_MEAS_REQ                         = 0x00A1, /* _H2ASN_MsgChoice CPROC_CSDR_1X_START_MEAS_REQ_STRU*/ /**< @sa CPROC_CSDR_1X_START_MEAS_REQ_STRU */
    ID_CSDR_CPROC_1X_MEAS_IND                               = 0x00A2, /* _H2ASN_MsgChoice CSDR_CPROC_1X_MEAS_IND_STRU*/ /**< @sa CSDR_CPROC_1X_MEAS_IND_STRU */
    ID_CPROC_CSDR_1X_STOP_MEAS_REQ                          = 0x00A3, /* _H2ASN_MsgChoice CPROC_CSDR_1X_STOP_MEAS_REQ_STRU*/ /**< @sa CPROC_CSDR_1X_STOP_MEAS_REQ_STRU */
    ID_CPROC_CSDR_1X_START_MPS_REQ                          = 0x00A4, /* _H2ASN_MsgChoice CPROC_CSDR_1X_START_MPS_REQ_STRU*/ /**< @sa CPROC_CSDR_1X_START_MPS_REQ_STRU */
    ID_CSDR_CPROC_1X_MPS_IND                                = 0x00A5, /* _H2ASN_MsgChoice CSDR_CPROC_1X_MPS_IND_STRU*/ /**< @sa CSDR_CPROC_1X_MPS_IND_STRU */
    ID_CPROC_CSDR_1X_BUFFER_REQ                             = 0x00A6, /* _H2ASN_MsgChoice CPROC_CSDR_1X_BUFFER_REQ_STRU*/ /**< @sa CPROC_CSDR_1X_BUFFER_REQ_STRU */
    ID_CSDR_CPROC_1X_BUFFER_IND                             = 0x00A7, /* _H2ASN_MsgChoice CSDR_CPROC_1X_BUFFER_IND_STRU*/ /**< @sa CSDR_CPROC_1X_BUFFER_IND_STRU */
    ID_CPROC_CSDR_1X_STOP_MPS_REQ                           = 0x00A8, /* _H2ASN_MsgChoice CPROC_CSDR_1X_STOP_MPS_REQ_STRU*/ /**< @sa CPROC_CSDR_1X_STOP_MPS_REQ_STRU */
    ID_CPROC_CSDR_1X_UPDATE_MPS_REQ                         = 0x00A9, /* _H2ASN_MsgChoice CPROC_CSDR_1X_UPDATE_MPS_REQ_STRU*/ /**< @sa CPROC_CSDR_1X_UPDATE_MPS_REQ_STRU */
    ID_CSDR_CPROC_1X_CELL_SEARCH_IND                        = 0x00AA, /* _H2ASN_MsgChoice CSDR_CPROC_1X_CELL_SEARCH_IND_STRU*/ /**< @sa CSDR_CPROC_1X_CELL_SEARCH_IND_STRU */
    ID_CPROC_CSDR_1X_SM_SET_WORK_MODE_REQ                   = 0x00AB, /* _H2ASN_MsgChoice CPROC_CSDR_1X_SM_SET_WORK_MODE_REQ_STRU*/ /**< @sa CPROC_CSDR_1X_SM_SET_WORK_MODE_REQ_STRU */
    ID_CSDR_CPROC_1X_SM_SET_WORK_MODE_CNF                   = 0x00AC, /* _H2ASN_MsgChoice CSDR_CPROC_1X_SM_SET_WORK_MODE_CNF_STRU*/ /**< @sa CSDR_CPROC_1X_SM_SET_WORK_MODE_CNF_STRU */
    ID_CPROC_CSDR_1X_SIGNAL_LEVEL_REQ                       = 0x00AD, /* _H2ASN_MsgChoice CPROC_CSDR_1X_SIGNAL_LEVEL_REQ_STRU*/ /**< @sa CPROC_CSDR_1X_SIGNAL_LEVEL_REQ_STRU */
    ID_CSDR_CPROC_1X_SIGNAL_LEVEL_IND                       = 0x00AE, /* _H2ASN_MsgChoice CSDR_CPROC_1X_SIGNAL_LEVEL_IND_STRU*/ /**< @sa CSDR_CPROC_1X_SIGNAL_LEVEL_IND_STRU */
    ID_CPROC_CSDR_1X_PILOT_SEARCH_REQ                       = 0x00AF, /* _H2ASN_MsgChoice CPROC_CSDR_1X_PILOT_SEARCH_REQ_STRU*/ /**< @sa CPROC_CSDR_1X_PILOT_SEARCH_REQ_STRU */
    ID_CSDR_CPROC_1X_PILOT_SEARCH_IND                       = 0x00B0, /* _H2ASN_MsgChoice CSDR_CPROC_1X_PILOT_SEARCH_IND_STRU*/ /**< @sa CSDR_CPROC_1X_PILOT_SEARCH_IND_STRU */
    ID_CSDR1XSM_MSG_TYPE_ENUM_BUTT                          = 0xFFFF
};
 ...
 * (i.e. for SF measurements in slotted mode). NEW is used when CSDR is to
 * fill the buffer by itself before the measurements are performed (i.e. for
 * CF measurements both in slotted mode and in TCH).
 *******************************************************************************/
 ...
 * shwRlsEcN0 is set to CSDR_1X_ECNO_NOT_INCLUDED in measurement reports and
 * in MPS reports when not all pilots in the radio link set have results (e.g.
 * in the first report after an MPS_START).
...
typedef struct
{
    ...
    PHY_INT16                           shwRscp;           /**<  -135..-1, resolution 1dBm Measured RSCP of the pilot */
    PHY_INT16                           shwEcN0;           /**<  -25..-1, resolution 1dB. Measured Ec/No of the pilot */
    PHY_INT16                           shwRlsEcIo;        /**<  -25..15, resolution 1dB., CSDR_1X_ECNO_NOT_INCLUDED Total Ec/Io of the RLS the pilot belongs to. */
    ...
    PHY_UINT32                          uwFirstPathOffset; /**<  Offset to the first used path. Used for timing maintenance and window placement. In 1/4 chips */
 ...
 * searches.
 * The Neighbour and candidate set cells are placed at positions 0 to
 * uhwNeighPNNum -1.
 * The remaining set cells are placed a positions uhwNeighPNNum to
 * uhwNeighPNNum + uhwRemPNNum - 1.
 * Results shall be sent to CPROC every time
 * CSDR_1X_MAX_CELL_SEARCH_RESULTS_NUM cells have been searched.
 *******************************************************************************/
typedef struct
{
    PHY_UINT16                          uhwNeighPNNum; /**<  Number of Neighbour PN offsets to search */
    PHY_UINT16                          uhwRemPNNum;   /**<  Number of Remaining PN offsets to search */
...
typedef struct
{
    ...
    CSDR1XSM_MSG_TYPE_ENUM_UINT16       enMsgId;       /* _H2ASN_Skip */
    PHY_UINT16                          uhwOpId;
...
typedef struct
{
    ...
    CSDR1XSM_MSG_TYPE_ENUM_UINT16                           enMsgId;        /* _H2ASN_Skip */
    PHY_UINT16                                              uhwOpId;
    CSDR_1X_MEAS_MODE_ENUM_UINT16                           enOffline;      /**<  0:Online  1:Offline, use the saved data */
...
typedef struct
{
    ...
    PHY_UINT16                          uhwOpId;
    PHY_INT16                           shwFreqRssi;    /**<  -880..0, resolution 0.125dBm. Measured RSSI on the frequency */
    PHY_INT16                           shwCfTotalEcIo; /**< -25..xx Total EcIo of all cells on the candidate frequency above CF_T_ADD. Valid only for CF meas reports. */
 ...
 * Description : This signal is sent from CPROC to CSDR to request CSDR to
 * stop any ongoing measurements or searches.
 *******************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                     /* _H2ASN_Skip */
...
typedef struct
{
    ...
    PHY_UINT16                          uhwWindowSize; /**<  100: after sleep. 50: otherwise */
 ...
 * shwAsTotalEcIo and shwAsTotalEc are set to CSDR_1X_ECNO_NOT_INCLUDED in
 * when not all pilots in the active set have results (e.g. in the first
...
typedef struct
{
    ...
    PHY_UINT16                          uhwOpId;
    PHY_INT16                           shwFreqRssi;    /**<  -880..0, resolution 0.125dBm. Measured RSSI on the frequency */
    PHY_INT16                           shwAsTotalEcIo; /**<  -25..15, CSDR_1X_ECNO_NOT_INCLUDED resolution 1dBm. Total EcIo of the Active set, from main antenna */
    PHY_INT16                           shwAsTotalEc;   /**<  -, CSDR_1X_ECNO_NOT_INCLUDED resolution 1dBm. total Ec of the Active set */
 ...
 * Description : This signal is sent from CPROC to CSDR to request CSDR to
 * fill the correlator buffer. The signal is used for buffering for serving
...
typedef struct
{
    ...
    CSDR1XSM_MSG_TYPE_ENUM_UINT16       enMsgId;       /* _H2ASN_Skip */
    PHY_UINT16                          uhwOpId;
    PHY_UINT16                          uhwActionTime; /**<  Start time of recording, in PCG. Does not use CSDR_1X_ACTIVATE_AT_ONCE */
    PHY_UINT16                          uhwNbrChips;   /**<  Length of burst to record in chips. Range: 0..3072 */
 ...
 * Description : This signal carries the complete new list of cells on which
 * to do MPS. No action time is given, since the request always shall be
 ...
 * The OpID shall be set to the OpID received in the corresponding
 * CPROC_CSDR_1X_MEAS_START_REQ.
 * 2) When measurements have been stopped by a CPROC_CSDR_1X_MEAS_STOP_REQ.
 * The signal then contains the results of cell searches that were finished
 * before the stop. The OpID shall be set to the OpID received in the
 ...
 * requested mode setting has been performed. The OpID shall be set to the
 * OpID received in the corresponding CPROC_CSDR_1X_SET_WORK_MODE_REQ.
 *******************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                               /* _H2ASN_Skip */
 ...
 * Description : If uhwScanAction == START_SCAN: Request a signal level scan
 * of usNbrOfFrequencies as defined in astFreq.
 * If uhwScanAction == STOP_SEND_REPORT: Abort the current scan and return the
 * results accumulated so far. usNbrOfFrequencies and astFreq are not valid.
 * If uhwScanAction == STOP_NO_REPORT: Abort the current scan and discard the
 * accumulated results. usNbrOfFrequencies and astFreq are not valid.
 * Result is returned by CSDR_CPROC_1X_SIGNAL_LEVEL_IND.
 *******************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                    /* _H2ASN_Skip */
    CSDR1XSM_MSG_TYPE_ENUM_UINT16       enMsgId;      /* _H2ASN_Skip */
    PHY_UINT16                          uhwOpId;
    CSDR_1X_SCAN_ACTION_ENUM_UINT16     enScanAction;
    PHY_UINT16                          uhwReserved;
    CSDR_1X_FREQ_INFO_LIST_STRU         stFreqList;
}CPROC_CSDR_1X_SIGNAL_LEVEL_REQ_STRU;

/** ****************************************************************************
 * Name        : CSDR_CPROC_1X_SIGNAL_LEVEL_IND_STRU
 * Description : Returns the result of a CPROC_CSDR_1X_SIGNAL_LEVEL_REQ.
 * If uhwScanAction == START_SCAN: The requested signal level scan has
 * completed, the number of frequencies is returned in usNbrOfFrequencies and
 * the signal levels in astFreq.
 * If uhwScanAction == STOP_SEND_REPORT: The signal level scan has been
 * stopped, the number of results accumulated so far are returned in
 * usNbrOfFrequencies and the signal levels in astFreq.
 * If uhwScanAction == STOP_NO_REPORT: The signal level scan has been stopped
 * and the results discarded. usNbrOfFrequencies and astFreq are not valid.
 *******************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                    /* _H2ASN_Skip */
    ...
    CSDR_1X_SCAN_ACTION_ENUM_UINT16     enScanAction;
    PHY_UINT16                          uhwReserved;
    CSDR_1X_FREQ_RESP_LIST_STRU         stFreqList;
 ...
 * pilots. stFreq contains the frequency to search. Result is returned by
 * CSDR_CPROC_1X_PILOT_SEARCH_IND.
 * If uhwSearchAction == STOP_SEARCH: Stop ongoing search. stFreq is not
 * valid. CSDR_CPROC_1X_PILOT_SEARCH_IND is returned when the search is
 * stopped. If no search is ongoing CSDR_CPROC_1X_PILOT_SEARCH_CNF is returned
 * immediately.
 *******************************************************************************/
typedef struct
{
 ...
 * uhwSearchAction == STOP_SEARCH indicates that pilot search has been
 * stopped, and the result fields are not valid.
 *******************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                      /* _H2ASN_Skip */
...
*******************************************************************************/
/** ****************************************************************************
 * Name        : CSDR1XSM_MSG_DATA
 * Description : H2ASN top level message structure definition
 *******************************************************************************/
typedef struct
{
    CSDR1XSM_MSG_TYPE_ENUM_UINT16       enMsgId;     /* _H2ASN_MsgChoice_Export CSDR1XSM_MSG_TYPE_ENUM_UINT16 */
    PHY_UINT8                           aucMsgBlock[2];

    /* _H2ASN_MsgChoice_When_Comment CSDR1XSM_MSG_TYPE_ENUM_UINT16 */
}CSDR1XSM_MSG_DATA;
