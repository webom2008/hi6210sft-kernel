 ...
 * @file
 * @brief
 * These container defines public structures used by both
 * csdr_1x_decdata_pif.h and csdr_1x_encdata_pif.h. We keep its name with the
 * suffix _pif, because we want to generate this interface file with _pif in
 * its name.
 ...
 * 1x. It's the address of CTTF_CSDR_1X_ADDR_INFO_STRU.
 */
#define CTTF_CSDR_1X_REQUIRE_ADDR                           ((CSDR_DDR_RAM_BASE) + ( 0x0) )
