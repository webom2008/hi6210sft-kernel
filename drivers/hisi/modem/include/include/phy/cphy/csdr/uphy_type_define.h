...
typedef  unsigned char              PHY_UINT8;                             /* range(0..2^8 -1) */
typedef  char                       PHY_INT8;                              /* range(-2^7..2^7-1) */
...
typedef  unsigned long long         PHY_UINT64;                            /* range(0..2^64 -1) */
...
typedef  int                        PHY_INT;                               /* range dependent on target */
typedef  unsigned int               PHY_UINT;                              /* range dependent on target */
