...
/* BEGIN: Added by w00139675, 2014/03/24 */
/************************************************************
                           7. DT路测数据结构定义
************************************************************/
...
typedef struct __LPHY_DT_CQI_RPT_R2_WCQI_RESULT_STRU__  //w00227162
{
	UINT16     Reserved;
	UINT8      ucR2WbCqi[2];           /*码字0和码字1的宽带CQI*/
	UINT16     usSysFrmNum;            /*上报时刻系统帧号*/
...
typedef struct __LPHY_DT_CQI_RPT_R1_WCQI_RESULT_STRU__  //w00227162
{
	UINT16     Reserved;
...
/* END:   Added by w00139675, 2014/03/24 */
#ifdef __cplusplus
#if __cplusplus
}
#endif
