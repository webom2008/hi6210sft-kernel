...
typedef struct
{
    ...
    /* END:   Added by l00131321, 2012/11/9 */
...
/* END:   Added by l00131321, 2012/12/13 */
/************************************************************
                           2. CNF数据结构定义
************************************************************/
...
typedef struct
{
    ...
    UINT16 usRevd;
    /* END:   Added by l00131321, 2012/12/3 */
...
/* END:   Added by l00131321, 2012/11/12 */
...
typedef struct
{
    ...
    /* END:   Added by l00131321, 2012/12/4 */
...
//    UINT8   ucPMIValue[25];         /*PMI值*/
    ...
    UINT16  usCqiChSel;
    UINT16  usRevd;
    /* END:   Added by l00131321, 2012/11/24 */
...
typedef struct
{
    ...
    /* END:   Added by l00131321, 2012/12/18 */
...
typedef struct
{
    ...
    UINT32                          :7;
    /* END:   Added by l00131321, 2012/11/22 */
    /*PUSCH_ODD_REG*/
...
typedef struct
{
    ...
    UINT16 usRbStart0;
    UINT16 usRbStart1;
    /* END:   Added by l00131321, 2012/12/17 */
}DCI0_STRU;
...
typedef struct __LPHY_IND_UL_SRS_CAPTURE_INFO_STRU__
{
    ...
    /* END:   Added by l00131321, 2012/12/6 */
    UL_MOD_SRS_BBP_PARA_STRU stSrsBbpPara;
...
typedef struct __LPHY_DT_TA_INFO_IND_STRU__ /*x00149676 add for ca */
{
    UINT16   usSFN;
    UINT16   usSubFn;
    UINT16   usTaValue;
