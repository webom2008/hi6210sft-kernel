...
26toF87kGDP6acAmIlgOJniA6950d8RK/Ax/YFLJaXzom1wL1Faxebk13X70j+T0PdXLULpB
KdBPyN5kDErCpFd1GoAbmFysisV3FmOxbh3EHhxoOoLv8qNgifoeCLiU2cE18g==*/
/*--------------------------------------------------------------------------------------------------------------------------*/
/**
 * @file sre_base.h
 *
...
{
    UINTPTR uwPs;
    __asm__ __volatile__( "rsil %0, 0" : "=a" (uwPs) );
    return uwPs;
}
...
OS_SEC_ALW_INLINE INLINE UINTPTR SRE_IntUnLock(VOID)
{
    __asm__ __volatile__("setinter 0, 0 ");
...
{
    UINTPTR uwPs;
    __asm__ __volatile__( "rsil %0, 3" : "=a" (uwPs) );
    return uwPs;
}
...
{
    UINTPTR uwPs;
    __asm__ __volatile__( "rsil %0, 4" : "=a" (uwPs) );
    return uwPs;
}
...
OS_SEC_ALW_INLINE INLINE UINTPTR SRE_IntLock(VOID)
{
    ...
    __asm__ __volatile__( "mov.a.ssr  %0 ,  sr    \n\
                           setinter 1, 0  " : "=r" (uwSR) );
    __asm__ __volatile__("sync" );
...
{
    __asm__ __volatile__( "wsr %0, ps; rsync" : : "a" (uvIntSave) );
}
...
OS_SEC_ALW_INLINE INLINE UINT32 SRE_GetCurCntx()
{
    return 0;
}
