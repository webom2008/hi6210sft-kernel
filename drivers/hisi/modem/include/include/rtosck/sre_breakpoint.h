...
26toFxJoA1i9vJtf+aKoi3oNyK59Ai9anjMjwAr8xr5bekori41OtoodoxqrWwOgLsNlksvv
vIWAuCxhzPYqjL4a8jBn9mPr8TX3RBLPtFvRdV7cPZOlRjdqxRUm2g0hbH5dSA==*/
/*--------------------------------------------------------------------------------------------------------------------------*/
/**
...
typedef enum
{
    ...
    BP_TYPE_DATA_READ_WRITE  = 3,  /**< 数据读写断点 */
    BP_TYPE_INVALID
}OS_BP_TYPE_E;
...
typedef enum
{
    ...
    BP_MON_SIZE_032 = 5,   /**<监控区间大小为32字节   */
    BP_MON_SIZE_064 = 6,   /**<监控区间大小为64字节   */
 ...
 * 值: 0x02002202
 *
 * 解决方案:请确保传入的断点类型为BP_TYPE_INSTRCTION，BP_TYPE_DATA_READ，BP_TYPE_DATA_WRITE，BP_TYPE_DATA_READ_WRITE其中一种。
 */
...
*@attention
* <ul>
* <li>仅支持SD6108/SD6181/SD6182/SD6157平台。</li>
* <li>当前支持2个指令断点和2个数据断点，当栈越界模块打开时，可使用的数据断点为1个。</li>
