...
26toF+qnSXOrX/kD5G/aWHSaIBG7jKUrXjXub3KhDKXyfD0kohWA08MU20TthE86NNdzxPLf
rkOUhA4d/AgyYx+DhxXO2Tsq/7ZsqGYEVxAJP+bqSV8iQQjJMoVbzHKFSirhSA==*/
/*--------------------------------------------------------------------------------------------------------------------------*/
/**
 ...
 * <li>建议用户使用矢量赋值操作前调用#SRE_TaskCpEntry或#SRE_SwiCpEntry，使用矢量赋值操作后，调用#SRE_TaskCpExit或#SRE_SwiCpExit, 以提高矢量操作性能。</li>
 * <li>参数uwValue只有低8bit有效，高位会被忽略。</li>
 * <li>在任务或软中断中进行矢量赋值操作前一定要设置矢量缓存区。</li>
 * <li>硬中断中不支持矢量操作</li>
 * </ul>
 ...
 * <li>调用前，需要保证目的缓冲区和源缓冲区无重叠，否则行为未知。</li>
...
#endif // (OS_HAVE_COPROCESSOR1 == YES)
