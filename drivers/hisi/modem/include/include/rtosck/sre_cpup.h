...
26toF+1zE/c7wNfjl1uhWmbtYHdwnbwUYfv8qD//06nWieUtvZ1aYMs3T/ObKvpvBXkhaeyM
ZVdYvI2DbP1TnH3tdINrcTFAocYm0Ej9MTePY7gi1uX+7sb3xZKyLznBsEuqNQ==*/
/*--------------------------------------------------------------------------------------------------------------------------*/
/**
* @file sre_cpup.h
*
...
/**
 * @ingroup SRE_cpup
 * CPUP错误码：CPUP功能开关未打开或者未初始化时，获取CPUP。
 *
 * 值: 0x02000C0B
 *
 * 解决方案: 需保证在打开功能开关,在osStart之后才能获取CPUP。
 */
...
* <ul>
* <li>osStart之前不能调用此接口。</li>
* <li>对于SD6182/SD6157平台，支持实例间查询其他核的当前CPU占用率。</li>
...
/**
 * History:
 * 2009-02-26 z00134877: Create this file.
 *
 *
 */
