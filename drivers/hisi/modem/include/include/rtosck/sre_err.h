...
26toFxRo0+I0/aJsoWuWMHFv1m4X8prcYja8N5mpwXhmxNzxrfVpQ/ku6YxjUZAnZ+zhmg75
apgxedY4fNd/IhPVcKhuw/NBV1DWgLd0qtfzrfSI+bG4i56x9iWmERX3ghLNPw==*/
/*--------------------------------------------------------------------------------------------------------------------------*/
/**
 * @file sre_err.h
 *
...
* <li>此数组存放元属顺序为：用户配置的任务栈+os默认创建的分区+用户配置的分区。详见CDA使用实例。</li>
