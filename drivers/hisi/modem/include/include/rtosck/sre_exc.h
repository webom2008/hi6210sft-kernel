...
26toF4C7DLEgsypJA3kprROCTjEuh6yzHpsmAb14fA5uJh72qeR8i6apRQBgJkEineVEETfy
ExjXkBJwguTQeVVo5B2ohEGOl9z3Php3wHMLtHS2IFtkOuisdIvQ59dEsl8wmg==*/
/*--------------------------------------------------------------------------------------------------------------------------*/
/**
 * @file sre_exc.h
 *
...
/**
 *@ingroup SRE_exc
 *异常错误码: A7,A9 配置的复位不丢失内存起始地址没有4字节对齐。
 *
 *值：0x02001c04
 *
 ...
 *值：0x02001c0a
 *
 *解决方案：请增大double异常栈空间的长度，使之不小于异常寄存器信息（EXC_REGS_S５末3倍(double异常,NMI异常,Debug异常共用)。
 */
...
/**
 *@ingroup SRE_exc
 *SD6182/SD6157 MSGM异常类型:正常消息队列memory 1bit错误，硬件自动纠错，不做异常接管。
 */
#define MSGM_EXC_TYPE_NOR_ECC_1BIT   6

/**
 *@ingroup SRE_exc
 *SD6182/SD6157 MSGM异常类型:正常消息队列memory 2bit错误, 消息读取时记录错误，不做异常接管。
 */
#define MSGM_EXC_TYPE_NOR_ECC_2BIT   7
...
/**
 *@ingroup SRE_exc
 *SD6182/SD6157 MSGM异常类型:共享消息队列memory 1bit错误，硬件自动纠错，不做异常接管。
 */
#define MSGM_EXC_TYPE_SH_ECC_1BIT   10

/**
 *@ingroup SRE_exc
 *SD6182/SD6157 MSGM异常类型:共享消息队列memory 2bit错误，消息读取时记录错误，不做异常接管。
 */
#define MSGM_EXC_TYPE_SH_ECC_2BIT   11
 ...
 *@ingroup SRE_exc
 *HIDSP异常分类:OS_DATA_LOAD_ERR, 取数据异常
 *HIDSP异常具体类型:LMT,取数据MMU二级tag奇偶校验错误。
 */
 ...
 *@ingroup SRE_exc
 *HIDSP异常分类:OS_DATA_STORE_MMU_ERR, 存数据MMU异常
 *HIDSP异常具体类型:SMT, 存数据MMU二级tag奇偶校验错误。
 */
 ...
 *HIDSP异常标志:指令预取异常。
 */
#define OS_PROG_FETCH_ERR        1
/**
 *@ingroup SRE_exc
 *HIDSP异常标志:数据LOAD异常。
 */
#define OS_DATA_LOAD_ERR         2
/**
 *@ingroup SRE_exc
 *HIDSP异常标志:存数据MMU异常。
 */
#define OS_DATA_STORE_MMU_ERR    3
/**
 *@ingroup SRE_exc
 *HIDSP异常标志:使用不符合权限的指令异常。
 */
#define OS_PRVLG_ERR             4
/**
 *@ingroup SRE_exc
 *HIDSP异常标志:除0异常。
 */
#define OS_DIV_ZERO_ERR          5
/**
 *@ingroup SRE_exc
 *HIDSP异常标志:调试异常。
 */
#define OS_DEBUG_EXCP            6
/**
 *@ingroup SRE_exc
 *HIDSP异常标志:syscall异常。
 */
 ...
 *HIDSP异常标志:协处理器异常。
 */
#define OS_CPENABLE_PRO          8
/**
 *@ingroup SRE_exc
 *HIDSP异常标志:MSGQ异常。
 */
#define OS_MSG_QUE_ERR           9
/**
 *@ingroup SRE_exc
 *HIDSP异常标志:致命错误异常。
 */
#define OS_EXCEPT_FATALERROR     10
/**
 *@ingroup SRE_exc
 *HIDSP异常标志:栈越界异常。
 */
#define OS_EXCEPT_STACKOVERFLOW  11
