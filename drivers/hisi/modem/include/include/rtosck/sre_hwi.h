...
6v3DamdNr0LnQAdDHSdbwHvRt484CkLsEHAznnZ+bup3xlA7q4fqv2sHM4Xa2HQL/tIyF1jH
7/1spnZdH1ZKaqZV52AVus6p2D+oJo5wCl/PCkIJvfGm9+j07yOBDnnqjHfiuw==*/
/*--------------------------------------------------------------------------------------------------------------------------*/
/**
 * @file sre_hwi.h
 *
 ...
 * 而Cortex-AX的优先级为0-31，SD6183的优先级为0-7。
 *
 *
 * N: Invalid Priority
 * Y: Valid Priority
 ...
 * 值: 0x02001400
 *
 * 解决方案：确保中断号合法，Tensilica:[0,31]，Cortex-AX:[0,255]，SD6183:[32,127]。
 */
 ...
 * 值: 0x02001401
 *
 * 解决方案：确保优先级合法，Tensilica:优先级忽略，Cortex-AX:[0,31]，SD6183:[0,7]。
 */
...
/**
 * @ingroup SRE_hwi
 * 硬中断错误码：Cortex-AX硬件上报错误中断，上报的中断号大于0xFF。
 *
 * 值: 0x02001410
 *
 * 解决方案：无。
 ...
 *
 * @par 描述:
 * 在创建硬中断前，必须要配置好硬中断的模式，包括独立型（#OS_HWI_MODE_ENGROSS）和组合型（#OS_HWI_MODE_COMBINE）两种配置模式。
 *
 * @attention
 * <ul>
 * <li>Tensilica下的SD6181, SD6108, SD6182, SD6157芯片，可用硬中断号为0-31，OS已经占用的不能被使用。</li>
 * <li>由于Tensilica平台下优先级由硬件固定，故此参数无效。</li>
 * <li>Cortex-AX平台下可用硬中断号为0-255,优先级0-31。</li>
 * <li>SD6183平台下可用硬中断号为32-127，优先级0-7，数字越大优先级越高。</li>
 * </ul>
 *
 ...
 * <li>Cortex-AX平台下可用硬中断号为0-255,优先级0-31。</li>
 * <li>SD6183平台下可用硬中断号为32-127,优先级0-7。</li>
 ...
 * <li>不能删除OS占用的中断号。</li>
 * <li>Cortex-AX下可用硬中断号为0-255。</li>
 * <li>SD6183下可用硬中断号为32-127。</li>
 * </ul>
 *
 * @param  uwHwiNum [IN] 类型#HWI_HANDLE_T，硬中断号。
 *
...
* <li>对于Cortex-AX，可用硬中断号为0-255。</li>
* <li>对于SD6183，可用硬中断号为32-127。</li>
 ...
 * <li>针对Cortex-AX，不支持该接口。</li>
 * <li>针对SD6183平台，此参数为中断向量号32-127，另外此接口对NMI中断无效。</li>
 * </ul>
 *
 * @param  uwHwiNum [IN] 类型#HWI_HANDLE_T，硬中断号。
 *
...
* <ul>
* <li>对于Tensilica，此参数为中断向量号0-31。</li>
* <li>对于Cortex-AX，此参数为中断向量号0-255。</li>
* <li>对于SD6183，此参数为中断向量号32-127，另外此接口对NMI中断无效。</li>
