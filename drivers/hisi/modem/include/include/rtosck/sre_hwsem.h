...
6v3DatK3K7GXUVnh61GSexUShCqqO2QyEvTSCnpc2zMV/00ZNdZqYAZI55Zpwix3ccztmmXr
qfuF1T6CAcynvTEMZL/FdYAWzFWXmJ6COMt9kM9YkhEf1iCyPear0Yw1w5aHsA==*/
/*--------------------------------------------------------------------------------------------------------------------------*/
/**
 * @file sre_hwsem.h
 *
 ...
 * @attention
 * <ul>
 * <li>若多个核需要使用同一硬件信号量资源，每个核均需调用删除接口释放资源。</li>
 ...
 * <li>对于SD6183平台这个接口仅MCPU核调用(COMM VMID权限)。</li>
...
/**
 * History:
 * 2010-04-07 h00133330: Create this file.
 *
