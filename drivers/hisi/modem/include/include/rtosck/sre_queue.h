...
6v3Dap7dLxeo48ojfxImzcbRobH/5QMEy801y1h11KP1aVOXY5zfRnQDEwFV9QncTLrNZ400
Qoz4OHs67GzBLdZCLLNjaE3Xlh98MkKU5iExKNqaOqqJRbS1YDrfFDTvHBo1oQ==*/
/*--------------------------------------------------------------------------------------------------------------------------*/
/**
 * @file SRE_queue.h
 *
 ...
 *
 * @par 描述:
 * 向指定队列写数据。将pBufferAddr地址中uwBufferSize大小的数据写入到异步队列中。
 * @attention
 * <ul>
...
/**
 * History:
 * 2011-8-11, z00165281, Create this file. \n
 *
