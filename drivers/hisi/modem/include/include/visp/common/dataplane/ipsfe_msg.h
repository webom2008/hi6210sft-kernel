...
enum enSfeNPpiType
{
    ...
    SFE_NPPI_PUB_SET_OUTPUT_TOCOM,          /* 设置数据面输出到串口的开关 */
...
typedef UINT32 (*MsgNPpiDispatchFuncPtr)(VOID *pstMsg, UINT32 u32DataBufLen, INT8 *pDataBuf, UINT32 *pu32ActualDataLen);
