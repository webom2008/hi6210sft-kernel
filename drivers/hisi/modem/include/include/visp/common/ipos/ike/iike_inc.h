...
#if 0
(IKE_YES == IKE_GGSN_SUPPORT)
#include "ipbircommon/ipbirmap/ipbir_component.h"
#endif
...
#if 0
    METHOD_(ULONG, pfIKE_SetPfkeyReplyTimeout) (ULONG ulRead);
    METHOD_(ULONG, pfIKE_SetCtlCpuCounter) (ULONG ulRead);
    METHOD_(ULONG, pfIKE_SetPfkeyV2SoftMulFact) (ULONG ulRead);
    METHOD_(ULONG, pfIKE_SetPfkeyV2SoftDivFact) (ULONG ulRead);
    METHOD_(ULONG, pfIKE_SetMessageTransmit) (ULONG ulRead);
    /*METHOD_(ULONG, pfIKE_SetExchangeTimeout) (ULONG ulRead);*/
    METHOD_(ULONG, pfIKE_SetModeCfgAddrCount) (ULONG ulRead);
#endif
