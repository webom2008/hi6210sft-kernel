...
DECLARE_INTERFACE (IIF_IPSEC_ComIntCFG)
{
    ...
    METHOD_(ULONG, pfIPSEC_EasyVPN_SetResetInBandExchange)(UCHAR *pucEasyVpnName,
                                                    ULONG ulType, ULONG ulOpMode); /* 167 */

    METHOD_(ULONG, pfIPSEC_TemplateKickSaWithSameFlow)(ULONG ulSetOrUndo);         /* 168 */
    METHOD_(ULONG, pfIPSEC_GetTemplateKickSaWithSameFlow)(VOID);                   /* 169 */

    /*HERT 3.4 - DO req*/
    METHOD_(ULONG, pfIPSEC_GetIPSECDoStats)(ULONG ulOperType);   /* 170 */
