...
#if 0
extern ULONG TCPIP_IPSEC_FlushCache (UCHAR ucCacheType);
extern ULONG TCPIP_IPSEC_EnableDisableCache (UCHAR ucOpMode);
extern ULONG TCPIP_IPSEC_SetCacheAgeTime (ULONG ulAgeTime, UCHAR ucCacheType);
extern ULONG TCPIP_IPSEC_SetCacheSavedEntriesCount (ULONG ulEntryCount);
#endif
...
#if 0
VOID TCPIP_IKE_DisplayAllSupportedIPSecProposals(VOID);
#endif
...
#if 0
/* For HI_Silicon Testing */
VOID TCPIP_IKE_IPSEC_MasterConfig();
VOID TCPIP_IKE_IPSEC_SlaveConfig();
#endif
