...
typedef enum enumSfeMbufErrCode
{
    ...
    SFE_MBUF_MBUF_NULL_POINTER_SETUSERPRVT,       /* 42 设置产品私有信息到MBUF时MBUF指针为空 */
    SFE_MBUF_PTRANDLEN_NOTMATCH_SETUSERPRVT,      /* 43 设置产品私有信息到MBUF时私有数据指针与长度不匹配,即长度非零,但指针为空 */
    SFE_MBUF_DATALEN_INVAILD_SETUSERPRVT,         /* 44 设置产品私有信息到MBUF时私有数据长度大于最大值 */
    SFE_MBUF_INPUT_NULL_POINTER_GETUSERPRVT,      /* 45 获取产品私有信息到MBUF时输入指针为空 */
    ...
    SFE_MBUF_MBUF_NULL_POINTER_SETUSERPRVTLEN,    /* 73 设置产品私有信息长度到MBUF时MBUF指针为空 */
    SFE_MBUF_DATALEN_INVAILD_SETUSERPRVTLEN,      /* 74 设置产品私有信息长度到MBUF时私有数据长度大于最大值 */
