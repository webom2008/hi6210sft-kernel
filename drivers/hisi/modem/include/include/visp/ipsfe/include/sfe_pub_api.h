...
*               UINT8 *pu8DstMac: 目的MAC地址(调用者提供的内存空间大小为6字节) <非NULL>
...
typedef struct tagSFE_STATISTIC_NOTIFY_INFO
{
    ...
    UINT32 u32SrcIP;            /* 报文中的源地址(网络字节序),无法获取IP地址的时候填为0 */
    UINT32 u32DstIP;            /* 报文中的目的地址(网络字节序),无法获取IP地址的时候填为0 */
