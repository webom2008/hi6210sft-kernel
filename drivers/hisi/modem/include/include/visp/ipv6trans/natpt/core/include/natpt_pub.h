...
#define NATPT_TCP_FTP_PORT  21/*FTP server port fpr ctrl commands*/ 
...
typedef struct tagNATPT_Hash_Session
{
    ...
    VOID* pExtData;/*Add for FTP-ALG support*/
}NATPT_HASH_SESSION_S;


/*Added for FTP-ALG support by Archana PV (70282)*/
...
/*End of Add for FTP-ALG support*/
