...
typedef struct tagOSPF6_INTERFACEID_S
{
    union
    {
...
typedef struct tagOSPF6_SHOWINTF
{
    ...
    OSPF6_INTERFACEID_S stInterfaceId;            /* 本接口的接口ID */
    ULONG ulAddrlessif;
...
{     
    ...
    UCHAR  ucNbrAddr[OSPF6_MAX_INET_ADDR_LEN]; /*邻居IP地址*/
    ...
    UCHAR  ucNbrIfIpAddr[OSPF6_MAX_INET_ADDR_LEN]; /*邻居接口IP地址*/
...
typedef struct tagOSPF6_SHOWPEER
{
    ...
    ULONG  ulInstanceId;                         /*Instance ID*/ 
    ULONG  ulIfIndex;                            /*接口索引*/ 
    UCHAR  ucNbrAddr[OSPF6_MAX_INET_ADDR_LEN];   /*手工配置对端的IP地址*/
    ULONG  ulNbrPriority;                        /*邻居优先级*/
