...
typedef struct tagOSPF_SHOWIF_OUT
{
    ...
    ULONG ulIfIpAddr;                             /*02 IP地址*/
    ULONG ulIfIpMask;                             /*-- IP地址掩码*/
...
{
    ULONG   ulPeerIpAddr;                   /*01 手工配置对端的IP地址*/
...
{
    ULONG   ulAreaId;                       /*01 区域ID*/
    ULONG   ulIpAddr;                       /*02 IP地址*/
    ULONG   ulIpMask;                       /*03 IP地址掩码*/
...
{    
    ...
    /*End of Modified by lKF35457, 2010/10/25 */
...
/* Added by likaikun 00213099,for retransmission interval,2013/09/22 */
...
/* End of Added by likaikun 00213099,for retransmission interval,2013/09/22 */
