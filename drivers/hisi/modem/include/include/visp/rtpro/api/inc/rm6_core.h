...
extern ULONG RM6_cmm_redist_open(ULONG *pulSessionID,RM_REDIST_FILTER_S *pstRedistFilter);
extern ULONG RM6_cmm_redist_get_first(ULONG ulSessionID, RM_DSP_REDIST_S * pstConfigInfo);
extern ULONG RM6_cmm_redist_get_next(ULONG ulSessionID, RM_DSP_REDIST_S * pstConfigInfo);
