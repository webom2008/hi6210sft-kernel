...
typedef struct tagRM_ENABLE_USR6
{
    ...
    UCHAR szIfName[MAX_IF_NAME_LENGTH + 1];/*出接口名字*/
    UCHAR aucDestAddr[RM_IPV6_ADDRESS_WORD_LEN];/*目的地址 4*4 bytes 主机序*/
    ULONG ulPrefixLen;/*前缀长度，取值0-128*/
    UCHAR aucNextHopAddr[RM_IPV6_ADDRESS_WORD_LEN];/*下一跳或网关地址 4*4 bytes 主机序*/
...
/*Modify by q62011 for BC3D00979 start*/
/***************************************************************************/
...
{\
  ...
  (VOID)VOS_Mem_Set((CHAR*)szMask, 0,AMB_MAX_IPV6_ADDR_LEN);\
  (VOID)VOS_Mem_Set((CHAR *)szMask, (CHAR)0xFF, (ucPrefixLen / QCRT_NUM_BITS_IN_BYTE));\
...
{\
  ...
  (VOID)VOS_Mem_Set((CHAR *)szMask, (CHAR)0xFF,AMB_MAX_IPV6_ADDR_LEN);\
  (VOID)VOS_Mem_Set((CHAR *)szMask, 0, (ucPrefixLen / QCRT_NUM_BITS_IN_BYTE));\
...
/*Modify by q62011 for BC3D00979 end*/
...
extern RM_ERROR_S RM_CreateRouteRedist(RM_CFG_REDIST_S * pstRedistPolicy);
...
extern RM_ERROR_S RM_CFG_CmdPolicyInProc (ULONG ulProType,ULONG ulVrfIndex,RM_CFGREDISTRIBUTE_S* pstRedistIn);
extern RM_ERROR_S RM_CFG_CmdPolicyOutProc (ULONG ulProType,ULONG ulVrfIndex,RM_CFGREDISTRIBUTE_S* pstRedistOut);
extern RM_ERROR_S RM_CFG_CmdDistributeOutProc (ULONG ulProType,ULONG ulVrfIndex,RM_CFGDISTRIBUTE_S* pstDistExpIn);
extern RM_ERROR_S RM_CFG_CmdDistributeInProc (ULONG ulProType ,ULONG ulVrfIndex,RM_CFGDISTRIBUTE_S*  pstDistImpIn);
/* End: VISP1.7C03 VRF qinyun , 2009-01-20 */
