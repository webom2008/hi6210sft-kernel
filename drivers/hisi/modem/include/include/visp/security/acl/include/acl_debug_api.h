...
* firewall settings.
* 
* @param[in] pstHookFunc Pointer to the ACLCOMMON_LOG_HOOK_FUNC_S.  [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 On Success [FW_OK|NA]
* @retval UINT32 pstHookFunc is NULL pointer [FWIPSAFE_LOG_REGLOG_ERR_INPUT_NULL_POINTER|NA]
...
* 
* @retval UINT32 On Success [FW_OK|NA]
* @retval UINT32 Refer the return value of TCPIP_SetLogLevel of VISP control plane [NA|NA]
* @retval UINT32 Refer the return value of SFE_SetLogLevel of VISP data plane [NA|NA]
* 
* 
* @par Dependency
