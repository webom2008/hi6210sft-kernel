...
*
* @param[in] szName Timer name [NA]
* @param[out] NA NA [NA]
*
* @retval PACL_TIMERANGE_S Indicates timer pointer [NA|NA]
* @retval PACL_TIMERANGE_S Indicates no timer exist [NULL|NA]
*
* @par Dependency
* acl_trng_api.h
*
...
*
* @param[in] szName Timer name to be deleted [NA]
* @param[out] NA NA [NA]
*
*
* @retval ULONG In case of success ACL_TRNG_OK is returned. In error scenarios, corresponding
...
*
* @param[in] pThis Timer from which the periodic timer should be deleted. [NA]
* @param[in] ucDayofWeek Same as used in ACL_TRNG_AddPeriodic. [NA]
* @param[in] ulStartTime Same as used in ACL_TRNG_AddPeriodic [NA]
* @param[in] ulEndTime Same as used in ACL_TRNG_AddPeriodic [NA]
* @param[out] NA NA [NA]
*
* @retval ULONG In case of success ACL_TRNG_OK is returned. In error scenarios, corresponding
* unique error code is returned. [ACL_TRNG_OK |NA]
...
*
* @param[in] pThis Pointer to the timer to which the periodic timer has to be configured. [NA]
...
* For calculating the time in seconds for the parameters, the function "ACL_TRNG_TimeToSeconds" can be used. [NA]
...
* assigned automatically. [NA]
* @param[out] NA NA [NA]
*
*
*
* @retval Adding absolute timer is success [ULONGACL_TRNG_OK | NA]
* @retval Timer pointer is Null [ULONGACL_TRNG_ADD_ABS_TMR_NULL_POINTER_FOR_TIMER | NA]
* @retval Invalid index for absolute timer [ULONGACL_TRNG_ADD_ABS_TMR_INVALID_INDEX | NA]
* @retval Start time should not be greater than End time [ULONGACL_TRNG_ADD_ABS_TMR_START_TIME_MORE_THAN_END_TIME | NA]
* @retval Start/End time cannot maximum time period supported [ULONGACL_TRNG_ADD_ABS_TMR_TIME_OUT_OF_RANGE | NA]
* @retval Memory allocation failed [ULONGACL_TRNG_ADD_ABS_TMR_CREATION_FAILED | NA]
* @retval Duplicate Time Range [ULONGACL_TRNG_ADD_ABS_TMR_DUPLICATE_TIME_RANGE | NA]
* @retval Wrong timer index [ULONGACL_TRNG_ADD_ABS_TMR_WRONG_TMR_INDEX | NA]
* @retval Maximum timer reached [ULONGACL_TRNG_ADD_ABS_TMR_MAX_TIMERS_REACHED | NA]
* @retval Timer insert failed [ULONGACL_TRNG_ADD_ABS_TMR_FIRST_INSERT_FAILED | NA]
* @retval Duplicate timer ID [ULONGACL_TRNG_ADD_ABS_TMR_DUPLICATE_FAILED | NA]
* @retval Inserting absolute timer failed [ULONGACL_TRNG_ADD_ABS_TMR_INSERT_FAILED | NA]
*
* @par Dependency
* acl_trng_api.h
*
...
* 
* @param[in] pThis Timer from which the absolute timer should be deleted. [NA]
* @param[in] ulStartTime Same as used in ACL_TRNG_AddAbsolute. [NA]
* @param[in] ulEndTime Same as used in ACL_TRNG_AddAbsolute. [NA]
* @param[out] NA NA [NA]
*
*
* @retval ULONG Delete absolute timer is success [ACL_TRNG_OK | NA]
* @retval ULONG Null timer range [ACL_TRNG_DEL_ABS_TMR_NULL_PTR | NA]
* @retval ULONG No absolute timers are present [ACL_TRNG_DEL_ABS_TMR_NO_ABSOLUTE_TIMERS | NA]
* @retval ULONG Absolute timer does not exist [ACL_TRNG_DEL_ABS_TMR_NO_TIMER_EXIST | NA]
*
* @par Dependency
* acl_trng_api.h
*
...
* 
* @param[in] szName Pointer to the timer name for which the configuration needs to be displayed. [NA]
* @param[out] NA NA [NA]
*
* @retval ULONG In case of success ACL_TRNG_OK is returned. In error scenarios, corresponding
* unique error code is returned. [ACL_TRNG_OK |NA]
