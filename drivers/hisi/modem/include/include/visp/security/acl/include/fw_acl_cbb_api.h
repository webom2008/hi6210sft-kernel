...
* 
* @param[in] pstRegisterInfo Pointer to the structure containing the basic information of user defined custom types. [NA]
* @param[out] NA NA [NA]
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Input argument is NULL [Help_ACL_NULL_POINTER|NA]
* @retval ULONG Indicates ACL is not initialized successfully [Help_ACL_NOT_INIT|NA]
* @retval ULONG Indicates invalid rule type number [Help_ACL_TYPE_ID_ERROR|NA]
* @retval ULONG Indicates that the rule type ID is already in use [Help_ACL_TYPE_ID_EXIST|NA]
* @retval ULONG Indicates rule type number is out of range [Help_ACL_GROUP_RANGE_ERROR|NA]
* @retval ULONG Indicates that the rule content size is zero [Help_ACL_CONTENT_SIZEZERO|NA] 
* @retval ULONG Indicates function pointer is NULL [Help_ACL_FUNC_NULL|NA]
* @retval ULONG Indicates error in memory allocation for ACL type [Help_ACL_Type_MallocError|NA]
* @retval ULONG Indicates failed to allocate memory for the rule set [Help_ACL_Group_MallocError|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* 
* @param[in] ulTypeID ACL type ID. It must be ACL_ADVANCE_RULE_TYPE.[NA]
*                 ulLowNo ACL type ID lower range. [NA]
*                 ulUpNo ACL type ID upper range. [NA]
* @param[out] NA NA [NA]
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @par Dependency
...
* 
*
* @retval On success [Help_ACL_OK|NA]
* @retval Type ID is not ACL_ADVANCE_RULE_TYPE [Help_ACL_TYPE_ID_ERROR|NA]
* @retval Extended advance is already registered [Help_ACL_ERR_EXT_ADV_ALREADY_REGISTERED|NA]
* @retval Group range is not proper [Help_ACL_GROUP_RANGE_ERROR|NA]
* @retval Malloc error while initialization [Help_ACL_TYPE_ADV_MallocErr|NA]
* @retval failed to extended hash table for extended advance group [Help_ACL_STAT_ERR_ACL_INIT_SWITCH_STAT_HASHTABLE|NA]
*
* @par Note
...
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates that the ACL rule type does not exist [Help_ACL_TYPE_NOT_EXIST|NA]
* @retval ULONG Indicates error in ACL rule type ID [Help_ACL_TYPE_ID_ERROR|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* @param[in] ulLowNo The lower limit of the range. [NA]
* @param[in] ulUpNo The upper limit of the range. [NA]
* @param[out] NA NA [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates rule type does not exist [Help_ACL_TYPE_NOT_EXIST|NA]
* @retval ULONG Indicates error in ACL rule type ID [Help_ACL_TYPE_ID_ERROR|NA]
* @retval ULONG Indicates the range cannot be changed [Help_ACL_GROUP_RANGE_CANOT_CHANGE|NA]
* @retval ULONG Indicates error in the ACL group range that has been set [Help_ACL_GROUP_RANGE_ERROR|NA]
* @retval ULONG Indicates failed to allocate memory for the rule set [Help_ACL_Group_MallocError|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
...
* the range for the group numbers provided as the second and third fields of the structure ACL_TYPE_S. [NA]
...
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates invalid rule match order [Help_ACL_MatchOrderErr|NA]
* @retval ULONG Indicates the group number and the corresponding order does not match [Help_ACL_MatchOrderErr_Snd|NA]
* @retval ULONG Indicates error in ACL group number [Help_ACL_GroupNumError|NA]
* @retval ULONG Indicates rule group already exists [Help_ACL_Group_Exist|NA]
* @retval ULONG Indicates memory operation failure [Help_ACL_MallocError|NA]
* @retval ULONG Hash search function failed to search the group stat [Help_ACL_ERR_STAT_ADD_GROUP_HASH_SEARCH|NA]
* @retval ULONG Hash add function failed to add the group stat [Help_ACL_ERR_STAT_ADD_GROUP_HASH_INSERT|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* If it is set to false, then the rule group number indicated by ulGroupNum is deleted. [NA]
* @param[in] ulGroupNum ACL group number that needs to be deleted. The value for this parameter should lie in between 
* the range for the group numbers provided as the second and third fields of the structure ACL_TYPE_S. [NA]
* @param[out] NA NA [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates the ACL group number does not exist [Help_ACLGroup_Not_Exist|NA]
* @retval ULONG Indicates error in group number [Help_ACL_GroupNumError|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates error in match order input [Help_ACL_MatchOrderErr|NA]
* @retval ULONG Indicates the type ID of the ACL group and the 
* input match order does not match [Help_ACL_MatchOrderErr_Snd|NA]
* @retval ULONG Indicates the ACL group number does not exist [Help_ACLGroup_Not_Exist|NA]
* @retval ULONG Indicates match order cannot be changed since the group already has rules [Help_ACL_NotChangeMatchOrder|NA]
* @retval ULONG Indicates error in input group number [Help_ACL_GroupNumError|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* description as given in the parameter szDescription. [NA]
* @param[in] ulGroupNum ACL rule group number.  The value for this parameter should lie in between 
* the range for the group numbers provided as the second and third fields of the structure ACL_TYPE_S. [NA]
* @param[in] szDescription The description to be added. [NA]
* @param[out] NA NA [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates rule group does not exist [Help_ACLGroup_Not_Exist|NA]
* @retval ULONG Indicates error in group number [Help_ACL_GroupNumError|NA]
* @retval ULONG Indicates description is NULL [Help_ACL_DESCRIPTION_NULL|NA]
* @retval ULONG Indicates description is more than 128 bytes in length [Help_ACL_DescriptionTooLong|NA]
* @retval ULONG Indicates memory allocation failure [Help_ACL_MallocError|NA]
*  
* @par Dependency
* fw_acl_cbb_api.h
* 
...
*	- Zero : This will modify the setting to the value given in ulStep. [NA]
* @param[out] NA NA [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates rule group does not exist [Help_ACLGroup_Not_Exist|NA]
* @retval ULONG Indicates error in step-size value [Help_ACL_ERRSTEP|NA]
* @retval ULONG Indicates error in group number [Help_ACL_GroupNumError|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
...
*	- 2 - For using the default order [NA]
* @param[in] ulMatchOrder Rule match order to be set. It can be one of the following:
*	- Default(0)
*	- Configuration(1)
*	- Auto(2) [NA]
...
*	- 2 - For using the default step size [NA]
...
*	- 2 - For using the default description [NA]
* @param[in] pDescription The description of this particular group. [NA]
* @param[out] NA NA [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates error in group number [Help_ACL_GroupNumError|NA]
* @retval ULONG Indicates group number is not present [Help_ACLGroup_Not_Exist|NA]
* @retval ULONG Indicates error in group number [Help_ACL_GroupNumError|NA]
* @retval ULONG Indicates error in rule match order [Help_ACL_MatchOrderErr|NA]
* @retval ULONG Indicates the Type ID of the ACL group and the 
* input match order does not match [Help_ACL_MatchOrderErr_Snd|NA]
* @retval ULONG Indicates memory allocation failure [Help_ACL_Group_MallocError|NA]
* @retval ULONG Indicates Hash search function failed to search the group stat[Help_ACL_ERR_STAT_ADD_GROUP_HASH_SEARCH|NA]
* @retval ULONG Hash add function failed to add the group stat[Help_ACL_ERR_STAT_ADD_GROUP_HASH_INSERT|NA]
* @retval ULONG Indicates match order cannot be set as DEFAULT order [Help_ACL_NotChangeMatchOrder|NA]
* @retval ULONG Indicates error in step-size value [Help_ACL_ERRSTEP|NA]
* @retval ULONG Indicates description is NULL [Help_ACL_DESCRIPTION_NULL|NA]
* @retval ULONG Indicates description is more than 128 bytes in length [Help_ACL_DescriptionTooLong|NA]
* @retval ULONG Indicates memory operation failure [Help_ACL_MallocError|NA]
...
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates error in operation type [Help_ACL_NotSupportOperType|NA]
* @retval ULONG Indicates error in group number [Help_ACL_GroupNumError|NA]
* @retval ULONG Indicates group number is not present [Help_ACLGroup_Not_Exist|NA]
* @retval ULONG Indicates error in group number [Help_ACL_GroupNumError|NA]
* @retval ULONG Indicates error in rule match order [Help_ACL_MatchOrderErr|NA]
...
* [Help_ACL_ERR_STAT_ADD_GROUP_HASH_SEARCH|NA]
* @retval ULONG Hash add function failed to add the group stat[Help_ACL_ERR_STAT_ADD_GROUP_HASH_INSERT|NA]
* @retval ULONG Indicates match order cannot be set as DEFAULT order [Help_ACL_NotChangeMatchOrder|NA]
* @retval ULONG Indicates error in step-size value [Help_ACL_ERRSTEP|NA]
* @retval ULONG Indicates description is NULL [Help_ACL_DESCRIPTION_NULL|NA]
...
* ACL_DELETE_ALL_RULE, 0xFFFFFFFF, all the rules under the specified group will be deleted. [NA]
* @param[out] NA NA [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates error in group number [Help_ACL_GroupNumError|NA]
* @retval ULONG Indicates rule group does not exist [Help_ACLGroup_Not_Exist|NA]
* @retval ULONG Indicates rule number does not exist [Help_ACL_Subitem_Number_Not_Exist|NA]
* @retval ULONG Indicates failure to open ACL interface configuration [ACLFW_ERR_NULL|NA]
* @retval ULONG Indicates failure to open ACL interface configuration [ACLFW_ERR_SFE_ACLFW_SECPOLICY_OPEN_INIT|NA]
* @retval ULONG Indicates end table error [ACLFW_ERR_END_TABLE|NA]
* @retval ULONG Indicates failure to open the table [ACLFW_ERR_IF_TABLE|NA]
* @retval ULONG Indicates memory allocation error [ACLFW_ERR_MEM|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* the basic ACL rule information [NA]
* @param[out] NA NA [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG RuleInfo argument is NULL or Internal Memory operation fails [Help_ACL_ERR|NA]
* @retval ULONG Indicates NULL argument [ACLFW_ERR_NULL|NA]
* @retval ULONG Indicates failure to open ACL interface configuration [ACLFW_ERR_SFE_ACLFW_SECPOLICY_OPEN_INIT|NA]
* @retval ULONG Indicates end table error [ACLFW_ERR_END_TABLE|NA]
* @retval ULONG Indicates error in ACL group number [Help_ACL_GroupNumError|NA]
* @retval ULONG Indicates the ACL group number does not exists [Help_ACLGroup_Not_Exist|NA]
* @retval ULONG Indicates invalid rule type number [Help_ACL_TYPE_ID_ERROR|NA]
* @retval ULONG Indicates number of ACL Rule exceeds limit [Help_ACL_AccessListTooMuchRulesNormal|NA]
* @retval ULONG Indicates number of ACL Rules per group exceeds limit [Help_ACL_AccessInGroup|NA]
* @retval ULONG Indicates error in step-size value [Help_ACL_ERRSTEP|NA]
* @retval ULONG Indicates error in VRF operation type [Help_ACL_ActionError|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* the advanced ACL rule information [NA]
* @param[out] NA NA [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates error in input arguments [Help_ACL_ERR|NA]
* @retval ULONG Indicates error in group number [Help_ACL_GroupNumError|NA]
* @retval ULONG Indicates group number is not present [Help_ACLGroup_Not_Exist|NA]
* @retval ULONG Indicates invalid rule type number [Help_ACL_TYPE_ID_ERROR|NA]
* @retval ULONG Indicates number of ACL Rule exceeds limit [Help_ACL_AccessListTooMuchRulesNormal|NA]
...
* @retval ULONG Indicates error in step-size value [Help_ACL_ERRSTEP|NA]
* @retval ULONG Indicates rule number does not exist [Help_ACL_Subitem_Number_Not_Exist|NA]
* @retval ULONG Indicates error in providing new rule Id [Help_ACL_CANOT_GIVEID|NA]            
* @retval ULONG Indicates error in number of rules in a group [Help_ACL_TooMuchRulesINGroup|NA] 
* @retval ULONG Indicates error in ACL rule number [Help_ACL_SubIDTooLarge|NA]
* @retval ULONG Indicates rule already exist [Help_ACL_RULES_EXIST|NA]
* @retval ULONG Indicates invalid action value [Help_ACL_ActionError|NA]
* @retval ULONG Indicates invalid port number [Help_ACL_CannotSetPortNum|NA]
* @retval ULONG Indicates invalid ICMP port number [Help_ACL_ERR_ICMPTYPE|NA]
* @retval ULONG Indicates invalid precedence value specified [Help_ACL_PreError|NA]
* @retval ULONG Indicates invalid TOS value specified [Help_ACL_TosError|NA]
* @retval ULONG Indicates invalid DSCP value specified [Help_ACL_DscpError|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* the interface based ACL rule information [NA]
* @param[out] NA NA [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates error in input arguments or memory operation error [Help_ACL_ERR|NA]
* @retval ULONG Indicates error in group number [Help_ACL_GroupNumError|NA]
* @retval ULONG Indicates group number is not present [Help_ACLGroup_Not_Exist|NA]
* @retval ULONG Indicates invalid rule type number [Help_ACL_TYPE_ID_ERROR|NA]
* @retval ULONG Indicates number of ACL Rule exceeds limit [Help_ACL_AccessListTooMuchRulesNormal|NA]
...
* @retval ULONG Indicates error in number of rules in a group [Help_ACL_TooMuchRulesINGroup|NA] 
* @retval ULONG Indicates error in ACL rule number [Help_ACL_SubIDTooLarge|NA]
* @retval ULONG Indicates error in modifying rule [Help_ACL_NOTMODIFY|NA]
* @retval ULONG Indicates rule already exist [Help_ACL_RULES_EXIST|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
...
* the MAC based ACL rule information [NA]
* @param[out] NA NA [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates error in input arguments / memory operation error [Help_ACL_ERR|NA]
* @retval ULONG Indicates error in group number [Help_ACL_GroupNumError|NA]
* @retval ULONG Indicates group number is not present [Help_ACLGroup_Not_Exist|NA]
* @retval ULONG Indicates invalid rule type number [Help_ACL_TYPE_ID_ERROR|NA]
* @retval ULONG Indicates number of ACL Rule exceeds limit [Help_ACL_AccessListTooMuchRulesNormal|NA]
...
* @retval ULONG Indicates invalid action value [Help_ACL_ActionError|NA]
* @retval ULONG Indicates rule already exist [Help_ACL_RULES_EXIST|NA]
* @retval ULONG Indicates frame type error [Help_ACL_FrameTypeError|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* the range for the group numbers provided as the second and third fields of the structure ACL_TYPE_S [NA]
* @param[in] ulRuleIndex The rule number [0-0XFFFFFFFF]
* @param[in] ulLog Log information [NA]
* @param[in] pContent The content rules [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates error in input arguments/memory operation error [Help_ACL_ERR|NA]
* @retval ULONG Indicates error in group number [Help_ACL_GroupNumError|NA]
...
* 
* @param[in,out] pulGroupNum Pointer to ACL group number [NA]
* 
* @retval ULONG Success [VOS_OK|NA]
* @retval ULONG Pointer to ACL group number is null [VOS_ERR|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* the range for the group numbers provided as the second and third fields of the structure ACL_TYPE_S. [NA]
* @param[in] pMatchInfo IP Packet header information to be matched. IPPACKETINFO_S structure should be used. [NA]
* @param[in] bIsCount Whether the statistics of rule matching needs to be stored in the ACL Rules or not [NA]
* @param[out] pulRuleIndex ACL rule that matches the current packet info [NA]
* @param[out] pbLog Whether logging is currently enabled for the matching rule. [NA]
* 
* @retval ULONG Indicates rule matched and the matched rules action is "permit". [ACL_PERMIT|NA]
* @retval ULONG Indicates rule matched and the matched rules action is "deny". [ACL_DENY|NA]
...
* 
* @param[in] pPktHdr Pointer to input packet header [NA]
...
* If any rule matches, the function returns the matching rule node number. It also returns whether the log is enabled or not.
* 
* @param[in] ulInIfIndex Inbound interface index [NA]
* @param[in] ulOutIfIndex Outbound interface index [NA]
...
* @param[in] ulGroupNum Group number. The value for this parameter should lie in between 
* the range for the group numbers provided as the second and third fields of the structure ACL_TYPE_S. [NA]
* @param[in] ulVrfIndex VRF index [NA]
* @param[out] pulRuleIndex ACL rule that matches the current packet info [NA]
* @param[out] pbLog Whether logging is currently enabled for the matching rule. [NA]
* 
* @retval ULONG Indicates rule matched and the matched rules action is "permit". [ACL_PERMIT|NA]
...
* 
* @param[in] ulMID Module number [NA]
* @param[out] NA NA [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG ACL already initialized [Help_ACL_INIT_ERR|NA]
* @retval ULONG g_pstSemForACL_share malloc error [Help_ACL_ACC_SEMSHARE_MallocError|NA]
* @retval ULONG Failed to register lock [Help_ACL_ERR_CreateSm|NA]
* @retval ULONG Failed to add semaphore shared variable to name DB [Help_ACL_ERR_SEMAPHORE_ADDNAMEDB|NA]
* @retval ULONG Failed to malloc g_pstAccACL_share global variable [Help_ACL_ACC_SHARE_MallocError|NA]
* @retval ULONG Failed to add g_pstAccACL_share shared variable to name DB [Help_ACL_ERR_ACC_ADDNAMEDB|NA]
* @retval ULONG Failed to malloc g_pulAclGroupNumSum_share global variable [Help_ACL_ACLGROUPNUMSUM_SHARE_MallocError|NA]
* @retval ULONG Failed to add g_pulAclGroupNumSum_share shared variable to name DB [Help_ACL_ERR_ACLGROUPNUMSUM_ADDNAMEDB|NA]
* @retval ULONG Failed to malloc g_pbFM_share global variable [Help_ACL_FM_SHARE_MallocError|NA]
* @retval ULONG Failed to add g_pbFM_share shared variable to name DB [Help_ACL_ERR_FM_ADDNAMEDB|NA]
* @retval ULONG Failed to malloc g_pstACL_share global variable [Help_ACL_GLOBALSTRUCT_SHARE_MallocError|NA]
* @retval ULONG Failed to malloc basic rule type [Help_ACL_TYPE_BASIC_MallocErr|NA]
* @retval ULONG Failed to malloc basic acl group [Help_ACL_GROUP_BASIC_MallocErr|NA]
* @retval ULONG Failed to malloc advance rule type [Help_ACL_TYPE_ADV_MallocErr|NA]
* @retval ULONG Failed to malloc advance acl group [Help_ACL_GROUP_ADV_MallocErr|NA]
* @retval ULONG Failed to malloc interface based rule type [Help_ACL_TYPE_IF_MallocErr|NA]
* @retval ULONG Failed to malloc interface based acl group [Help_ACL_GROUP_IF_MallocErr|NA]
* @retval ULONG Failed to malloc mac based rule type [Help_ACL_TYPE_MAC_MallocErr|NA]
* @retval ULONG Failed to malloc mac based ACL group [Help_ACL_GROUP_MAC_MallocErr|NA]
* @retval ULONG Failed to add g_pstACL_share shared variable to name DB [Help_ACL_ERR_ACLGLOBALSTRUCT_ADDNAMEDB|NA]
* @retval ULONG Failed to initialize statistics component [Help_ACL_ACL_STAT_INIT|NA]
* @retval ULONG Failed to malloc ACLFW debug switch [ACLFW_ERR_INIT_DBG_SWITCH_MALLOC|NA]
* @retval ULONG Failed to add ACLFW debug switch to name DB [ACLFW_ERR_SFE_INIT_DBG_SWITCH_ADDNAMEDB|NA]
* @retval ULONG Failed to initialize hash table [ACLFW_ERR_HASH_INIT|NA]
* @retval ULONG Failed to add g_pstACLFWDB_share shared variable to name DB  [ACLFW_ERR_INIT_CFGDB_ADDNAMEDB|NA]
* @retval ULONG Failed to malloc statistics timer [ACLFW_ERR_ACLFW_CORE_INIT_STAT_TIMER_MALLOC|NA]
* @retval ULONG Failed to add statistics timer shared variable to name DB [ACLFW_ERR_ACLFW_CORE_INIT_STAT_TIMER_DBADD|NA]
* @retval ULONG Failed to create statistics timer [ACLFW_ERR_ACLFW_CORE_INIT_STAT_TIMER_CREATE|NA]
* @retval ULONG Failed to initialize statistics timer [ACLFW_ERR_INIT_STAT_TIMER|NA]
* @retval ULONG Failed to initialize common Init module [Help_ACL_IPSAFE_INIT_FAIL|NA]
*
* 
* @par Dependency
* fw_acl_cbb_api.h
...
* The string should be of a length of 256 bytes. [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates error in input arguments [Help_ACL_ERR|NA]
* 
...
* 
* @param[in] NA NA [NA]
* @param[out] szTypeID[ACL_MAX_TYPEID] Array to get the type ID [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates error in input arguments [Help_ACL_ERR|NA]
* 
...
* of the rule type ID given in ulTypeID. [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates error in input arguments [Help_ACL_ERR|NA]
* @retval ULONG Indicates rule type does not exist [Help_ACL_TYPE_NOT_EXIST|NA]
...
* @param[in] ulGroupNum The ACL group number. The value for this parameter should lie in between 
* the range for the group numbers provided as the second and third fields of the structure ACL_TYPE_S. [NA]
* @param[out] pstGroupInfo Pointer to the structure that stores the group information. [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates NULL arguments [Help_ACL_ERR|NA]
* @retval ULONG Indicates error in group number [Help_ACL_GroupNumError|NA]
* @retval ULONG Indicates rule group does not exist [Help_ACLGroup_Not_Exist|NA]
* 
* @par Dependency
...
* @param[in] ulGroupNum The ACL group number. The value for this parameter should lie in between 
* the range for the group numbers provided as the second and third fields of the structure ACL_TYPE_S. [NA]
* @param[out] pulTypeID Pointer to the type ID. [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates NULL arguments [Help_ACL_ERR|NA]
* @retval ULONG Indicates error in group number [Help_ACL_GroupNumError|NA]
...
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates NULL arguments [Help_ACL_ERR|NA]
* @retval ULONG Indicates error in arguments [Help_ACL_CONTENT_NULL|NA]
* @retval ULONG Indicates error in group number [Help_ACL_GroupNumError|NA]
* @retval ULONG Indicates rule group does not exist [Help_ACLGroup_Not_Exist|NA]
* @retval ULONG Indicates rule number does not exist [Help_ACL_Subitem_Number_Not_Exist|NA]
* 
...
* else it resets the match count of the rules from the ACL group ulGroupNum [NA]
...
* @param[out] NA NA [NA]
* 
* @retval ULONG The total number of ACL groups. [NA|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* @param[out] NA NA [NA]
* 
* @retval ULONG The total number of ACL rules. [NA|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* @param[out] NA NA [NA]
* 
* @retval ULONG On success.Group number is valid [Help_ACL_OK|NA]
* @retval ULONG On failure. Group number is invalid [Help_ACL_ERR|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* @param[in] ulGroupNum The ACL group number. The value for this parameter should lie in between 
* the range for the group numbers provided as the second and third fields of the structure ACL_TYPE_S. [NA]
* @param[in] ulRuleIndex The ACL rule index number. [NA]
* @param[out] NA NA [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates error in group number [Help_ACL_GroupNumError|NA]
* @retval ULONG Indicates group does not exist [Help_ACLGroup_Not_Exist|NA]
* @retval ULONG Indicates rule number does not exist [Help_ACL_Subitem_Number_Not_Exist|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
...
* @param[in] ulGroupNum The ACL group number. The value for this parameter should lie in between 
* the range for the group numbers provided as the second and third fields of the structure ACL_TYPE_S. [NA]
* @param[out] pulVrfIndex Pointer to the VRF index [NA]
*
* @retval ULONG On Success [Help_ACL_OK|NA]
* @retval ULONG Indicates error in input arguments [Help_ACL_ERR|NA]
* @retval ULONG Indicates invalid group number [Help_ACL_GroupNumError|NA]
* @retval ULONG Indicates group doe snot exist [Help_ACLGroup_Not_Exist|NA] 
* @retval ULONG Indicates no rule is present in the group [Help_ACL_NO_RULES_EXIST|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* @param[in] ulGroupNum The ACL group number. The value for this parameter should lie in between 
* the range for the group numbers provided as the second and third fields of the structure ACL_TYPE_S. [NA]
* @param[in] ulRuleIndex Rule Index for which the VRF must be searched. [NA]
* @param[out] pulVrfIndex Pointer to the VRF index [NA]
*
* @retval ULONG On Success [Help_ACL_OK|NA]
* @retval ULONG Indicates error in input arguments [Help_ACL_ERR|NA]
...
* 
* @param[in] ulIfIndex The index of the interface. [NA]
* @param[out] NA NA [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates error in the ACL interface type [Help_ACL_TYPE_NOT_EXIST|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* @param[out] NA NA [NA]
* 
* @retval BOOL_T Indicates ACL is accelerated [BOOL_TRUE|NA]
* @retval BOOL_T Indicates ACL is not accelerated [BOOL_FALSE|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* 
* @param[in] NA NA [NA]
* @param[out] pAccErr Pointer to enum containing the ACL Accelerated error codes. [NA]
* 
* @retval ULONG On success [ACL_RFC_SUCCESS|NA]
* @retval ULONG The input pointer is NULL [ACL_RFC_ERRORCODESTRUCTURE_NULL_PTR|NA]
* @retval ULONG Unable to allocate memory for Phase [ACL_RFC_UNABLE_TO_ALLOC_MEM_FOR_PHASE|NA]
* @retval ULONG Failed to allocate memory [FWCOMMON_RFC_INITCHUNK_MEM_MALLOC_FAIL|NA]
* @retval ULONG Failed to create memory for Rule [ACL_RFC_UNABLE_TO_ALLOC_MEM_FOR_RULE|NA]
* @retval ULONG Failed to create memory for Phase [ACL_RFC_UNABLE_TO_ALLOC_MEM_FOR_PHASE|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG On failure [Help_ACL_ERR|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* @param[out] NA NA [NA]
* 
* @retval ULONG  On success [ACLFW_OK|NA]
* @retval ULONG  ACL is not initialized [ACLFW_ERR_SFE_SETENABLE_INIT|NA]
* @retval ULONG  Input parameter is invalid. Value is other than ACL_YES/ACL_NO [ACLFW_ERR_PARA|NA]
*
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* 
* @retval ULONG  On success [ACLFW_OK|NA]
* @retval ULONG  pulFlag is null pointer [ACLFW_ERR_NULL|NA]
* @retval ULONG  ACL is not initialized [ACLFW_ERR_SFE_GETENABLE_INIT|NA]
*
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* 
* 
* @param[in] ulFlag Flag to enable or disable the ACL packet classification [NA]
* @param[out] NA NA [NA]
* 
* @retval ULONG  On success [ACLFW_OK|NA]
* @retval ULONG  ACL is not initialized [ACLFW_ERR_SFE_SETDEBUG_INIT|NA]
*
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* packet classification. [NA]
* 
* @retval ULONG  On success [ACLFW_OK|NA]
* @retval ULONG  ACL is not initialized [ACLFW_ERR_SFE_GETDEBUG_INIT|NA]
* @retval ULONG  pulFlag is null pointer [ACLFW_ERR_NULL|NA]
*
* @par Dependency
* fw_acl_cbb_api.h
...
* 
* @param[in] NA NA [NA]
* @param[out] pstStat Pointer to statistic structure [NA]
* 
* @retval ULONG On Success [ACLFW_OK|NA]
* @retval ULONG pstStat is null pointer [ACLFW_ERR_NULL|NA]
* @retval ULONG Firewall is not initialized [ACLFW_ERR_SFE_GETSTAT_INIT|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* 
* @retval ULONG On Success [ACLFW_OK|NA]
* @retval ULONG ulVCPUNum is invalid.  [ACLFW_ERR_SFE_GETVCPUSTAT_VCPU|NA]
* @retval ULONG pstStat is null pointer [ACLFW_ERR_SFE_GETVCPUSTAT_NULLPTR|NA]
* @retval ULONG Firewall is not initialized [ACLFW_ERR_SFE_GETVCPUSTAT_INIT|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* 
* @param[in] ulGroupNum Group Number [NA]
* @param[out] pstStat Pointer to statistic structure [NA]
* 
* @retval ULONG On Success [ACLFW_OK|NA]
* @retval ULONG pstStat is null pointer [ACLFW_ERR_SFE_GETGROUPSTAT_NULLPTR|NA]
* @retval ULONG Firewall is not initialized [ACLFW_ERR_SFE_GETGROUPSTAT_INIT|NA]
* @retval ULONG Error during search [ACLFW_ERR_SFE_ACLFW_GETGROUP_STAT_GROUPNOTFOUND|NA]
* @retval ULONG No entry found in Hash table during search [FWCOMMON_HASH_TABLE_ITEM_NOT_EXIST|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* 
* @param[in] ulGroupNum ACL Group Number [NA]
* @param[out] NA NA [NA]
* 
* @retval VOID This function does not return any value [NA|NA]
* 
...
* 
* @param[in] pstGroup Pointer to ACL Group [NA]
* @param[in] bIsNo To identify whether the node should be deleted. [NA]
* @param[out] pulRuleIndex Pointer to rule id [NA]
* @param[out] pbIsNew To identify whether it is an new rule or existing [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates error in input arguments / memory operation error [Help_ACL_ERR|NA]
* @retval ULONG Indicates number of ACL Rule exceeds limit [Help_ACL_AccessListTooMuchRulesNormal|NA]
* @retval ULONG Indicates rule doe snot exist for deletion [Help_ACL_Subitem_Number_Not_Exist|NA]
* @retval ULONG Indicates unable to provide new rule Id [Help_ACL_CANOT_GIVEID|NA]
* @retval ULONG Indicates number of ACL Rules per group exceeds limit [Help_ACL_AccessInGroup|NA]
* @retval ULONG Indicates rule number does not exist [Help_ACL_Subitem_Number_Not_Exist|NA]
* @retval ULONG Indicates error in step-size value [Help_ACL_ERRSTEP|NA]
* @retval ULONG Indicates error in number of rules in a group [Help_ACL_TooMuchRulesINGroup|NA] 
...
* 
* @param[in] pstGroup Pointer to ACL Group [NA]
* @param[in] bIsNew TRUE - To identify new rule, FALSE - To identify existing rule [NA]
* @param[in] ulRuleIndex ACL rule number [NA]
* @param[out] ppNode Pointer to a pointer to ACL rule node [NA]
* @param[out] ppRule Pointer to a pointer to ACL rule [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates error in input arguments / memory operation error [Help_ACL_ERR|NA]
* 
...
* 
* @param[in] pstGroup Pointer to input ACL Group [NA]
* @param[in] pRule Pointer to input ACL Rule Node [NA]
* @param[in] bIsNew TRUE - To identify new rule, FALSE - To identify existing rule [NA]
* @param[in] bIsNo TRUE - To identify the deleted node, FALSE - To identify the created node [NA]
* @param[out] NA NA [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates error in input arguments / memory operation error [Help_ACL_ERR|NA]
* @retval ULONG Indicates unable to modify the rule [Help_ACL_NOTMODIFY|NA]
* @retval ULONG Indicates rule already exists [Help_ACL_RULES_EXIST|NA]
* @retval ULONG Indicates rule does not exist for deletion [Help_ACL_Subitem_Number_Not_Exist|NA]
* @retval ULONG Indicates error in group number [Help_ACL_GroupNumError|NA]
* @retval ULONG Indicates group number is not present [Help_ACLGroup_Not_Exist|NA]
* @retval ULONG Indicates rule number does not exist [Help_ACL_Subitem_Number_Not_Exist|NA]
* @retval ULONG Indicates internal arguments are null pointers [ACLFW_ERR_NULL|NA]
* @retval ULONG Firewall is not initialized [ACLFW_ERR_SFE_ACLFW_SECPOLICY_OPEN_INIT|NA] 
* @retval ULONG No configuration entry founds[ACLFW_ERR_END_TABLE|NA]
* @retval ULONG Failed to register the handle [ACLFW_ERR_IF_TABLE|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* 
* @param[in] ulListNumber List number [NA]
* @param[out] pstFlow Flow Information [NA]
* @param[out] pulDscp DSCP Value [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates error in input arguments [Help_ACL_ERR|NA]
* 
...
* 
* @param[in] ulACLNumber ACL Group number [NA]
* @param[in] pstFlow Pointer to ACL Sub-Item [NA]
* @param[out] NA NA [NA]
* 
* @retval BOOL_T Input ACL Sub-Item exists inside the specified group [BOOL_TRUE|NA]
* @retval BOOL_T Input ACL Sub-Item does not exist inside the specified group.
*                If the matched ACL Sub-Item have action type as DENY [BOOL_FALSE|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* 
* @param[in] ulACLNumber ACL rule number [NA]
* @param[in] pstFlow ACL items provided [NA]
* @param[in] ucDSCP DSCP Value [NA]
* @param[out] NA NA [NA] 
* 
* @retval ULONG Not matching
*               If the matched ACL Sub-Item have action type as DENY [BOOL_FALSE|NA]
* @retval ULONG Matching [BOOL_TRUE|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* 
* @param[in] ulNumber ACL Group number [NA]
* @param[in] ulSubitem ACL Rule number [NA]
* 
* @retval ULONG Rule exist [1|NA]
* @retval ULONG Rule does not exist or error [0|NA] 
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
*
* @param[in] NA NA [NA]
* @param[out] pstAclconfig pointer to acl configuration structure [NA]
* 
* @retval VOID This function do not return anything [NA|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* 
* 
* @param[in] ulVrfIndex The VRF index. [NA]
* @param[out] NA NA [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG On failure [Help_ACL_ERR|NA]
...
* @param[out] NA NA [NA]
* 
* @retval ULONG Accurate rule match mode [0|NA]
* @retval ULONG Standard rule match mode [1|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates invalid input specified [Help_ACL_ERR|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
*
* @param[in] pstMBuf packet structure [NA]
* @param[in] pstFlow ACL Sub-Item [NA]
* @param[out] NA NA [NA]
* 
* @retval BOOL_T Packet matches with the ACL Sub-Item [BOOL_TRUE|NA]
* @retval BOOL_T Packet does not match with the ACL Sub-Item [BOOL_FALSE|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* @param[in] pstMBuf Packet structure [NA]
* @param[in] ulGroupNum Group number [NA]
* @param[out] pstFlow ACL sub-item [NA]
* 
* @retval ULONG Packet is permitted to pass [VOS_OK|NA]
* @retval ULONG Packet is not permitted to pass [VOS_ERR|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* @param[in] pstMBuf Packet structure [NA]
* @param[in] ulGroupNum ACL group number [NA]
* @param[out] pstFlow Pointer to ACL sub-item [NA]
* @param[out] pucDSCP Pointer to DSCP value [NA]
* 
* @retval ULONG Success [VOS_OK|NA]
* @retval ULONG Failure [VOS_ERR|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* source/destination IP address and source/destination port number reversed.
*
* @param[in] pstMBuf Packet structure [NA]
* @param[in] pstFlow ACL sub-item [NA]
* @param[out] NA NA [NA]
...
* 
* @param[in] pMBuf Pointer to packet structure [NA]
* @param[in] pItem Pointer to ACL sub-item [NA]
* @param[in] ucDSCP DSCP value [NA]
* @param[out] NA NA [NA]
* 
* @retval BOOL_T Packet matches with input ACL sub-item and DSCP [BOOL_TRUE|NA]
* @retval BOOL_T Packet does not match with input ACL sub-item and DSCP [BOOL_FALSE|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* specified group, with source/destination IP address and source/destination port number reversed.
* 
* @param[in] pMBuf Packet structure [NA]
* @param[in] ulGroupNum ACL group number [NA]
...
* @param[out] NA NA [NA]
* 
* @retval ULONG Rule matched and the matched rules action is "permit" [ACL_PERMIT|NA]
* @retval UL0NG Rule matched and the matched rules action is "deny" [ACL_DENY|NA]
* @retval ULONG IP Packet header information does not match with any rule inside the specified group. [ACL_NOTFOUND|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
*
* @param[in] pMBuf NA [NA]
* @param[in] ulNumber Group number NA [NA]
* @param[out] pulRuleIndex Pointer to matched rule number [NA]
* @param[out] pbLog Pointer to log flag [NA]
* 
* @retval ULONG Rule matched and the matched rules action is "permit" [ACL_PERMIT|NA]
* @retval UL0NG Rule matched and the matched rules action is "deny" [ACL_DENY|NA]
* @retval ULONG IP Packet header information does not match with any rule inside the specified group. [ACL_NOTFOUND|NA]
...
* @param[in] pstMbuf Packet structure [NA]
* @param[in] ulGroupNum Group number  [NA]
* @param[out] pulRuleIndex Matched rule index [NA]
* @param[out] pbLog Log flag [NA]
*
* @retval ULONG Permit packet [ACL_PERMIT|NA]
* @retval ULONG Deny packet [ACL_DENY|NA]
* @retval ULONG Rule Not matched [ACL_NOTFOUND|NA]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
...
* 
* @param[in] ulLowNo Lower Range [NA]
* @param[in] ulUpNo Upper Range  [NA]
* @param[out] NA
*
