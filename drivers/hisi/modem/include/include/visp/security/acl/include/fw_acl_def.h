...
/* Added by w60786 for A82D19436 2007-08-24 */
/* VLAN 类型值 */
...
#ifndef FWCOMMON_IpAddrToStr
#define FWCOMMON_IpAddrToStr(ulAddr, szStr, bufLen) (IPSAFE_ADP_nsprintf(szStr, bufLen, "%u.%u.%u.%u", (ulAddr >> 24) & 0xff,(ulAddr >> 16) & 0xff, (ulAddr >> 8) & 0xff,ulAddr & 0xff))
#endif
