...
* @datastruct ulSrcAddr Indicates source IP address.
* @datastruct ulSrcMask Indicates source mask.
* @datastruct ulDscAddr Indicates destination IP address.
...
* @datastruct ulRuleID Rule ID
* @datastruct usAction Indicates match action
* @datastruct usSrcMac Indicates source MAC address.
* @datastruct usSrcMask Indicates source MAC mask.
* @datastruct usDstMac Indicates destination MAC address.
...
* 
* @param[in] ulRet Indicates the error code [NA] 
...
*	- ACL_ADVANCE_RULE_TYPE (2) [NA] 
*	- ACL_EXTMAC_RULE_TYPE (4) [NA] 
* @param[in] pstPpiAcl Indicates null pointer. It stores the corresponding structure type [NA] 
* configuration values, based on the type of the rule; that is PPI_ACL_BASE_S or PPI_ACL_EXTEND_S or PPI_ACL_EXTENDMAC_S[NA/NA] 
* @param[out] NA NA [NA]
* 
...
* 
* @param[in] ulOprType Indicates operation type [NA]
* @param[in] ulGroupID Indicates the group ID [NA]
* @param[out] NA NA [NA]
* 
* @retval VOID This function does not return any value [NA|NA]
* 
...
* 
* @param[in] ulOprType Indicates the type of operation. [NA]
* @param[in] ulGroupID Indicates the group ID. [NA]
* @param[in] ulRuleID Indicates the rule ID. [NA]
* @param[in] ulIfIndex Indicates the interface index. [NA]
* @param[in] ulDirection Indicates the direction of packet transmission. [NA]
* @param[in] pstContext Indicates a null pointer. [NA]
* @param[out] NA NA [NA]
* 
* @retval VOID This function does not return any value [NA|NA]
* 
...
* @param[in] ulMsgType Indicates the type of message [NA]
* @param[in] pData Indicates configuration data sent to PPI callback function. [NA]
* 
* @retval VOID This function does not return any value [NA|NA]
* 
* @par Dependency
...
* 
* @param[in] ulOprType Indicates the type of operation [NA]
* @param[in] ulMsgType Indicates the message type [NA]
* @param[in] pData Indicates ACLFW configuration for an interface [NA]
* @param[out] NA NA [NA]
* 
...
* 
* @param[in] ulOprType Indicates operation type. It will be any value from E_ACLFW_PPI_OPR. [NA]
* @param[in] ulMsgType Indicates message type related to binding operation or statistics. [NA]
* @param[in] pData Indicates configured data if PPI_ACLFW_CFG_S if type is PPI_ACLFW_BIND.  
* Indicates statistics structure if ACLFW_HWSTAT_S if ulMsgType is PPI_ACLFW_STAT. [NA]
* 
* @retval ULONG Depends on registered callback function [NA|NA]
* 
* @par Dependency
* fw_acl_ppi.h
* 
...
* 
* @param[in] pfACLFWPPIHook Callback function to be registered. [NA]
* 
* @retval ULONG On success [ACLFW_OK|NA]
* @retval ULONG Indicates received null pointer as input argument [ACLFW_ERR_NULL|NA]
* 
* @par Dependency
* fw_acl_ppi.h
* 
...
* 
* @param[in] ulSwitch Value of debug switch to be set. [NA]
* 
* @retval ULONG On success [ACLFW_OK|NA]
* @retval ULONG Indicates wrong value to set debug switch. [ACLFW_ERR_PARA|NA]
* 
* @par Dependency
* fw_acl_ppi.h
* 
...
* 
* @param[out] pstCount Pointer to structure ACLFW_PPI_COUNT_S to which statistics will be copied. [NA]
*
* @retval ULONG On success [ACLFW_OK|NA]
* @retval ULONG Indicates received null pointer as in put argument [ACLFW_ERR_NULL|NA]
* 
* @par Dependency
* fw_acl_ppi.h
* 
...
* @param[out] NA NA [NA]
* 
* @retval VOID This function does not return ant value [NA|NA]
* 
* @par Dependency
* fw_acl_ppi.h
* 
...
* 
* @param[in] pstIfName Interface name for which statistics needs to be cleared. [NA]
* 
* @retval ULONG On success. [ACLFW_OK|NA]
* @retval ULONG Indicates received null pointer as input argument. [ACLFW_ERR_IFNAME|NA]
* @retval ULONG Indicates interface name length exceeds the limit. [ACLFW_ERR_IFNAME|NA]
* @retval ULONG Indicates failed to clear statistics. [ACLFW_ERR_PPI_CFG|NA]
* @retval ULONG Indicates no PPI call back function registered. [ACLFW_ERR_PPI_NOREG|NA]
* 
* @par Dependency
* fw_acl_ppi.h
* 
...
* 
*
* @param[out] pstStat Pointer to a structure ACLFW_HWSTAT_S to which statistics will be copied. [NA]
*
* @retval ULONG On success. [ACLFW_OK|NA]
* @retval ULONG Indicates received null pointer as input argument [ACLFW_ERR_NULL|NA]
* @retval ULONG Indicates no PPI call back function registered. [ACLFW_ERR_PPI_NOREG|NA]
* @retval ULONG Indicates failed to get statistics. [ACLFW_ERR_PPI_CFG|NA]
* 
* @par Dependency
* fw_acl_ppi.h
* 
...
* 
* @param[in] pstIfName Interface name for which statistics needs to be shown. [NA]
* @param[out] NA NA [NA]
* 
* @retval VOID This function does not return any value. [NA|NA]
* 
...
* 
* @param[in] ulSetYes Value to enable/disable the switch. [NA]
* 
* @retval ULONG On success [VOS_OK|NA]
* @retval ULONG Failed to set the switch [VOS_ERR|NA]
* 
* @par Dependency
* fw_acl_ppi.h
* 
...
* 
* @param[in] ulOprType Indicates operation type. It will be any value from PPI_MSG_TYPE_ACL_E [NA]
* @param[in] ulRuleType Indicates rule for group type (Basic/Advanced/MAC) [NA]
* @param[in] pstPpiAcl Indicates configured data (for rule update) and group number (for group update) [NA]
* @param[out] NA NA [NA]
* 
* @retval ULONG Depends on registered callback function [NA|NA]
* 
...
* 
* @param[in] pfAclPpiHook Callback function to be registered [NA]
* @param[out] NA NA [NA]
*
* @retval ULONG On success [VOS_OK|NA]
* @retval ULONG Indicates received null pointer as input argument [VOS_ERR|NA]
* 
* @par Dependency
* fw_acl_ppi.h
* 
...
* 
* @retval ULONG On success [VOS_OK|NA]
* @retval ULONG Indicates wrong value to set debug switch. [VOS_ERR|NA]
* 
* @par Dependency
* fw_acl_ppi.h
* 
...
* 
* @retval ULONG On success [ACLFW_OK|NA]
* @retval ULONG Indicates received null pointer as in put argument [VOS_ERR|NA]
* 
* @par Dependency
* fw_acl_ppi.h
* 
...
* 
* @param[in] pstMatchCount This structure contains for which group and rule match count is required. [NA]
* @param[out] pstMatchCount The match count for given group and rule will be copied into this structure. [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates received null pointer as input argument [Help_ACL_NULL_POINTER|NA]
* @retval ULONG Indicates there is no callback function registered  [Help_ACL_FUNC_NULL|NA]
* @retval ULONG Indicates failed to get match count  [Help_ACL_ERR_GETMATCHCOUNT|NA]
* 
* @par Dependency
* fw_acl_ppi.h
* 
...
* 
* @param[in] ulGroupID ACL group number for which match count is required. [NA]
* @param[in] ulRuleID ACL rule number for which match count is required. [NA]
* 
* @retval VOID This function does not return any value [NA|NA]
* 
* @par Dependency
...
* 
* @param[in] ulIfIndex Interface index for which configuration has to be deleted. [NA]
* @param[out] NA NA [NA]
* 
* @retval VOID This function does not return any value [NA|NA]
* 
