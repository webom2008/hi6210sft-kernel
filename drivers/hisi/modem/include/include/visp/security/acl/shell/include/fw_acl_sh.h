...
* 
* @param[in] pfFunc The call back function to be registered [NA]
* @param[in] ulModId ACL module number [NA]
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Function pointer is empty [Help_ACL_NULL_POINTER|NA]
* @retval ULONG The same module is already registered callback function [Help_ACL_CALLBACK_EXIST|NA]
* @retval ULONG Memory allocation failure [Help_ACL_MallocError|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* be between 1 and 47 [NA]
* @param[out] pszIfName Interface index as string. [NA]
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Failed to get interface name [Help_ACL_ERR_GETIFINDEX|NA]
* @retval ULONG Interface name exceeded maximum length [Help_ACL_ERR_GETIFINDEX_NAMELEN|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] ulRegPri Priority of hooking function. [NA]
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Failed to hook filtering function [ACLFW_ERR_PROTOCOL_STACK_HOOK|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] pRuleInfo The ACL rule that needs to be converted into ASCII string. [NA]
* @param[out] szOut The converted ACL command as ASCII string. [NA]
*
* @retval LONG The number of characters in converted ACL command string. [NA|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] pMBuf Pointer to MBUF_S structure. [NA]
*
* @retval UINT32 The message should be process by protocol stack [IP_PP4_NOT_PROCESSED_BY_INTERMEDIATE|NA]
* @retval UINT32 The message has been process by ACL. PP do not need to process the packet any more.
* [IP_PP4_PROCESSED_BY_INTERMEDIATE|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* @param[in] pMBuf Pointer to MBUF_S structure. [NA]
* 
* @retval ULONG Fill Description [Fill_Revturn_Value|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] pstMBuf MBUF pointer (message) [NA]
* @param[in] pstFlow Quintuple stream pointer [NA]
* @param[in] ucDSCP DSCP value. [NA]
*
* @retval BOOL_T Packet (MBUF) match a five-tuple flow and DSCP values [BOOL_TRUE|NA]
* @retval BOOL_T Packet (MBUF) does not match a five-tuple flow and DSCP values [BOOL_FALSE|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] pszIfName Interface name for which interface index is required. [NA]
* @param[out] pulIfIndex Interface index [NA]
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Error depends on adapter function [NA|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] pszVrfName It is VRF index name for which VRF index is required. [NA]
* @param[out] pulVrfIndex VRF Index. [NA]
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates failed to get VRF index [Help_ACL_ERR_GETVRFINDEX|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] ulVrfIndex VRF index for which VRF Index name is required [NA]
* @param[out] pszVrfName VRF Index name. [NA]
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Failed to get VRF index name [Help_ACL_ERR_GETVRFINDEX|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] ulIfIndex Interface index for which VRF index is required [NA]
* @param[out] pulVrfIndex VRF Index [NA]
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Failed to get VRF index [Help_ACL_ERR|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] pucIfName Interface name for which configuration is required. [NA]
* @param[out] pstShowCfg Configuration for that interface. [NA]
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates received null pointer [ACLFW_ERR_NULL|NA]
* @retval ULONG Indicates received wrong interface name [ACLFW_ERR_PARA|NA]
* @retval ULONG Indicates initialization is not done. [ACLFW_ERR_SFE_GETCFGBYIF_INIT|NA]
* @retval ULONG Indicates failed to get configuration for given interface. [ACLFW_ERR_NONODE|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] ulHandle Handle for ACLFW's configuration table. [NA]
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates received null pointer handle [ACLFW_ERR_NULL|NA]
* @retval ULONG Indicates failed to close ACLFW's configuration table. [ACLFW_ERR_IF_TABLE|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] pstFilter Filter for ACLFW's configuration table [NA]
* @param[out] pulHandle Handle for ACLFW's configuration table [NA]
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates received null pointer input [ACLFW_ERR_NULL|NA]
* @retval ULONG Indicates failed to open ACLFW's configuration table [ACLFW_ERR_IF_TABLE|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] ulHandle handle for ACLFW's configuration table. [NA]
* @param[out] pstShowObj Pointer to a structure in which ACLFW's first entry has to be copied. [NA]
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates received null pointer as input [ACLFW_ERR_NULL|NA]
* @retval ULONG Indicates there is no entry in configuration table. [ACLFW_ERR_NONODE|NA]
* @retval ULONG Indicates failed to get first entry from ACLFW's configuration table [Help_ACL_ERR|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] ulHandle Handle for configuration table of ACLFW [NA]
* @param[out] pstShowObj Pointer to a structure in which next entry of ACLFW has to be copied [NA]
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates received null pointer as input [ACLFW_ERR_NULL|NA]
* @retval ULONG Indicates reached end of the configuration table [ACLFW_ERR_END_TABLE|NA]
* @retval ULONG Indicates there is no entry in configuration table [ACLFW_ERR_NONODE|NA]
* @retval ULONG Indicates failed to get next entry from configuration table of ACLFW [Help_ACL_ERR|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] pszIfName Interface name for which configuration needs to be shown [NA]
* @param[out] NA NA [NA]
*
...
* 
* @param[in] ulACLInfoHandle Handle for ACL configuration table. [NA]
* @param[in] ulGroupNum ACL group number from which ACL rules needed. [NA]
* @param[out] pstACLInfo Pointer to ACL_RULE_INFO_OUT_S structure in which ACL rule data to be copied. [NA]
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates received null pointer as input [Help_ACL_NULL_POINTER|NA]
* @retval ULONG Indicates given group number does not match with the group number given in handle [Help_ACL_ERR|NA]
* @retval ULONG Indicates given group number does not exist [Help_ACL_Not_Exist|NA]
* @retval ULONG Indicates failed to get next rule from the list [Help_ACL_WAITLIST_GetFail|NA]
* @retval ULONG Indicates reached end of the rules list [Help_ACL_END|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] ulGroupNum ACL group number for which rules information is required. [NA]
* @param[in] pstACLFilter Filter for ACL rules configuration table. [NA]
* @param[out] pulACLInfoHandle Pointer to handle for ACL configuration table. [NA]
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates received null pointer as input [Help_ACL_NULL_POINTER|NA]
* @retval ULONG Indicates given group number does not exist [Help_ACL_Not_Exist|NA]
* @retval ULONG Indicates reached end of the rules list [Help_ACL_END|NA]
* @retval ULONG Indicates failed to open ACL rules list [Help_ACL_WAITLIST_OpenFail|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates received null pointer as input [Help_ACL_ERR|NA]
* @retval ULONG Indicates failed to close ACL rules list [Help_ACL_WAITLIST_CloseFail|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] pstMbuf Pointer to MBUF message [NA]
...
* @param[in] ulGroupNum ACL group number in which rules needs to be checked. [NA]
* @param[out] pbLog Which says whether any rule is matched for given packet or not. [NA]
* @param[out] pulRuleIndex Index of the matched rule for given packet. [NA]
*
* @retval ULONG ACL says PERMIT the packet [ACL_PERMIT|NA]
* @retval ULONG ACL says DENY the packet [ACL_DENY|NA]
* @retval ULONG ACL says no rule matched for the packet [ACL_NOTFOUND|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] ulAclWaitListHandle Handle for ACL group list. [NA]
* @param[out] pstGroupInfo Pointer to structure in which group information needs to be copied. [NA]
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates received null pointer as input [Help_ACL_NULL_POINTER|NA]
* @retval ULONG Indicates failed to get next group from ACL configuration list [Help_ACL_WAITLIST_GetFail|NA]
* @retval ULONG Indicates reached end of ACL configuration list [Help_ACL_END|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] pstGroupFilter Filter for ACL group configuration list. [NA]
*
* @param[out] ulAclWaitListHandle Handle for ACL group configuration list
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG  Indicates received null pointer as input [Help_ACL_NULL_POINTER|NA]
* @retval ULONG  Indicates there is no entry in ACL group configuration list. [Help_ACL_END|NA]
* @retval ULONG  Indicates failed to open ACL group configuration list. [Help_ACL_WAITLIST_OpenFail|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] ulAclWaitListHandle Handle for ACL group configuration list. [NA]
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates received null pointer as input [Help_ACL_NULL_POINTER|NA]
* @retval ULONG Indicates failed to close  ACL group configuration list [Help_ACL_WAITLIST_CloseFail|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] ulGroupNum ACL group number for which rules information is required. [NA]
* @param[out] pulAclWaitListHandle Handle for ACL rule configuration list. [NA]
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates received null pointer as input [Help_ACL_ERR|NA]
* @retval ULONG Indicates received invalid group number [Help_ACL_GroupNumError|NA]
* @retval ULONG Indicates received group does not exist [Help_ACL_Not_Exist|NA]
* @retval ULONG Indicates there is no entry in the configuration list [Help_ACL_END|NA]
* @retval ULONG Indicates failed to open ACL rules list [Help_ACL_WAITLIST_OpenFail|NA]
* 
* @par Dependency
* fw_acl_sh.h
...
* 
* @param[in] ulGroupNum ACL group number for which rules information is required. [NA]
* @param[in] ulAclWaitListHandle Handle for ACL rule configuration list. [NA]
* @param[out] pstRuleInfo Pointer to ACL_RULE_INFO_S structure in which ACL rule data to be copied. [NA]
*
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates received null pointer as input [Help_ACL_ERR|NA]
* @retval ULONG Indicates content info is null in received pstRuleInfo structure [Help_ACL_CONTENT_NULL|NA]
* @retval ULONG Indicates received invalid group number [Help_ACL_GroupNumError|NA]
* @retval ULONG Indicates received group does not exist [Help_ACL_Not_Exist|NA]
* @retval ULONG Indicates failed to get first entry from ACL rules list  [Help_ACL_WAITLIST_SetFail|NA]
* @retval ULONG Indicates there is no entry in the configuration list [Help_ACL_END|NA]
* 
* @par Dependency
* fw_acl_sh.h
...
* @retval ULONG Indicates received invalid group number [Help_ACL_GroupNumError|NA]
* @retval ULONG Indicates received group does not exist [Help_ACL_Not_Exist|NA]
* @retval ULONG Indicates failed to get next entry from ACL rules list  [Help_ACL_WAITLIST_GetFail|NA]
* @retval ULONG Indicates there is no entry in the configuration list [Help_ACL_END|NA]
* 
* @par Dependency
* fw_acl_sh.h
...
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates received null pointer as input [Help_ACL_ERR|NA]
* @retval ULONG Indicates failed to close ACL rule configuration list [Help_ACL_ERR|NA]
* 
* @par Dependency
* fw_acl_sh.h
* 
...
* 
* @param[in] psAcl_BasicRule Pointer to the basic rule ACL structure. [NA]
* @param[out] NA NA [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
...
* @retval ULONG Indicates error in getting VRFIndex [Help_ACL_ERR_GETVRFINDEX|NA]
...
* 
* @param[in] psAcl_AdvRule Pointer to the advanced ACL rule structure. [NA]
* @param[out] NA NA [NA]
* 
* @retval ULONG On success [Help_ACL_OK|NA]
* @retval ULONG Indicates error in input arguments / memory operation error [Help_ACL_ERR|NA]
...
*
* @param[in] pstFWCfg Pointer to configuration structure [NA]
* @param[out] NA NA [NA]
* 
* @retval ULONG On Success [ACLFW_OK|NA]
* @retval ULONG User calls delete for interface index which is not configured [ACLFW_ERR_NONODE|NA]
* @retval ULONG Input pointer is null [ACLFW_ERR_NULL|NA]
* @retval ULONG Interface name length is 0 [ACLFW_ERR_PARA|NA]
* @retval ULONG Failed to find the interface index for given interface name. Or failed to convert
          interface name in to integer value[ACLFW_ERR_IFNAME|NA]
* @retval ULONG ulFlag contains value other than ACLFW_CFG_ADD or ACLFW_CFG_DEL [ACLFW_ERR_PARA|NA]
* @retval ULONG ulDirection contains value other than 
          ACLFW_FITLERTYPE_IN/ACLFW_FITLERTYPE_OUT/ACLFW_FITLERTYPE_MACIN/ACLFW_FITLERTYPE_MACOUT [ACLFW_ERR_IFNAME|NA]
* @retval ULONG ulGroup is not valid. ulGroup in not in the range of ACL_ADV_MAX_EXT/ACL_BAS_MIN_EXT for ulDirection ACLFW_FITLERTYPE_IN/ACLFW_FITLERTYPE_OUT 
          ulGroup is not in the range of ACL_EXTMAC_MAX_EXT/ACL_EXTMAC_MIN_EXT fro ulDirection ACLFW_FITLERTYPE_MACIN/ACLFW_FITLERTYPE_MACOUT[ACLFW_ERR_PARA|NA]
* @retval ULONG Firewall is not initialized [ACLFW_ERR_SFE_CFGSECPOLICY_INIT|NA]
* @retval ULONG Internal configuration error occurs [ACLFW_ERR_SFE_ACLFW_CFG_SECPOLICY_CONFIG|NA]
* @retval ULONG PPI callback error occurs [ACLFW_ERR_PPI_CFG|NA]
*
* @par Dependency
* None
* 
...
* 
* @param[in] pszIfName Null terminated interface name [NA]
* @param[out] NA NA [NA]
* 
* @retval VOID This function does not return any value. [NA|NA]
* 
...
*	- 0 - Information of the specified rule will be displayed. [NA]
* @param[in] ulRuleNumber ACL Rule number [NA]
* @param[out] NA NA [NA] 
* 
* @retval VOID This function do not return any value. [NA|NA]
* 
* @par Dependency
* None
* 
