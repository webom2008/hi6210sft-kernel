...
*
*  Project Code: V1.1.0
*   Module Name: packet adapter
*  Date Created: 2010-1-08
*        Author: z00142640/z62474 
*   Description: security packet adapter file
*
*-------------------------------------------------------------------------------
...
*
*  2011-8-4       Eswar  72335      Added VLAN ID parameter in packet structure.
*******************************************************************************/
...
/*This macro is defined here to get the mac address position from the given FWCOMMON_IPPACKETINFO_S structure pointer*/
...
*
* @retval UINT32 Successful [FWCOMMON_MSGADAPTOR_OK|NA]
* @retval UINT32 Appropriate error code from FWCOMMON_MSG_ADAPTOR_ERR_CODE_E[NA]
* 
* @par Dependency
...
* @retval UINT32 Indicates the source IP address is a broadcast address [FWCOMMON_MSGADAPTOR_BROADCAST_IPSPOOFING_SH|NA]
* @retval UINT32 Indicates the source IP address does not exist in FIB table [FWCOMMON_MSGADAPTOR_IP_NOT_IN_FIB_IPSPOOFING_SH|NA]
* @retval UINT32 Indicates the received interface of the packet is different with the interface to 
* send a packet to the source IP [FWCOMMON_MSGADAPTOR_INTERFACE_NOT_SAME_IPSPOOFING_SH|NA]
*
* @par Dependency
* ad_inc.h
* 
