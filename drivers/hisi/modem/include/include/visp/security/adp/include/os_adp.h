...
*
*  Project Code: V1.1.0
*   Module Name: os adapter
*  Date Created: 2010-1-08
*        Author: z00142640/z62474 
*   Description: os adapter function
*
*-------------------------------------------------------------------------------
...
*  2011-05-05    r72335                   Merged firewall and NAT adapters
*******************************************************************************/
...
*        Input: INT8 *pcstr: Char string array <Not null pointer>
*       Output: NA
...
*
*******************************************************************************/
UINT32 IPSAFE_ADP_StrLen(INT8 *pcstr);
...
*
*******************************************************************************/
INT32 IPSAFE_ADP_StrNCmp(INT8 *pscStr1, INT8 * pscStr2, UINT32 ulCount);
...
*        Input: INT8 *pscFormat: Format<Not null pointer>
*       Output: NA
*       Return: 0: Success
*               Other: Fail
*      Caution: NA
...
*
*******************************************************************************/
UINT32 IPSAFE_ADP_Printf(INT8 *pscFormat, ...);


/*******************************************************************************
*    Func Name: IPSAFE_ADP_nsprintf
* Date Created: 2010-03-30
*       Author: zhangchunyu(62474)
*      Purpose: Format output to memory
*  Description: Format output to memory like spritf
*        Input: INT8 *: Output memory<Not null pointer>
*               UINT32 ulCount - Buffer Length
*               INT8 *: Format string<Not null pointer>
*       Output: NA
*       Return: 0: Success
*               Other: Fail
*      Caution: NA
...
*
*******************************************************************************/
UINT32 IPSAFE_ADP_nsprintf(CHAR *, UINT32 ulCount, CHAR *, ...);
...
*
*******************************************************************************/
VOID *IPSAFE_ADP_MemSet(VOID *pvToSet, INT8 scChar, UINT32 uvCount);
...
*        Input: INT8 * pscStr1: String array 1<Not null pointer>
*               INT8 * pscStr2: String array 2<Not null pointer>
*       Output: NA
...
*
*******************************************************************************/
INT32 IPSAFE_ADP_StrCmp(INT8 * pscStr1, INT8 * pscStr2);
...
*        Input: INT8 * pcstring: String array<Not null pointer>
*               INT8 * pccontrol: String adday address<Not null pointer>
*       Output: NA
...
*
*******************************************************************************/
INT8*  IPSAFE_ADP_StrTok(INT8 * pcstring, INT8 * pccontrol);
...
*        Input: INT8 *str: String array<Not null pointer>
*       Output: NA
*       Return: VOID
*      Caution: NA
*        Since: V200R003C01
...
*
*******************************************************************************/
VOID IPSAFE_ADP_UpperCase(INT8 *str);
...
*        Input: INT8 *pcStr: String array<Not null pointer>
...
*
*******************************************************************************/
INT32 IPSAFE_ADP_Atoul(INT8 *pcStr, UINT32 *pulVal);
...
*
*******************************************************************************/
INT32 IPSAFE_ADP_StrToInt32(INT8 *szStr, INT32 *pslVal);
...
*        Input: INT8 *pi8DstString  : pointer to destination
*               UINT32 ulDstLen     : Destination memory length
*               INT8 *pi8SrcString  : pointer to source string
...
*
*******************************************************************************/
INT8 * IPSAFE_ADP_StrnCpy(INT8 *pi8DstString, UINT32 ulDstLen, INT8 *pi8SrcString, UINT32 u32Count);
...
*        Input: INT8 *pi8String1: pointer to the first string
*               INT8 *pi8String2: pointer to the second string
*       Output: NA
...
*
*******************************************************************************/
INT32 IPSAFE_ADP_StrICmp(INT8 *pi8String1, INT8 *pi8String2);
...
*
*******************************************************************************/
INT32 IPSAFE_ADP_StrNiCmp(INT8 *pi8Str1, INT8 *pi8Str2, UINT32 u32Count);
...
*        Input: INT8* pi8Name: The name to be removed from the data base
...
*
*******************************************************************************/
UINT32 IPSAFE_ADP_MCMemNameDBRemove(INT8* pi8Name, UINT32 u32Type);
