 ...
 *  2010-03-02      Arjun 00900868                  Create
 ************************************************************************/
typedef VOID (*FWIPSAFE_DEBUG_OUTPUT_CALLBACK_FUNC)(INT8 *pu8DebugOutput);
 ...
 *  2010-03-02      Arjun 00900868                  Create
 ************************************************************************/
typedef VOID (*FWIPSAFE_INFO_OUTPUT_CALLBACK_FUNC)(INT8 *pu8InfoOutput);
...
*   Input: pfDebugOutput: Function pointer of type FWIPSAFE_DEBUG_OUTPUT_CALLBACK_FUNC. <NA>
*   Output: NA
...
*   Input: pfInfoOutput: Function pointer of type FWIPSAFE_INFO_OUTPUT_CALLBACK_FUNC. <NA>
*   Output: NA
*   Return: Success: FWIPSAFE_OK
