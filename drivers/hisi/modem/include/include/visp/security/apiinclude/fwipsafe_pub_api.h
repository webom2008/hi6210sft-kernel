...
{ 
    ...
    FWIPSAFE_FTP_BEGIN_RET_CODE   = 7000,   /* FTP module return begin error value */
...
/*******************************************************************************
*    Func Name:  FWIPSAFE_Init
*    Date Created: 2010-1-12
*    Author: zhangchi(00142640)
*    Purpose: Init function
*                
*    Description: This function allocates all the global variables depending on the pre 
*                   config parameters
*    Input:  VOID
*    Output: NA
*    Return: Success: FWIPSAFE_PUB_SUCCESS
*               Failure: 
*                           FWIPSAFE_INIT_ERR_MEMALLOC_SPINLOCK
*                           FWIPSAFE_INIT_ERR_CREATE_SPINLOCK
*                           FWIPSAFE_INIT_ERR_ADDNAME_SPINLOCK
...
*                           u32Ret: Refer FWIPSAFE_PUB_Init()
*                           u32Ret: Refer IPSAFE_FCInit()
*                           u32Ret: Refer NAT_Init()
*                           u32Ret: Refer ALG_Init()
*                           FWIPSAFE_INIT_ERR_MEMALLOC_GLOBALTIMER
*                           FWIPSAFE_INIT_ERR_CREATE_SHARE_TIMER
*                           FWIPSAFE_INIT_ERR_ADDNAME_GLOBALTIMER
