...
#define IPSAFE_DEBUG_MODULE_ALGFTP     0x00000010    /*Enables debug type switch for ALG FTP*/
...
*           pFormat: Indicates log message. Contains "%d", if any variable argument is passed.<NA> 
*           u32Para1: First parameter.<NA> 
*           u32Para2: Second parameter.<NA> 
*           u32Para3: Third parameter.<NA> 
*           u32Para4: Fourth parameter.<NA> 
*   Output: NA
*   Return: VOID
*   Caution: None
*   Since: V200R003C01
...
*               pFormat: Log Message. Contains "%s" in the message. <NA>
*               pData: NULL Terminated string. <NA>
*        
*   Output: NA
*   Return: VOID
*   Caution: None
...
*   Input: pu8DebugOutput: Null terminated string. <NA>
*   Output:         NA
*   Return: VOID
*   Caution: None
*   Since: V200R003C01
 ...
 *  2010-03-02      Arjun 00900868                  Create
 ************************************************************************/
typedef VOID (*IPSAFE_DEBUG_OUTPUT_CALLBACK_FUNC)(INT8 *pu8DebugOutput);
...
*   Input: pu8InfoOutput: Null terminated string <NA>
*   Output: NA
*   Return: VOID
*   Caution: None
*   Since: V200R003C01
 ...
 *  2010-03-02      Arjun 00900868                  Create
 ************************************************************************/
typedef VOID (*IPSAFE_INFO_OUTPUT_CALLBACK_FUNC)(INT8 *pu8InfoOutput);
...
*    Input: pstHookFunc: Indicates NULL pointer.<NA>
*    Output: NA
...
*   Input: pfDebugOutput: Function pointer of type IPSAFE_DEBUG_OUTPUT_CALLBACK_FUNC. <NA>
*   Output: NA
...
*   Input: pu32DebugTypeSwitch: Indicates pointer to debug type switch. <NA>
*          pu32DebugVcpuSwitch: Indicates pointer to VCPU type switch. <NA>
*          pu32DebugModuleSwitch : Indicates pointer to module information. <NA>
*   Output: pu32DebugTypeSwitch: Debug type information. <NA>
*           pu32DebugVcpuSwitch: Debug VCPU switch number. <0x00000001 to 0xFFFFFFFF>
*           pu32DebugModuleSwitch: Debug module information. <NA>
*   Return: Success: IPSAFE_OK
...
*   Input: pfInfoOutput: Function pointer of type IPSAFE_INFO_OUTPUT_CALLBACK_FUNC. <NA>
*   Output: NA
*   Return: Success: IPSAFE_OK
