...
* 
* @param[in] pApplicationHashTable Pointer to fragtable for which timeout has to be checked. [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 Timeout items deleted succesfully. [FWCOMMON_HASH_TABLE_OK|NA]
*
* @par Dependency
* 
* 
...
* 
* @param[in] pApplicationHashTable Pointer to hashtable for which timeout has to be checked. [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 Timeout items deleted succesfully. [FWCOMMON_HASH_TABLE_OK|NA]
*
