...
*   Description: security public api header
*
*-------------------------------------------------------------------------------
*  Modification History
*  DATE         NAME                      DESCRIPTION    
*  -----------------------------------------------------------------------------
*  2010-1-25    z00142640/z62474         Create the first version.
*  2010-10-20   Vinay Gudur              Added "DOPRA IPSAFE V200R003C02SPC050B010"
*  2010-10-26   Vinay Gudur              Added "DOPRA IPSAFE V200R003C02SPC050"
*  2011-01-18   Apurba Nagar             Added "IPSAFE NAT V200R003C02SPC060B030T010"
*  2011-02-16   Varun 71873              Modified version number to "IPSAFE NAT V200R003C02SPC060"
*  2011-03-11   Varun 71873              Modified version number to "IPSAFE NAT V200R003C02SPC070B010"
*  2011-03-16   Apurba Nagar             Modified version number to "IPSAFE NAT V200R003C02SPC070"
*******************************************************************************/
...
{ 
    ...
    IPSAFE_FTP_BEGIN_RET_CODE   = 7000,   /* FTP module return begin error value */
...
/*******************************************************************************
*    Func Name:  IPSAFE_Init
*    Date Created: 2010-1-12
*    Author: zhangchi(00142640)
*    Purpose: Initializes all the modules required by NAT, including NAT.
*  Description: This function initializes NAT and related components, and 
*               returns IPSAFE_PUB_SUCCESS on successful initialization.
*        Input: NAT_PRE_CFG_S *pstPreCfg: Pointer to the NAT pre-configuration 
*               structure.<Non null pointer>
*       Output: NA
*    Return: Success: IPSAFE_PUB_SUCCESS
*               Failure: IPSAFE_INIT_ERR_NULL_INPUT_PARA
*                           IPSAFE_INIT_ERR_MEMALLOC_SPINLOCK
*                           IPSAFE_INIT_ERR_CREATE_SPINLOCK
*                           IPSAFE_INIT_ERR_ADDNAME_SPINLOCK
*                           IPSAFE_INIT_ERR_SPIN_LOCK
*                           u32Ret: Refer Blk_init()
*                           u32Ret: Refer IPSAFE_PUB_Init()
*                           u32Ret: Refer IPSAFE_FCInit()
*                           u32Ret: Refer NAT_Init()
*                           u32Ret: Refer ALG_Init()
*                           IPSAFE_INIT_ERR_MEMALLOC_GLOBALTIMER
*                           IPSAFE_INIT_ERR_CREATE_SHARE_TIMER
*                           IPSAFE_INIT_ERR_ADDNAME_GLOBALTIMER
*                           IPSAFE_INIT_ERR_MEMALLOC_AGINGTIMER
*                           IPSAFE_INIT_ERR_AGING_TIMER_INIT
*                           IPSAFE_INIT_ERR_ADDNAME_AGINGTIMER
*      Caution: None
*    Since: V100R008C03
*    Reference: NA
*------------------------------------------------------------------------------
...
*  2010-25-04  Arjun(a00900868)     Modifications
*******************************************************************************/
