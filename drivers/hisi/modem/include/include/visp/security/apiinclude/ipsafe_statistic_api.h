...
typedef enum enumALG_STAT_Protocols
{
    ...
    NAT_STAT_ALG_FTP_DATA,                          /*Packets dropped or passed are of FTP Data Connection*/

    NAT_STAT_ALG_FTP_CNTRL,                         /*Packets dropped or passed are of FTP Control Connection*/
...
/*STRUCT< Union to store the type of IP address. It can either be IPv4 or IPv6.>*/
...
*        Input: NAT_GLOB_STATISTIC_S *pstStatistic: Pointer to NAT_GLOB_STATISTIC_S <NA>
*       Output: NAT_GLOB_STATISTIC_S *pstStatistic: Updated structure containing 
*               statistics information.<NA>
*       Return: Success - NAT_STAT_SUCCESS
...
*               NAT_GLOB_STATISTIC_S. <NA>
*               UINT16 u16VRF: VRF Index <The range is 0 - (VRF_MAX_NUM-1)>
*       Output: NAT_GLOB_STATISTIC_S pstStatistic : Updated statistics information. <NA>
*       Return: Success - NAT_STAT_SUCCESS
...
*        Input: NAT_GLOB_STATISTIC_S *pstStatistic: Pointer to the structure NAT_GLOB_STATISTIC_S. <NA>
...
*                                           flow statitics information is stored. <NA>
*       Output: NA
*       Return: Success: NAT_STAT_SUCCESS
...
*                       type IPSAFE_FLOWSTATISTIC_RULE_S with all parameters correctly filled in<NA>
*       Output: NA
*       Return: Success: NAT_STAT_SUCCESS
*      Caution: None
*        Since: V200R003C01
...
*        Input: IPSAFE_FLOWSTATISTIC_ALLINFO_S *pstFlowStatAllInfo: Pointer to structure of the type IPSAFE_FLOWSTATISTIC_RULE_S<NA>
*       Output: NA
*       Return: Success: NAT_STAT_SUCCESS
...
*        Input: UINT32 u32FlowId: Valid ID of a currently existing rule.<NA>
*       Output: NA
*       Return: VOID
*      Caution: None
*        Since: V200R003C01
