...
*
*  Project Code: V1.1.0
*   Module Name: nat api header
*  Date Created: 2010-1-08
*        Author: z00142640/z62474 
*   Description: nat api header
*
*-------------------------------------------------------------------------------
*  Modification History
*  DATE         NAME                      DESCRIPTION    
*  -----------------------------------------------------------------------------
*  2009-8-11    z00142640/z62474         Create the first version.
*
*******************************************************************************/
...
{
    UINT16 u16Port;               /*Port of the ALG. For example, for FTP it is 21*/
...
typedef struct tagNatAlgMode
{
    ...
    UINT8 u8FtpMode;  /*Cone mode operation for FTP*/
...
enum enumNAT_ALG_ErrCode
{
    ...
    NAT_ALG_INIT_ERR_FTP_INIT_FAIL,                     /*<15031> Failed to initialize FTP ALG */
...
/*ERRORCODE< Error codes in FTP-ALG > */
enum enumNAT_ALG_FTP_ErrCode
{
    NAT_ALG_FTP_SUCCESS,                                     /*<0> On Success*/
    NAT_ALG_FTP_BEGIN_CODE = IPSAFE_FTP_BEGIN_RET_CODE,      /*<7000> Beginning of FTP error code.*/
    ...
    NAT_ALG_FTP_PKTOUT_ERR_MEMALLOC_PROTOCOL_DATA,           /*<7006> Failed to allocate memory for Control Session's 
                                                                  protocol data*/
    NAT_ALG_FTP_PKTOUT_ERR_UNKNOWN_FTP_CMD,                  /*<7007> Unknown FTP Command detected, drop the packet.*/
...
#define NAT_DEL_SESS_FOR_SOURCE_IP                  1    /*Operation type For deleting sessions per source IP address*/
...
*    Func Name: NAT_OperRule
*    Date Created: 2010-1-13
*    Author: z62474/b71224
*    Purpose: This function is used to configure NAT access rule
*    Description: This function adds new rule to NAT and deletes existing rule from NAT
*                       based on input operation type
*    Input:  UINT32 u32OperType: Operation Type <0:Add new rule,1:Delete existing rule>
*               NAT_RULE_S *pstRule: Pointer to Rule Structure <Non null pointer>
*    Output:NA
*    Return:NAT_OPR_ERR_NULL_POINTER: input Rule pointer is null
*           NAT_OPR_ERR_GET_RULE_HANDLE: Unable to get rule handle
*           NAT_OPR_ERR_OPERTYPE_NOT_SUPPORTED: Invalid operation type specified
*           NAT_OPR_ERR_VCPU_NOINIT: Init not initialized
*           NAT_OPR_ERR_MODE_TYPE_INVALID:niether NAT nor NAPT
*     Since: V200R003C01
*     Caution: NA
*     Reference: NA
*------------------------------------------------------------------------------
...
/*******************************************************************************
*  Func Name: NAT_DisplaySession
*  Date Created:2010-1-12
*  Author:     Navneeth Kishna GT(n00900857)
* Purpose: This function is called for displaying all NAT and PAT sessions.
*                
* Description: It displays all the NAT and PAT sessions per interface or across
*               all interfaces depending upon the user input.
*  Input:      UINT16 u16DispType : Specifies thr display mode 
*                                   <0:PerInterface, 1: All interface, 2: Per VRF>
*              UINT32 u32Data: INTF_HANDLE when u16DispType is NAT_PER_INTERFACE/NAT_ALL_SESSION
*                            VRF Index when u16DispType is NAT_VRF_SESSION <Valid Intf. handle /VRF index>
*  Output: NA
*  Return:  VOID
*  Since: V200R003C01
*  Caution:   IPSAFE_SetOutputToCOMSwitch has to be enabled in order to display the session details using this API. "
*  Reference: NA
*------------------------------------------------------------------------------
*  Modification History
*  DATE         NAME             DESCRIPTION    
*  ----------------------------------------------------------------------------
*  2010-1-12    zhangchi(00142640)  Create the first version.
*  2010-04-05  Arjun (a00900868)    Support VRF
*******************************************************************************/
extern VOID NAT_DisplaySession(UINT16 u16DispType, UINT32 u32Data);

/*******************************************************************************
*    Func Name: NAT_UPDATE_SESSION_FUNC
* Date Created: 2010-04-01
*       Author: zhangchi(00142640)
*      Purpose: Product implement update session function prototype
*  Description: Product implement update session function prototype
*        Input: UINT32 u32Oper: Update command, indicating whether to create or delete a 
*               session<NAT_NOTIFY_CREATE_SESSION and NAT_NOTIFY_DELETE_SESSION>
*               NAT_UPDATE_SESSION_S pstNatPpiSession: Update session information. <Not null pointer>
*       Output: NA
*       Return: Success: NAT_SUCCESS
*      Caution: NA
*        Since: V200R003C01
...
/*******************************************************************************
*    Func Name: NAT_NotifySessionChange
* Date Created: 2010-04-07
*       Author: zhangchi(00142640)
*      Purpose: This function is to notify the Session Aging.
*  Description: This function is used for notifying FPGA NAT module about aging session.
*        Input: UINT32 u32Oper: Operation Type <1:Delete Session>
*               NAT_SESSION_CHANGE_S* pstChangeInfo: Change Info <not null>
*       Output: NA
*       Return: Success: NAT_SUCCESS
*      Caution: NA
*        Since: V200R003C01
...
*  DATE         NAME                    DESCRIPTION
*  ----------------------------------------------------------------------------
*  2010-04-07   zhangchi(00142640)      Create the first version.
*
*******************************************************************************/
...
*               UINT32 Number: Number of Rules user want to display at one call <Any Integer>
*       Output: GET_RULE_S *pstGetRule: Rule information <NA>
