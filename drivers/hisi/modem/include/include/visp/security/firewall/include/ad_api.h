...
/**
* @defgroup tagAdScanPara AD_SCAN_PARA_S
* @ingroup ADS Attack Defense Structures
* @par Prototype
* @code
...
*
* @par Description
* This structure stores the details of the scan/sweep attack defense configuration.
* 
* @datastruct u32MaxRate This is the maximum destination IP or port change rate. It's value ranges from 
* 1-100000.
* @datastruct u32EnableBlkList Indicates whether to add source IP to blacklist when scan/sweep attack happens.
...
* A value of 0 mins indicates, it has no timeout feature. The entry will not be deleted from blacklist.
* It can be deleted manually.
* @datastruct u32EnableLog It indicates whether to enable log recording or not. It can have the following 
* values:
*	- 0 - disable
*	- 1 - enable
*/ 
...
* @datastruct AD_BROADCAST_IPSPOOFING_SH Indicates IP address is a broadcast address.
* @datastruct AD_IP_NOT_IN_FIB_IPSPOOFING_SH Indicates IP address does not exist in FIB.
...
* @datastruct AD_IPADDR_HOST Indicates IP address is proper.
...
* @param[out] NA NA [NA]
* 
* @retval UINT32 On Success [AD_OK|NA]
* @retval UINT32 Indicates failure of malloc upon malformed configuration [AD_ERR_MALLOC_AD_MALFORM_CFG_S|NA]
* @retval UINT32 Indicates failure of bind name upon malformed configuration [AD_ERR_ADD_NAME_DB_MALFORM_CFG_S|NA]
* @retval UINT32 Indicates failure of malloc [AD_ERR_MALLOC_AD_CFG_S|NA]
* @retval UINT32 Indicates failure of bind name [AD_ERR_ADD_NAME_DB_AD_CFG_S|NA]
* @retval UINT32 Indicates failure to get the pre configuration of maximum no of Interfaces configured in flood attack [AD_ERR_GET_IF_CFG_PRECONFIG_FAIL|NA]
* @retval UINT32 Indicates failure to get the pre configuration of maximum no of IPs configured in flood attack [AD_ERR_GET_FLOOD_CFG_PRECONFIG_FAIL|NA]
* @retval UINT32 Indicates hash table operation failed for interface configuration [AD_HASH_FAIL_IF_CFG_SFE_INIT_CFG|NA]
* @retval UINT32 Indicates hash table operation failed for IP configuration [AD_HASH_FAIL_FLOOD_IP_CFG_SFE_INIT_CFG|NA]
* @retval UINT32 Indicates allocated shared memory failed for global configuration [AD_MALLOC_FAIL_FLOOD_GLOBAL_CFG_SFE_INIT_CFG|NA]
* @retval UINT32 Indicates bind name for shared memory failed [AD_ADD_NAME_FAIL_SFE_INIT_CFG|NA]
* @retval UINT32 Indicates failure of malloc upon scan configuration [AD_SCAN_PARA_MALLOC_ERR_SFE_INIT_CFG|NA]
* @retval UINT32 Indicates failure of bind name upon scan configuration [AD_SCAN_PARA_ADD_NAME_ERR_SFE_INIT_CFG|NA]
* @retval UINT32 Indicates failure of malloc upon sweep configuration [AD_SWEEP_PARA_MALLOC_ERR_SFE_INIT_CFG|NA]
* @retval UINT32 Indicates failure of bind name upon sweep configuration [AD_SWEEP_PARA_ADD_NAME_ERR_SFE_INIT_CFG|NA]
* @retval UINT32 Indicates failure of malloc upon user defined attack configuration [AD_USER_DEF_PARA_MALLOC_ERR_SFE_INIT_CFG|NA]
* @retval UINT32 Indicates failure of bind name upon user defined attack configuration [AD_USER_DEF_PARA_ADD_NAME_ERR_SFE_INIT_CFG|NA]
* @retval UINT32 Indicates failure of malloc upon ARP miss configuration [AD_ARP_MISS_PARA_MALLOC_ERR_SFE_INIT_CFG|NA]
* @retval UINT32 Indicates failure of bind name upon ARP miss configuration [AD_ARP_MISS_PARA_ADD_NAME_ERR_SFE_INIT_CFG|NA]
* @retval UINT32 Indicates failure of malloc upon ARP miss flood configuration [AD_ARP_MISS_RATECOUNT_MALLOC_ERR_SFE_INIT_CFG|NA]
* @retval UINT32 Indicates failure of bind name upon ARP miss flood configuration [AD_ARP_MISS_RATECOUNT_ADD_NAME_ERR_SFE_INIT_CFG|NA]
* @retval UINT32 Indicates failure of malloc upon debug configuration for all attacks [AD_DBG_FOR_ATK_MALLOC_ERR_SFE_INIT_CFG|NA]
* @retval UINT32 Indicates failure of bind name upon debug configuration for all attacks [AD_DBG_FOR_ATK_ADD_NAME_ERR_SFE_INIT_CFG|NA]
* @retval UINT32 Indicates failure of malloc upon malformed parameter configuration [AD_ERR_MALLOC_AD_MALFORM_CONFIG|NA]
* @retval UINT32 Indicates failure of bind name upon malformed parameter configuration [AD_ERR_ADD_NAME_DB_AD_MALFORM_CONFIG|NA]
* @retval UINT32 Indicates getting pre configuration value for maximum packet size failed.
* [AD_ERR_GET_MAX_PKT_SIZE_PRECONFIG_FAIL|NA]
* @retval UINT32 Indicates getting pre configuration value for minimum fragment size failed. 
* [AD_ERR_GET_MIN_FRAGMENT_SIZE_PRECONFIG_FAIL|NA]
* @retval UINT32 Indicates failure of malloc upon flood parameter configuration [AD_ERR_FLOOD_PARA_VAR_MALLOC_FAIL|NA]
* @retval UINT32 Indicates failure of bind name upon flood parameter configuration [AD_ERR_FLOOD_PARA_VAR_ADD_NAME_DB_FAIL|NA]
* @retval UINT32 Indicates getting pre configuration value for flood parameter failed.
* [AD_ERR_FLOOD_PARA_VAR_GET_PRECONFIG_FAIL|NA]
* @retval UINT32 Indicates getting pre configuration value for maximum packets handled in
* tear drop attack failed. [AD_ERR_GET_MAX_IP_PKTS_HANDLED_PRECONFIG_FAIL|NA]
* @retval UINT32 Indicates getting pre configuration value for maximum fragments of one packet handled in
* tear drop attack failed. [AD_ERR_GET_MAX_FRAGMENTS_HANDLED_PRECONFIG_FAIL|NA]
* @retval UINT32 Indicates failure of frag table initialization. [AD_FRAG_TABL_INIT_FAIL_FOR_TEARDROP|NA]
* @retval UINT32 Indicates failure of malloc upon fragment table creation [AD_TEARDROP_MALLOC_ERR_FRAG_TABLE_NAMEID|NA]
* @retval UINT32 Indicates failure of bind name upon fragment table creation  [AD_TEARDROP_ADD_NAME_ERR_FRAG_TABLE_NAMEID|NA]
* @retval UINT32 Indicates failure of timer creation for fragment table. [AD_TEARDROP_CREATE_TIMER_ERR_FRAG_TABLE|NA]
* @retval UINT32 Indicates failure of statistics initialization for all attacks. [AD_STAT_INIT_ERR_SFE_INIT_CFG|NA]
*
* @par Dependency
* ad_inc.h
* 
...
* [1-Enable/0-Disable]
* @param[in] u32AtkType Indicates the type of attack. For more details, refer AD_ATTACK_TYPE_E. [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 On Success [AD_OK|NA]
* @retval UINT32 Indicates global configuration of AD module not initialized [AD_CFG_NULL_SFE_ENABLE_ATK_BY_TYPE|NA]
* @retval UINT32 Indicates invalid input parameter [AD_INVALID_INPUT_SFE_ENABLE_ATK_BY_TYPE|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* 
* @param[in] u32AtkType Indicates the type of attack [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 Indicates attack defense module is disabled [0|NA]
* @retval UINT32 Indicates attack defense module is enabled [1|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* @param[in] u32IfIndex Indicates the network interface index [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 On Success [AD_OK|NA]
* @retval UINT32 Indicates global configuration of AD module not initialized 
* [AD_IF_CFG_HASH_NULL_SFE_ENABLE_ATK_DEFEND|NA]
* @retval UINT32 Indicates invalid input parameter [AD_INVALID_INPUT_SFE_ENABLE_ATK_DEFEND|NA]
* @retval UINT32 Indicates hash table is full [AD_HASH_TABLE_FULL_SFE_ENABLE_ATK_DEFEND|NA]
* @retval UINT32 Indicates hash table operation failed [AD_HASH_FAIL_SFE_ENABLE_ATK_DEFEND|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* 
* @retval UINT32 On Success [AD_OK|NA]
* @retval UINT32 Indicates hash table operation failed [AD_HASH_FAIL_SFE_AD_IS_ENABLE_ATK_DEFEND|NA]
* @retval UINT32 Indicates recieved null pointer as input [AD_NULL_INPUT_IS_ENABLE_DEFEND|NA]
* @retval UINT32 Indicates recieved interface is not configured [AD_INTERFACE_NOT_CONFIGURED|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* 
* @par Description
* This function is used to set malformed packet attack parameter by the type.
...
* @param[in] pstAtkPara Indicates structure that contains attack parameters [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 On Success [AD_OK|NA]
* @retval UINT32 Indicates invalid input for attack parameter [AD_INVALID_INPUT_SFE_SET_MALFORM|NA]
* @retval UINT32 Indicates wrong attack type [AD_TYPE_ERR_SFE_SET_MALFORM|NA]
* @retval UINT32 Indicates global configuration of AD module not initialized [AD_CFG_NULL_SFE_SET_MALFORM|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
*	- ATCK_TEARDROP            : Teardrop attack
* 
* @param[in] u32AtkType Indicates the type of atatck whose configuration is needed [NA]
* @param[out] pstAtkPara Indicates the pointer to the structure to store the configured data [NA]
* 
* @retval UINT32 On Success [AD_OK|NA]
* @retval UINT32 Indicates invalid input parameter [AD_INVALID_INPUT_SFE_GET_MALFORM|NA]
* @retval UINT32 Indicates wrong attack type [AD_TYPE_ERR_SFE_GET_MALFORM|NA]
* @retval UINT32 Indicates global configuration of AD module not initialized [AD_CFG_NULL_SFE_GET_MALFORM|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* attack parameters [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 On Success [AD_OK|NA]
* @retval UINT32 Indicates invalid input parameter [AD_INVALID_INPUT_SFE_SET_FLOOD|NA]
* @retval UINT32 Indicates global configuration of AD module is not initialized [AD_CFG_NULL_SFE_SET_FLOOD|NA]
* @retval UINT32 Indicates Input flood parameter pointer is NULL [AD_INVALID_INPUT_SET_GLOBAL_FLOOD_PARA|NA]
* @retval UINT32 Indicates wrong flooding attack type [AD_FLOOD_TYPE_ERR_SET_GLOBAL_FLOOD_PARA|NA]
* @retval UINT32 Indicates invalid input parameter [AD_INVALID_INPUT_CPY_FLOOD_PARA_TO_IF_HASH_ITEM|NA]
* @retval UINT32 Indicates wrong flooding attack type [AD_FLOOD_TYPE_ERR_CPY_FLOOD_PARA_TO_IF_HASH_ITEM|NA]
* @retval UINT32 Indicates invalid input parameter [AD_INVALID_INPUT_CPY_FLOOD_PARA_TO_IP_HASH_ITEM|NA]
* @retval UINT32 Indicates invalid input parameter [AD_INVALID_DEFENSE_SWITCH_CPY_FLOOD_PARA|NA]
* @retval UINT32 Indicates invalid input parameter [AD_FLOOD_RATE_OUTRANGE_CPY_FLOOD_PARA|NA]
* @retval UINT32 Indicates invalid input parameter [AD_INVALID_BLK_SWITCH_CPY_FLOOD_PARA|NA]
* @retval UINT32 Indicates invalid input parameter [AD_FLOOD_BLK_TIMEOUT_OUTRANGE_CPY_FLOOD_PARA|NA]
* @retval UINT32 Indicates invalid input parameter [AD_INVALID_LOG_SWITCH_CPY_FLOOD_PARA|NA]
* @retval UINT32 Indicates hash table is full [AD_HASH_TABLE_FULL_SFE_SET_FLOOD|NA]
* @retval UINT32 Indicates hash table operation failed [AD_HASH_FAIL_SFE_SET_FLOOD|NA]
* @retval UINT32 Indicates invalid flooding attack type [AD_INVALID_FLOOD_TYPE_INPUT_SFE_SET_FLOOD|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* @param[in] u32Key Indicates the key to search the configuration parameter. It can be an IP address or 
* index of an interface. [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 On Success [AD_OK|NA]
* @retval UINT32 Indicates that the global configuration variable is invalid [AD_CFG_NULL_SFE_DEL_FLOOD|NA]
* @retval UINT32 Indicates that the attack configuration type input is wrong [AD_CFG_OBJ_TYPE_ERR_SFE_DEL_FLOOD|NA]
* @retval UINT32 Indicates failure of hash table operation [AD_HASH_FAIL_SFE_DEL_FLOOD|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* @param[in] pstScanPara Indicates scan and sweep attack defense parameter. For more details, refer AD_SCAN_PARA_S [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 On Success [AD_OK|NA]
* @retval UINT32 Indicates global configuration for scan/sweep attack defense is not initialized 
* [AD_CFG_NULL_SFE_SET_SCAN_PARA|NA]
* @retval UINT32 Indicates invalid input parameter [AD_NULL_INPUT_SFE_SET_SCAN_PARA|NA]
* @retval UINT32 Indicates invalid input parameter [AD_PARA_INVALID_SFE_SET_SCAN_PARA|NA]
* @retval UINT32 Indicates wrong attack type [AD_ATTACK_TYPE_ERR_SFE_SET_SCAN_PARA|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
*	- ATCK_PORTSCAN
* 
* @param[in] u32ScanType Indicates the type of scan/sweep attack type. [NA]
* @param[out] pstScanPara Indicates scan/sweep attack defense parameter. For more details, refer AD_SCAN_PARA_S. [NA]
* 
* @retval UINT32 On Success [AD_OK|NA]
* @retval UINT32 Indicates global configuration for scan/sweep attack defense is not initialized 
* [AD_CFG_NULL_SFE_GET_SCAN_PARA|NA]
* @retval UINT32 Indicates invalid input parameter [AD_NULL_INPUT_SFE_GET_SCAN_PARA|NA]
* @retval UINT32 Indicates wrong attack type [AD_ATTACK_TYPE_ERR_SFE_GET_SCAN_PARA|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* 
* @param[in,out] pstADStat It stores statistics of all VCPU and Attack types. [NA]
* 
* @retval UINT32 On success [AD_OK|NA]
* @retval UINT32 Indicates input statistics pointer is null [SFE_AD_ERR_STAT_INPUT_NULLPTR_GETSTAT|NA]
* @retval UINT32 Indicates statistics is not initialized [AD_ERR_STAT_AD_STATISTICS_NOT_INITIATLIZED_GETSTAT|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* 
* @param[in] u32VCPUNum VCPU number for which the statistics is required. [NA]
* @param[in,out] pstADStat The statistics of all VCPU and attack types will be stored in the 
* input parameter pstADStat [NA]
* 
* @retval UINT32 On success [AD_OK|NA]
* @retval UINT32 Indicates input VCPU type [SFE_AD_ERR_STAT_INVALID_VCPU_GETVCPUSTAT|NA]
* @retval UINT32 Indicates input statistics pointer is null [SFE_AD_ERR_STAT_INPUT_NULLPTR_GETVCPUSTAT|NA]
* @retval UINT32 Indicates global statistics variable not initialized 
* [AD_ERR_STAT_AD_STATISTICS_NOT_INITIATLIZED_GETVCPUSTAT|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* 
* @param[in] NA NA [NA]
* @param[out] ppHandle Indicates handle of interface defense configuration list [NA]
* 
* @retval UINT32 Indicates there are more items [FWCOMMON_ITERATOR_ITEM_EXIST|NA]
* @retval UINT32 Indicates there are no more items [FWCOMMON_ITERATOR_ITEM_NOT_EXIST|NA]
* @retval UINT32 Indicates NULL pointer as input parameter [AD_NULL_INPUT_SFE_IF_OPENLIST|NA]
* @retval UINT32 Indicates opening interface defense configuration list failed [AD_OPEN_FAIL_SFE_IF_OPENLIST|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* 
* @param[in] pHandle Indicates handle of interface defense configuration list [NA]
* @param[out] pstIfCfg Indicates pointer to interface defense configuration [NA]
* 
* @retval UINT32 Indicates there are more items [FWCOMMON_ITERATOR_ITEM_EXIST|NA]
* @retval UINT32 Indicates there are no more items [FWCOMMON_ITERATOR_ITEM_NOT_EXIST|NA]
* @retval UINT32 Indicates NULL pointer as input parameter [AD_NULL_INPUT_SFE_IF_GETNEXT|NA]
* @retval UINT32 Indicates getting next item of interface defense configuration list failed 
* [AD_GET_FAIL_SFE_IF_GETNEXT|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* @param[out] NA NA [NA]
* 
* @retval UINT32 Indicates no error occurred for iterator [FWCOMMON_ITERATOR_OK|NA]
* @retval UINT32 Indicates NULL pointer as input parameter [AD_NULL_INPUT_SFE_IF_CLOSELIST|NA]
* @retval UINT32 Indicates closing interface defense configuration list failed [AD_CLOSE_FAIL_SFE_IF_CLOSELIST|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* @param[out] pstFloodPara Indicates pointer to flooding defense parameter [NA]
* 
* @retval UINT32 On success [AD_OK|NA]
* @retval UINT32 Indicates global configuration for flooding defense is not initialized 
* [AD_CFG_NULL_SFE_GET_GLOBAL_FLOOD_PARA|NA]
* @retval UINT32 Indicates NULL pointer as input parameter [AD_NULL_INPUT_SFE_GET_GLOBAL_FLOOD_PARA|NA]
* @retval UINT32 Indicates invalid flooding attack type as input parameter 
* [AD_FLOOD_TYPE_ERR_SFE_GET_GLOBAL_FLOOD_PARA|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* get the whole list of IP level flood defense parameter. [NA]
* @param[out] ppHandle Indicates the handle for list. [NA]
* 
* @retval UINT32 Indicates there are more items. [FWCOMMON_ITERATOR_ITEM_EXIST|NA]
* @retval UINT32 Indicates there are no more items. [FWCOMMON_ITERATOR_ITEM_NOT_EXIST|NA]
* @retval UINT32 Indicates NULL pointer as input parameter [AD_NULL_INPUT_SFE_FLOODPARAIP_OPENLIST|NA]
* @retval UINT32 Indicates opening IP level flood defense configuration list failed 
* [AD_OPEN_FAIL_SFE_FLOODPARAIP_OPENLIST|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* 
* @param[in] pHandle Indicates the handle for list [NA]
* @param[out] pstFloodParaIPInfo Indicates the IP based flood parameter [NA]
* 
* @retval UINT32 Indicates there are more items. [FWCOMMON_ITERATOR_ITEM_EXIST|NA]
* @retval UINT32 Indicates there are no more items. [FWCOMMON_ITERATOR_ITEM_NOT_EXIST|NA]
* @retval UINT32 Indicates NULL pointer as input parameter [AD_NULL_INPUT_SFE_FLOODPARAIP_GETNEXT|NA]
* @retval UINT32 Indicates getting next item in IP level flood defense configuration list failed 
* [AD_GET_FAIL_SFE_FLOODPARAIP_GETNEXT|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* 
* @retval UINT32 Indicates no error occurred for iterator [FWCOMMON_ITERATOR_OK|NA]
* @retval UINT32 Indicates NULL pointer as input parameter [AD_NULL_INPUT_SFE_FLOODPARAIP_CLOSELIST|NA]
* @retval UINT32 Indicates closing IP level flood defense configuration list failed 
* [AD_CLOSE_FAIL_SFE_FLOODPARAIP_CLOSELIST|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* 
* @param[in] u32IP Indicates the destination IP to be protected from flood attack [NA]
* @param[out] NA NA [NA]
* 
* @retval VOID This function does not return any value. [NA|NA]
* 
...
*	- 1 indicates Enable 
*	- 0 indicates Disable 
* @param[in] u32AtkType Attack type [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 On Success [AD_OK|NA]
* @retval UINT32 Attack type debug configuration not initialized [AD_CFG_NULL_SFE_SET_ATK_DBG_FLG|NA]
* @retval UINT32 Invalid input parameter [AD_INVALID_INPUT_SFE_SET_ATK_DBG_FLG|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
*	- 0 - if debug for the attack type is disabled [NA]
* 
* @retval UINT32 On Success [AD_OK|NA]
* @retval UINT32 Attack type debug configuration not initialized [AD_CFG_NULL_SFE_GET_ATK_DBG_FLAG|NA]
* @retval UINT32 Indicates input parameter is NULL [AD_NULL_INPUT_SFE_GET_ATK_DBG_FLAG|NA]
* @retval UINT32 Invalid input attack type [AD_INVALID_INPUT_SFE_GET_ATK_DBG_FLG|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* 
* @param[in] u32AtkType This parameter is a reserved parameter that can pass any integer value.[NA]
* @param[in] pstAtkPara This parameter is the pointer to the structure for ARP Miss defense parameter.[NA]
* @param[out] NA NA [NA]
*
* @retval UINT32 On Success [AD_OK|NA]
* @retval UINT32 Indicates global configuration of ARP MISS attack defense is not initialized 
* [AD_CFG_NULL_SFE_SET_ARP_MISS|NA]
* @retval UINT32 Indicates NULL pointer as input parameter while setting ARP MISS attack defense parameter 
* [AD_NULL_INPUT_SFE_SET_ARP_MISS|NA]
* @retval UINT32 Indicates invalid input parameter while setting ARP MISS attack defense parameter 
* [AD_INVALID_INPUT_SFE_SET_ARP_MISS|NA]
*
* @par Dependency
* ad_inc.h
* 
...
* 
* @param[in] u32AtkType This parameter is a reserved parameter and can pass any integer value.[NA]
* @param[in] pstAtkPara This parameter is a pointer to the structure for ARP Miss defense parameter.[NA]
* @param[out] NA NA [NA]
*
* @retval UINT32 On Success [AD_OK|NA]
* @retval UINT32 Indicates global configuration of ARP MISS attack defense is not initialized 
* [AD_CFG_NULL_SFE_GET_ARP_MISS|NA]
* @retval UINT32 Indicates NULL pointer as input parameter while getting ARP MISS attack defense parameter 
* [AD_NULL_INPUT_SFE_GET_ARP_MISS|NA]
*
* @par Dependency
* ad_inc.h
* 
...
/**
* @defgroup AD_SetAtkUserDefined AD_SetAtkUserDefined
* @ingroup ADF Attack Defense Functions
* @par Prototype
* @code
* UINT32 AD_SetAtkUserDefined(UINT32 u32AtkType, AD_USER_DEFINE_PARA_S * pstAtkPara);
* @endcode 
* 
* @par Description
* This function sets the configuration for user defined attack defense.
* 
* @param[in] u32AtkType This parameter is reserved and can pass any integer value [NA]
* @param[in] pstAtkPara Pointer to the structure for user define defense parameter [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 On Success [AD_OK|NA]
* @retval UINT32 Indicates NULL pointer as input parameter while setting user defined defense rule 
* [AD_NULL_INPUT_SFE_SET_USER_DEF|NA]
* @retval UINT32 Indicates user defined defense global variable is not initialized [AD_CFG_NULL_SFE_SET_USER_DEF|NA]
* @retval UINT32 Indicates invalid input parameter while setting user defined defense rule 
* [AD_PARA_INVALID_SFE_SET_USER_DEF|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* 
*	- The AD module should be initialized before calling this function.
*	- The signature stored in memory maybe not same as user's input. This
*     is because for getting more performance while detecting user defined
*     attack, signature is preprocessed while setting the user defined rule.
*     For example, if signature is 11001001, mask is 00101011, the final 
*     signature stored in memory is (11001001 & 00101011), that's 00001001.
* 
* 
* @par Related Topics
* None
...
* 
* @param[in] u32AtkType This parameter is reseved and can pass any integer value. [NA]
* @param[in] u32ID ID of user defined defense rule. [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 On Success [AD_OK|NA]
* @retval UINT32 Indicates user defined defense global variable is not initialized [AD_CFG_NULL_SFE_DEL_USER_DEF|NA]
* @retval UINT32 Indicates invalid input parameter while deleting user defined defense rule 
* [AD_PARA_INVALID_SFE_DEL_USER_DEF|NA]
* @retval UINT32 Indicates the user defined defense rule to be deleted does not exist 
* [AD_RULE_NOT_EXIST_SFE_DEL_USER_DEF|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* 
* @param[in] NA NA [NA]
* @param[out] ppHandle Handle of the list. [NA]
* 
* @retval UINT32 Indicates there are more items [FWCOMMON_ITERATOR_ITEM_EXIST|NA]
* @retval UINT32 Indicates there are no more items [FWCOMMON_ITERATOR_ITEM_NOT_EXIST|NA]
* @retval UINT32 Indicates NULL pointer as input parameter while opening list of user defined defense rule 
* [AD_NULL_INPUT_SFE_USER_DEF_OPENLIST|NA]
* @retval UINT32 Indicates opening list of user defined defense rule failed [AD_OPEN_FAIL_SFE_USER_DEF_OPENLIST|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* 
* @param[in] pHandle Handle of the list. [NA]
* @param[out] pstAtkPara Structure for user defined defense parameter. [NA]
* 
* @retval UINT32 Indicates there are more items [FWCOMMON_ITERATOR_ITEM_EXIST|NA]
* @retval UINT32 Indicates there are no more items [FWCOMMON_ITERATOR_ITEM_NOT_EXIST|NA]
* @retval UINT32 Indicates NULL pointer as input parameter while getting next user defined defense rule 
* [AD_NULL_INPUT_SFE_USER_DEF_GETNEXT|NA]
* @retval UINT32 Indicates failed to get next user defined defense rule [AD_GET_FAIL_SFE_USER_DEF_GETNEXT|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* [AD_NULL_INPUT_SFE_USER_DEF_CLOSELIST|NA]
* @retval UINT32 Indicates closing list of user defined defense rule failed [AD_CLOSE_FAIL_SFE_USER_DEF_CLOSELIST|NA]
* 
* @par Dependency
* ad_inc.h
* 
...
* 
* @param[in] pstMBuf Pointer to the packet structure [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 Indicating packet should be permitted [IP_PP4_NOT_PROCESSED_BY_INTERMEDIATE|NA]
* @retval UINT32 Indicating packet should be dropped [IP_PP4_PROCESSED_BY_INTERMEDIATE|NA]
* 
* @par Dependency
* ad_inc.h
* 
