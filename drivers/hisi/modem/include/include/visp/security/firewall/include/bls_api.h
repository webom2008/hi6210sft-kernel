...
* @param[out] NA NA [NA]
* 
* @retval UINT32 Enabling blacklist is success. [BLS_OK|NA]
* @retval UINT32 Enabling blacklist has failed as firewall is not initialized. [BLS_ERR_INIT_ENABLE|NA]
* 
* @par Dependency
* None
*
...
* @param[out] NA NA [NA]
* 
* @retval UINT32 Disabling blacklist is success. [BLS_OK|NA]
* @retval UINT32 Disabling blacklist has failed as firewall is not initialized. [BLS_ERR_INIT_DISABLE|NA]
*
* @par Dependency
* None
* 
...
* 
* @param[in] pstBLSInfo Pointer to BLS_INFO_S structure [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 Adding entry to blacklist is success. [BLS_OK|NA]
* @retval UINT32 Received null pointer as input argument. [SFE_BLS_ERR_ADD_NULLPTR_INPUT|NA]
* @retval UINT32 Timeout value of IP is out of range. [SFE_BLS_ERR_TIMEOUT_OUTOF_RANGE|NA]
* @retval UINT32 Invalid value provided for Enablelog flag. [SFE_BLS_ERR_INVALID_LOG_SWITCH|NA]
* @retval UINT32 Failed to insert entry in blacklist as firewall is not initialized. [BLS_ERR_INIT_ADDENTRY|NA]
* @retval UINT32 Maximum number of rules reached for blacklist. [BLS_MAXRULEREACHED|NA]
* @retval UINT32 Failed to insert entry in blacklist as hash operation failed. [BLS_ERR_ADD_INTERNAL_HASH_FAIL|NA]
* 
* @par Dependency
* None
* 
...
* @param[out] NA NA [NA]
* 
* @retval UINT32 Deleting entry from blacklist success. [BLS_OK|NA]
* @retval UINT32 Received null pointer as input argument. [SFE_BLS_ERR_DELETE_NULLPTR_INPUT|NA]
* @retval UINT32 Failed to delete entry from blacklist as firewall is not initialized. [BLS_ERR_INIT_DELENTRY|NA]
* @retval UINT32 The entry does not exists in blacklist. [BLS_ENTRY_NOT_EXISTS|NA]
* 
* @par Dependency
*	- bls_common.h
*	- sfe_fwcommon_inc.h
...
* @param[out] NA NA [NA]
* 
* @retval UINT32 Initializing blacklist is success. [BLS_OK|NA]
* @retval UINT32 Failed to get pre-configuration of maximum entries that can be configured
* in blacklist. [BLS_ERR_GET_PRECONFIG_FAIL|NA]
* @retval UINT32 Failed to allocate memory for blacklist. [BLS_ERR_MALLOC|NA]
* @retval UINT32 Registering global variable name failed in blacklist. [BLS_ERR_ADD_NAMEDB|NA]
* @retval UINT32 Hash table initialization failed for blacklist. [BLS_ERR_HASH_INIT|NA]
* @retval UINT32 Indicates failed to allocate memory for blacklist timer. [BLS_ERR_MALLOC_TIMER|NA]
* @retval UINT32 Indicates failed to register timer name. [BLS_ERR_ADD_NAME_DB_TIMER|NA]
* @retval UINT32 Indicates failed to create timer for blacklist. [BLS_ERR_TIMER_CREATE_MULTIPLANE|NA]
* @retval UINT32 Statiatics initialization failed for blacklist. [BLS_ERR_STAT_INIT|NA]
* 
* @par Dependency
* None
* 
...
* 
* @param[in] pstMBuf Pointer to MBUF_S structure [NA]
* @param[out] NA NA [NA]
*
* @retval UINT32 Indicates message should be processed by protocol stack [IP_PP4_NOT_PROCESSED_BY_INTERMEDIATE|NA]
...
* 
* @param[in] NA NA [NA]
* @param[out] ppHandle Pointer to void pointer which stores blacklist handle [NA]
* 
* @retval UINT32 Opening blacklist is success. [FWCOMMON_ITERATOR_ITEM_EXIST|NA]
* @retval UINT32 Recieved null pointer as input argument to open blacklist. [SFE_BLS_ERR_NULLPTR_OPENLIST|NA]
* @retval UINT32 Failed to open blacklist as blacklist is not initialized. [BLS_ERR_INIT_OPENLIST|NA]
* @retval UINT32 Failed to open blacklist as iterator operation failed. [BLS_ERR_OPEN_FAIL_OPENLIST|NA]
* @retval UINT32 No item exists in blacklist. [FWCOMMON_ITERATOR_ITEM_NOT_EXIST|NA]
* 
* @par Dependency
*
* 
...
* 
* @param[in] pHandle Handle to blacklist [NA]
* @param[out] pstBLSInfo Blacklist structure [NA]
* 
* @retval UINT32 Getting next item from blacklist is success. [FWCOMMON_ITERATOR_ITEM_EXIST|NA]
* @retval UINT32 Recieved null pointer as handle to get next entry from blacklist. [SFE_BLS_ERR_HANDLE_NULLPTR_GETNEXT|NA]
* @retval UINT32 Recieved null pointer to get next entry from blacklist. [SFE_BLS_ERR_STRUCT_NULLPTR_GETNEXT|NA]
* @retval UINT32 Failed to get next entry from blacklist as blacklist is not initialized. [BLS_ERR_INIT_GETNEXT|NA]
* @retval UINT32 Failed to get next entry from blacklist as iterator operation failed. [BLS_ERR_GET_FAIL_GETNEXT|NA]
* @retval UINT32 No item exists in blacklist. [FWCOMMON_ITERATOR_ITEM_NOT_EXIST|NA]
* 
* @par Dependency
* None
...
* @param[out] NA NA [NA]
* 
* @retval UINT32 Closing blacklist is success. [BLS_OK|NA]
* @retval UINT32 Recieved null handle to close blacklist.. [SFE_BLS_ERR_NULLPTR_CLOSELIST|NA]
* @retval UINT32 Failed to close blacklist as blacklist is not initialized. [BLS_ERR_INIT_CLOSELIST|NA]
* @retval UINT32 Failed to close blacklist as iterator operation failed. [BLS_ERR_CLOSE_FAIL_CLOSELIST|NA]
* 
* @par Dependency
*	- bls_common.h
*	- sfe_fwcommon_inc.h
...
* 
* @param[in] NA NA [NA]
* @param[out] pstBLSStat Blacklist statistics structure [NA]
* 
* @retval UINT32 Getting blacklist statistics success. [BLS_OK|NA]
* @retval UINT32 Recieved null pointer as blacklist statistics structure. [SFE_BLS_ERR_STRUCT_NULLPTR_GETSTAT|NA]
* @retval UINT32 Failed to get blacklist statistics as blacklist is not initialized. [BLS_ERR_INIT_GETSTAT|NA]
* 
* @par Dependency
...
* 
* @param[in] u32VCPUNum VCPU number for which statistics are required [NA]
* @param[out] pstBLSStat Blacklist statistics structure [NA]
* 
* @retval UINT32 Getting blacklist statistics of given VCPU is success. [BLS_OK|NA]
* @retval UINT32 Recieved invalid VCPU number. [SFE_BLS_ERR_INVALID_VCPUNUM_GETVCPUSTAT|NA]
* @retval UINT32 Recieved null pointer as blacklist statistics structure. [SFE_BLS_ERR_STRUCT_NULLPTR_GETVCPUSTAT|NA]
* @retval UINT32 Failed to get blacklist statistics of given VCPU 
* as blacklist is not initialized. [BLS_ERR_INIT_GETVCPUSTAT|NA]
* 
* @par Dependency
* fwcommon_statistic_api.h
* 
...
* entries were added to blacklist.
* 
* @param[in] u32VCPUNum VCPU number for which statistics is required [NA]
* @param[out] NA NA [NA]
* 
* @retval VOID This function does not return any value. [NA|NA]
* 
...
* 
* @param[in] u32GroupNumber ACL group number which is to be binded with blacklist [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 Binding ACL group to blacklist is success. [BLS_OK|NA]
* @retval UINT32 Indicates received invalid ACL group number. only basic and advanced groups can 
* be binded with blacklist [SFE_BLS_ERR_INVLID_ACL_GROUP_NUMBER|NA]
* @retval UINT32 Binding ACL group to blacklist is failed, as blacklist is not initialized 
* [BLS_ERR_INIT_SETBINDACLGROUP|NA]
* 
* @par Dependency
* None
* 
...
* 
* @param[in] NA NA [NA]
* @param[out] pu32GroupNumber The pointer in which binded acl group will be stored. [NA]
* 
* @retval UINT32 Getting ACL group binded with blacklist is success. [BLS_OK|NA]
* @retval UINT32 Indicates received null pointer as input to get ACL group number 
* binded with blacklist [SFE_BLS_ERR_NULLPTR_GET_BINDACLGROUP|NA]
* @retval UINT32 Getting ACL group binded with blacklist is failed, as blacklist is not initialized 
* [BLS_ERR_INIT_GETBINDACLGROUP|NA]
* 
* @par Dependency
* None
* 
