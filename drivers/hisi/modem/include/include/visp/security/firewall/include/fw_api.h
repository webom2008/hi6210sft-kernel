...
* @param[out] NA NA [NA]
*
* @retval UINT32 Firewall initialization is success [FW_INIT_OK|NA] 
* @retval UINT32 Malloc fails in whitelist [WLS_ERR_MALLOC|NA] 
* @retval UINT32 Registering global variable name fails in whitelist [WLS_ERR_ADD_NAMEDB|NA] 
* @retval UINT32 Hash table initialization fails for whitelist [WLS_ERR_HASH_INIT|NA] 
* @retval UINT32 Malloc fails in blacklist [BLS_ERR_MALLOC|NA] 
* @retval UINT32 Registering global variable name fails in blacklist [BLS_ERR_ADD_NAMEDB|NA] 
* @retval UINT32 Hash table initialization fails for blacklist [BLS_ERR_HASH_INIT|NA] 
* @retval UINT32 Malloc fails in malformed attack module [AD_ERR_MALLOC_AD_MALFORM_CFG_S|NA]
* @retval UINT32 Registering global variable name fails in malformed attack module [AD_ERR_ADD_NAME_DB_MALFORM_CFG_S|NA]
* @retval UINT32 Malloc fails in malformed attack module [AD_ERR_MALLOC_AD_CFG_S|NA]
* @retval UINT32 Registering global variable name fails in attack module [AD_ERR_ADD_NAME_DB_AD_CFG_S|NA]
* @retval UINT32 Hash table initialization fails for attack module [AD_HASH_FAIL_INIT_IF_CFG|NA]
* @retval UINT32 Hash table initialization fails for flood attack module [AD_HASH_FAIL_INIT_FLOOD_CFG|NA]
*
* @par Dependency
* sfe_fwcommon_inc.h
* 
...
* @param[in] u32ModuleType Module type [NA]
* @param[out] NA NA [NA]
*
* @retval UINT32 Enable/Disable success [FW_OK|NA] 
* @retval UINT32 Global configuration for firewall not initialized [FW_CFG_NULL_SFE_ENABLE_FW_MODULE_BY_TYPE|NA] 
* @retval UINT32 Invalid input parameter to the function [FW_INVALID_INPUT_SFE_ENABLE_FW_MODULE_BY_TYPE|NA] 
*
* @par Dependency
* sfe_fwcommon_inc.h
* 
...
* @param[out] NA NA [NA]
*
* @retval UINT32 Disabled [0|NA] 
* @retval UINT32 Enabled [1|NA] 
*
* @par Dependency
* sfe_fwcommon_inc.h
* 
...
* @param[in] u32Layer Layer to which the receive function is hooked [NA]
* @param[out] NA NA [NA]
*
...
* @param[out] NA NA [NA]
*
* @retval UINT32 The message should be processed by protocol stack [IP_PP4_NOT_PROCESSED_BY_INTERMEDIATE|NA]
...
* include black list, white list, attack defense, and packet filter.
* 
* @param[in] pstMBuf Pointer to SFE_MBUF_S structure [NA]
* @param[out] NA NA [NA]
*
* @retval UINT32 The message should be process by protocol stack [IP_PP4_NOT_PROCESSED_BY_INTERMEDIATE|NA]
* @retval UINT32 The message should be drop by protocol stack [IP_PP4_INTER_PROCESS_ERROR|NA] 
* @retval UINT32 The message has been process by firewall. PP do not need to process the packet any more.
* [IP_PP4_PROCESSED_BY_INTERMEDIATE|NA]
* 
* @par Dependency
...
*
* @retval UINT32 The message should be processed by protocol stack [IP_PP4_NOT_PROCESSED_BY_INTERMEDIATE|NA]
* @retval UINT32 The message should be dropped by protocol stack [IP_PP4_INTER_PROCESS_ERROR|NA] 
* @retval UINT32 The message has been processed by firewall. PP do not need to process the packet any more.
* [IP_PP4_PROCESSED_BY_INTERMEDIATE|NA]
* 
* @par Dependency
...
* @par Prototype
* @code
* UINT32 FW_GetVersion(INT8 *pi8VerInfo);
* @endcode 
* 
* @par Description
...
* 
* @param[in] NA NA [NA]
* @param[out] pi8VerInfo Pointer for storing the verion info [NA]
*
* @retval UINT32 Get Version successful [FW_OK|NA]
* @retval UINT32 NULL pointer passed for getting the version [FW_NULL_INPUT_PASSED_GET_VERSION|NA] 
* 
* @par Dependency
* 
* @par Note
