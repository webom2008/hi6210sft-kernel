...
* firewall settings.     
* 
* @param[in] pstHookFunc Pointer to the FWCOMMON_LOG_HOOK_FUNC_S.  [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 On Success [FW_OK|NA]
* @retval UINT32 pstHookFunc is NULL pointer [FWCOMMON_DEBUG_REGLOGHOOK_NULLPTR|NA]
* @retval UINT32 Please refer the return value of TCPIP_RegFuncLogOutputHook of VISP control plane [NA|NA]
* 
* @par Dependency
...
* 
* @retval UINT32 On Success [FW_OK|NA]
* @retval UINT32 Please refer the return value of TCPIP_SetLogLevel of VISP control plane [NA|NA]
* @retval UINT32 Please refer the return value of SFE_SetLogLevel of VISP data plane [NA|NA]
* 
* 
* @par Dependency
...
* 
* @retval UINT32 On Success [FW_OK|NA]
* @retval UINT32 pu32LogLevel is NULL pointer [FWCOMMON_DEBUG_REGGETLOGLEVEL_NULLPT|NA]
* @retval UINT32 Please refer the return value of TCPIP_GetLogLevel of VISP control plane [NA|NA]
* @retval UINT32 Please refer the return value of SFE_GetLogLevel of VISP data plane [NA|NA]
* 
* @par Dependency
* tcpip/public/tcpip_debug.h
* ipsfe/public/debug/include/sfe_log.h
...
* 
* @retval UINT32 On Success [FW_OK|NA]
* @retval UINT32 Please refer the return value of TCPIP_SetLogType of VISP control plane [NA|NA]
* @retval UINT32 Please refer the return value of SFE_SetLogType of VISP data plane [NA|NA]
* 
* @par Dependency
* tcpip/public/tcpip_debug.h
* ipsfe/public/debug/include/sfe_log.h
...
* 
* @retval UINT32 On Success [FW_OK|NA]
* @retval UINT32 Input pointer is NULL. [FWCOMMON_DEBUG_GETLOGTYPE_NULLPTR|NA]
* @retval UINT32 Please refer the return value of TCPIP_GetLogType of VISP control plane [NA|NA]
* @retval UINT32 Please refer the return value of SFE_GetLogType of VISP data plane [NA|NA]
* 
* @par Dependency
* tcpip/public/tcpip_debug.h
* ipsfe/public/debug/include/sfe_log.h
...
* firewall settings.
* 
* @param[in] pfDebugOutput Function pointer of type FWCOMMON_DEBUG_OUTPUT_CALLBACK_FUNC [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 On Success [FW_OK|NA]
* @retval UINT32 pfDebugOutput is NULL pointer [FWCOMMON_DEBUG_REGDEBUGHOOK_NULLPTR|NA]
* @retval UINT32 Please refer the return value of TCPIP_RegFuncDebugOutputHook of VISP control plane [NA|NA]
* 
* 
* @par Dependency
* tcpip/public/tcpip_pub_api.h
...
* 
* @retval UINT32 On Success [FW_OK|NA]
* @retval UINT32 Please refer the return value of SFE_SetDebugTypeSwitch of VISP data plane [NA|NA]
* 
* @par Dependency
* tcpip/public/tcpip_pub_api.h
* 
...
*  
* @param[in] u32DebugVcpuSwitch VCPU switch number [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 On Success [FW_OK|NA]
* @retval UINT32 Please refer the return value of SFE_SetDebugVcpuSwitch of VISP data plane [NA|NA]
* 
* 
* @par Dependency
...
* @param[out] NA NA [NA]
* 
* @retval UINT32 On Success [FW_OK|NA]	SFE_GetLogLevel
* @retval UINT32 Please refer the return value of SFE_SetDebugModuleSwitch of VISP data plane [NA|NA]
* 
* @par Dependency
* None
* 
...
* 
* @param[in] NA NA [NA]
* @param[out] pu32DebugTypeSwitch Debug type information [NA]
* @param[out] pu32DebugVcpuSwitch Debug VCPU switch number [NA]
* @param[out] pu32DebugModuleSwitch Debug module information [NA]
* 
* @retval UINT32 On Success [FW_OK|NA]
* @retval UINT32 Input pointer is NULL [FWCOMMON_DEBUG_GETDEBUGSWITCH_NULLPTR|NA]
* @retval UINT32 Please refer the return value of SFE_SetDebugModuleSwitch of VISP data plane [NA|NA]
* 
* @par Dependency
* None
...
* 
* @param[in] pfInfoOutput Function pointer of type FWCOMMON_INFO_OUTPUT_CALLBACK_FUNC [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 On Success [FW_OK|NA]
* @retval UINT32 pfInfoOutput is NULL Pointer [FWCOMMON_DEBUG_REGINFOHOOK_NULLPTR|NA]
* @retval UINT32 Please refer the return value of TCPIP_RegFuncInfoOutputHook of VISP control plane [NA|NA]
* 
* @par Dependency
* tcpip/public/tcpip_pub_api.h
* 
