...
* 
* @param[in] u32FlowStatSwitch Value for setting the Flow statistics switch [NA]
* [1-Enable/0-Disable]
* @param[out] NA NA [NA]
*
* @retval UINT32 Setting Flow Statistics switch successful [FW_OK|NA] 
*
* @par Dependency
* None
* 
...
* 
* @param[in] NA NA [NA]
* @param[out] pu32FlowStatSwitch Address of location to get the value of Flow Statistics switch [NA]
*
* @retval UINT32 Getting Flow Statistics switch successful [FW_OK|NA] 
*
* @par Dependency
* None
* 
...
* 
* @param[in] u32FlowId Flow ID whose statistics is to be displayed[NA]
* @param[out] NA NA [NA]
*
* @retval NA [NA|NA]
*
...
* @param[out] NA NA [NA]
*
* @retval UINT32 Clearing Flow Statistics is successful [FW_OK|NA]
*
* @par Dependency
* None
* 
...
* @param[out] NA NA [NA]
*
* @retval UINT32 Maximum number of flows [NA|NA]
*
* @par Dependency
* None
* 
...
* 
* @param[in] u32FWStatSwitch Value for statistics switch [NA]
* @param[out] NA NA [NA]
*
* @retval UINT32 Setting the statistics switch success  [FW_OK|NA] 
* @retval UINT32 Invalid value passed for the statistics switch  [FWCOMMON_DEBUG_SFE_SETFWSTATISTICSWITCH_INVALID_SWITCH|NA] 
* @retval UINT32 The global variable for the statistics switch is not initialized [FWCOMMON_DEBUG_SFE_SETFWSTATISTICSWITCH_NULL_SWITCH|NA] 
*
* @par Dependency
* Fwcommon_var.h
* 
...
* 
* @param[in] NA NA [NA]
* @param[out] pu32FWStatSwitch Pointer to the statistics switch variable [NA]
*
* @retval UINT32 Setting the statistics switch success  [FW_OK|NA] 
* @retval UINT32 NULL pointer passed as argument  [FWCOMMON_DEBUG_SFE_GETFWSTATISTICSWITCH_NULLPTR|NA] 
* @retval UINT32 The global variable for the statistics switch is not initialized [FWCOMMON_DEBUG_SFE_GETFWSTATISTICSWITCH_NULL_SWITCH|NA] 
*
* @par Dependency
* Fwcommon_var.h
* 
