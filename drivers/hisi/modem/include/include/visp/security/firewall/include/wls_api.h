...
* @param[out] NA NA [NA]
* 
* @retval UINT32 Enabling Whitelist is success [WLS_OK|NA]
* @retval UINT32 Enabling Whitelist has failed as Firewall is not initialized [WLS_ERR_INIT_ENABLE|NA]
* 
* @par Dependency
* None
* 
...
* @param[out] NA NA [NA]
* 
* @retval UINT32 Disabling Whitelist is success. [WLS_OK|NA]
* @retval UINT32 Disabling Whitelist has failed as Firewall is not initialized [WLS_ERR_INIT_DISABLE|NA]
* 
* @par Dependency
* None
* 
...
* 
* @param[in] pstWLSInfo Pointer to WLS_INFO_S structure. [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 Adding entry to Whitelist is success. [WLS_OK|NA]
* @retval UINT32 Received NULL pointer as input argument. [SFE_WLS_ERR_ADD_NULLPTR_INPUT|NA]
* @retval UINT32 Failed to insert entry in Whitelist as Firewall is not initialized [WLS_ERR_INIT_ADDENTRY|NA]
* @retval UINT32 Failed to insert entry in Whitelist as hash operation failed. [WLS_ERR_ADD_INTERNAL_HASH_FAIL|NA]
* @retval UINT32 Maximum number of rules reached for Whitelist. [WLS_MAXRULEREACHED|NA]
* 
* @par Dependency
* None
* 
...
* @param[out] NA NA [NA]
* 
* @retval UINT32 Deleting entry from Whitelist is success. [WLS_OK|NA]
* @retval UINT32 Received NULL pointer as input argument. [SFE_WLS_ERR_DELETE_NULLPTR_INPUT|NA]
* @retval UINT32 Failed to delete entry from Whitelist as Firewall is not initialized. [WLS_ERR_INIT_DELENTRY|NA]
* @retval UINT32 The entry does not exists in Whitelist. [WLS_ENTRY_NOT_EXISTS|NA]
* 
* @par Dependency
* None
* 
...
* @param[out] NA NA [NA]
* 
* @retval UINT32 Initializing Whitelist is success. [WLS_OK|NA]
* @retval UINT32 Error in getting preconfiguration data for Whitelist. [WLS_ERR_GET_PRECONFIG_FAIL|NA]
* @retval UINT32 Failed to allocate memory for Whitelist. [WLS_ERR_MALLOC|NA]
* @retval UINT32 Registering global variable name failed in Whitelist. [WLS_ERR_ADD_NAMEDB|NA]
* @retval UINT32 Hash table initialization failed for Whitelist. [WLS_ERR_HASH_INIT|NA]
* @retval UINT32 Statistics initialization failed for Whitelist. [WLS_ERR_STAT_INIT|NA]
* 
* @par Dependency
* None
* 
...
* 
* @param[in,out] ppHandle Pointer to a pointer to the Whitelist handle[NA]
* 
* @retval UINT32 Opening Whitelist is success. [FWCOMMON_ITERATOR_ITEM_EXIST|NA]
* @retval UINT32 Received NULL pointer as input argument to open Whitelist. 
* [SFE_WLS_ERR_NULLPTR_OPENLIST|NA]
* @retval UINT32 Failed to open Whitelist as Whitelist is not initialized. [WLS_ERR_INIT_OPENLIST|NA]
* @retval UINT32 Failed to open Whitelist as iterator operation failed. [WLS_ERR_OPEN_FAIL_OPENLIST|NA]
* @retval UINT32 No item exists in Whitelist. [FWCOMMON_ITERATOR_ITEM_NOT_EXIST|NA]
* 
* @par Dependency
* None
* 
...
*
* @param[in] pHandle Handle to Whitelist [NA]
* @param[out] pstWLSInfo Structure to get the Whitelist entries[NA]
* 
* @retval UINT32 Getting next item from Whitelist is success. [FWCOMMON_ITERATOR_ITEM_EXIST|NA]
* @retval UINT32 NULL pointer is passed for handle to Whitelist. [SFE_WLS_ERR_HANDLE_NULLPTR_GETNEXT|NA]
* @retval UINT32 NULL pointer is passed for pointer to Whitelist structure. [SFE_WLS_ERR_STRUCT_NULLPTR_GETNEXT|NA]
* @retval UINT32 Failed to get next entry from Whitelist as Whitelist is not initialized. [WLS_ERR_INIT_GETNEXT|NA]
* @retval UINT32 Failed to get next entry from Whitelist as iterator operation failed. [WLS_ERR_GET_FAIL_GETNEXT|NA]
* @retval UINT32 No item exists in Whitelist. [FWCOMMON_ITERATOR_ITEM_NOT_EXIST|NA]
* 
* @par Dependency
* None
...
* @param[out] NA NA [NA]
* 
* @retval UINT32 Closing Whitelist is success. [WLS_OK|NA]
* @retval UINT32 Received NULL pointer to close Whitelist. [SFE_WLS_ERR_HANDLE_NULLPTR_CLOSELIST|NA]
* @retval UINT32 Failed to close Whitelist as Whitelist is not initialized. [WLS_ERR_INIT_CLOSELIST|NA]
* @retval UINT32 Failed to close Whitelist as iterator operation failed. [WLS_ERR_CLOSE_FAIL_CLOSELIST|NA]
* 
* @par Dependency
* None
* 
...
* 
* @param[in] NA NA [NA]
* @param[out] pstWLSStat Whitelist statistics structure [NA]
* 
* @retval UINT32 Getting Whitelist statistics is success. [WLS_OK|NA]
* @retval UINT32 Received NULL pointer as Whitelist statistics structure. [SFE_WLS_ERR_STRUCT_NULLPTR_GETSTAT|NA]
* @retval UINT32 Failed to get Whitelist statistics as Whitelist is not initialized. [WLS_ERR_INIT_GETSTAT|NA]
* 
* @par Dependency
...
* @param[out] pstWLSStat Whitelist statistics structure [NA]
* 
* @retval UINT32 Getting Whitelist statistics of given VCPU is success. [WLS_OK|NA]
* @retval UINT32 Received NULL pointer as Whitelist statistics structure. [SFE_WLS_ERR_STRUCT_NULLPTR_GETVCPUSTAT|NA]
* @retval UINT32 Received invalid VCPU number. [SFE_WLS_ERR_INVALID_VCPUNUM_GETVCPUSTAT|NA]
* @retval UINT32 Failed to get Whitelist statistics of given VCPU 
* because Whitelist is not initialized. [WLS_ERR_INIT_GETVCPUSTAT|NA]
* 
* @par Dependency
*	- fwcommon_statistic_api.h
* 
