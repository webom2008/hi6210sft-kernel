...
* 
* @param[in] u32Priority Priority [NA]
* @param[out] NA NA [NA]
*
* @retval UINT32 Hooking success [FWCOMMON_HOOK_OK|NA]
* @retval UINT32 InboundFilter register failed for MAC layer [FW_ERR_MAC_INBOUND_REGISTER_FAILED|NA]
* @retval UINT32 InboundFilter register failed for MAC layer [FW_ERR_MAC_OUTBOUND_REGISTER_FAILED|NA]
* @retval UINT32 InboundFilter already registered in IP layer [FW_ERR_IP_INBOUND_ALREADY_REGISTERED|NA]
* @retval UINT32 InboundFilter register failed for IP layer [FW_ERR_IP_INBOUND_REGISTER_FAILED|NA]
* @retval UINT32 OutboundFilter already registered in IP layer [FW_ERR_IP_OUTBOUND_ALREADY_REGISTERED|NA]
* @retval UINT32 OutboundFilter register failed for IP layer [FW_ERR_IP_OUTBOUND_REGISTER_FAILED|NA]
* 
* @par Dependency
*    - sfe_fwcommon_inc.h
* 
