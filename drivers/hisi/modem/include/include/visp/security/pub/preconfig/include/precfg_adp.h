...
* 
* @param[in] u32Key Key to identify the parameter for which configuration needs to be done [NA]
* @param[in] u32Val Value to be configured [NA]
* @param[out] NA NA [NA]
* 
* @retval UINT32 Setting pre-configuration is success [FW_OK|NA]
* @retval UINT32 Failed to set pre-configuration [IPSAFE_SET_INVALID_VALUE|NA]
* 
* 
*
* @par Note
...
* 
* @param[in] u32Key Key to identify the parameter for which configured value is needed [NA]
* @param[out] *puu32Val To store the configured value [NA]
* 
* @retval UINT32 Getting configured value is success [FW_OK|NA]
* @retval UINT32 Received null pointer as input [IPSAFE_VAL_NULL_PTR|NA]
* @retval UINT32 Failed to get configured value [IPSAFE_GET_INVALID_KEY|NA]
* 
* @par Note
