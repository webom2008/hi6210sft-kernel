...
extern ULONG OAM_1AG_GetMaWithVID(USHORT VLANID,OAM_1AG_MA_S **pstMaInfo);
...
extern ULONG OAM_Y1731_GetMaWithVIDPlusMDLevel(USHORT usVlanID, UCHAR ucMdLevel, OAM_1AG_MA_S **pstMaInfo);
extern ULONG OAM_Y1731_GetMaWithVIDPlusMegID(USHORT usVlanID, UCHAR* pucMegID, OAM_1AG_MA_S **pstMaInfo);
...
extern ULONG  OAM_1AG_NpNotify(ULONG aulMsg[4]);
