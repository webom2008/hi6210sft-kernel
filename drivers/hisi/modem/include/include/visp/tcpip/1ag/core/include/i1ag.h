...
DECLARE_INTERFACE (IIF_COMP_OAM1AG_ComIntFUN)
{
    ...
    METHOD_(ULONG, pfOAM_1AG_NpNotify)(ULONG aulMsg[4]);
...
DECLARE_INTERFACE (IIF_COMP_OAM1AG_ComIntCFG)
{
    ...
    /* Edit by L00105073 at 2009-12-23 for 1agOverTrunkPort */
    ...
    /* Edit by C00168670 at 2010-10-13 for 1AG waring inquiry */
