...
enum eOAM1AGERRCODE
{
    ...
    OAM1AG_ERR_LTSELFMAC,           /*31链路跟踪测试的目的MAC地址等于本地MAC地址 */
    ...
    OAM1AG_ERR_MACADDR,             /*36用户MAC地址错误*/
    OAM1AG_ERR_RMEPHAVENOMAC,       /*37RMEP 表项没有MAC地址*/
    ...
    OAM1AG_ERR_LBSELFMAC,           /*45环回测试的目的地址等于出接口的mac地址 */
    ...
    OAM1AG_ERR_GETMACADDR,          /*51获取出接口的mac地址失败 */
    ...
    OAM1AG_ERR_MACADDR_NOTUNICAST,  /* 61 非单播MAC地址*/
    ...
    OAM1AG_ERR_GET_PMPOLICY,        /* 79 获取监控策略失败 */
...
typedef struct tagTCPIP_1AG_PING
{
    ...
    UCHAR  *pucMacAddr;     /* 1AG Mac Ping使用的目的MAC地址.指向"XX-XX-XX-XX-XX-XX"形式MAC地址的指针,
                               如果为NULL则根据RMEP Ping,否则根据指定的MAC地址和接口索引Ping */
...
typedef struct tagTCPIP_1AG_USERPING
{
    UCHAR   szMDName[OAM_1AG_MAX_MDNAME_LEN + 1]; /*MD名字,最长为43字节*/
    UCHAR   szMaName[OAM_1AG_MAX_MANAME_LEN + 1]; /*MA名字,最长为43字节*/
    UCHAR  *pucMacAddr;     /* 1AG Mac User Ping使用的目的MAC地址.指向"XX-XX-XX-XX-XX-XX"形式MAC地址的指针,
                               如果为NULL则根据RMEP Ping,否则根据指定的MAC地址和接口索引Ping */
...
{
    UCHAR  szMacAddr[OAM_1AG_MACADDR_LEN];       /* 报文中的源MAC地址 */
...
typedef struct tagDISP_MEP_INFO
{
    ...
    USHORT usMepId;                         /* MEP ID */
    UCHAR  szMacAddr[OAM_1AG_MACADDR_LEN];  /* RMEP MAC地址 */
...
/* Added by c00168670, VISPV1R8C05 for 1AG warning inquiry, 2010/10/13 */
/* 1AG对外告警状态*/
...
/*End of Added by c00168670, 2010/10/13 */
