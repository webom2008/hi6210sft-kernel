...
ULONG OAM_3AH_OpenWtLstObject(ULONG *pulWaitListHandle);
ULONG OAM_3AH_CloseWtLstObject (ULONG ulWaitListHandle);
ULONG OAM_3AH_GetWtLstEntry(ULONG ulWaitListHandle, OAM3AH_PORTINFO_S *pstOam3ahPortInfo);
