...
/* Modified by w60786 for BC3D01047 2008-12-31 */
/* 3AH模块信息 */
...
DECLARE_INTERFACE (IIF_COMP_OAM3AH_ComIntFUN)
{
    ...
    METHOD_(VOID , pfOAM_3AH_DealLinkCtrlMsg)(ULONG aulMsg[4]);  /* 底层(driver/np)消息通知处理函数 */
    ...
    /* 3ah waitlist */
    METHOD_(ULONG, pfOAM_3AH_OpenWtLstObject)(ULONG *pulWaitListHandle); 
    METHOD_(ULONG, pfOAM_3AH_GetWtLstEntry)(ULONG ulWaitListHandle, OAM3AH_PORTINFO_S *pstOam3ahPortInfo); 
    METHOD_(ULONG, pfOAM_3AH_CloseWtLstObject)(ULONG ulWaitListHandle); 
