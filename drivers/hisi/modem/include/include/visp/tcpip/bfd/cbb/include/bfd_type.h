...
typedef struct tagBFD_SESS_CFG_ENTRY_S
{
    ...
    UCHAR   ucAuthPwd[BFD_LEN_MAX_SIMPLE_PWD + 1] ;      /* BFD配置的认证密码 */
...
typedef struct tagBFD_SESS_ENTRY_S
{
    ...
    CHAR*   pchPacket                         ;      /* 报文缓存Buffer，若参数未更改则直接拷贝发送，不用再构造报文 */
    ...
    /*Added by r62469 for defect BC3D01699 Begin*/
    ULONG   ulSentNegoPakcets; /*用于统计发送报文个数，不会被清除，除非会话被删除*/
    /*Added by r62469 for defect BC3D01699 End*/
...
/* Begin:VISP1.7C03 VRF wangchengyang,2009-02-01 */
/* BFD会话表项，增加了VRF信息 */
typedef struct tagBFD_VRFSESS_ENTRY_S
{
    ULONG ulVrfIndex                                          ;  /* VRF索引 */
    ULONG ulBfdNumber                                         ;  /* 该VRF下的BFD4个数 */
    /*Added by wangchengyang-xujun62830-57575, VISPV1R8C01, 2009/4/8 */
    ULONG ulBfd6Number                                        ;  /* 该VRF下的BFD6个数 */
    /* End of Added by wangchengyang-xujun62830-57575, 2009/4/8 */
    /* Modified by z00208058/w00207740, BFD会话规格扩展, 2012/5/8 */
    BFD_SESS_ENTRY_S **pstBfdSessEntry;  /* 该VRF下的BFD表项 */
    /*End of Modified by z00208058/w00207740, 2012/5/8 */
}BFD_VRFSESS_ENTRY_S;
/* End:VISP1.7C03 VRF wangchengyang,2009-02-01 */
...
typedef struct tagBFD_CONTROL_PACKET_S
{
     ...
     UCHAR   ucAuthPwd[BFD_LEN_MAX_SIMPLE_PWD + 1] ;      /* 认证的密码 */
...
{
    BFD_ADD_IPADDR,           /* 增加IP地址 */
    BFD_DEL_IPADDR,           /* 删除IP地址 */
...
typedef struct tagBFD_MSG_S
{
   ...
   ULONG   ulIfIndex       ;   /* 接口索引，用于IP地址增删 */
   /* Begin:VISP1.7C03 VRF wangchengyang,2009-02-01,因为BFD会话需要会话ID和Vrf Index共同标识
   * 而写消息的时候消息队列的参数是四个元素的ULONG的数组,鉴于IP地址和VRFIndex不同时出现，因此改为联合体 */
   union
   {
       ULONG   ulIPAddr    ;   /* IP地址,网络序，用于IP地址增删 */
       ULONG   ulIP6AddrHandle;
       ULONG   ulVrfIndex  ;   /* VRF索引 */
       ULONG   ulLinkLink  ;   /* 用于传递数据的指针 */
   }unPrivate;
   /* End:VISP1.7C03 VRF wangchengyang,2009-02-01 */
} BFD_MSG_S;
...
/*Add by q62011 for BC3D02224 start*/
...
/*Add by q62011 for BC3D02224 end*/
