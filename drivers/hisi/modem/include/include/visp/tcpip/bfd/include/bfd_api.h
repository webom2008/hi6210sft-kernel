...
/*Add by Q62011 for bfd ext start*/
/* BFD会话操作字 */
...
typedef struct tagBFD_SESSION_CREATE_WITH_PARA_S {
    ...
    ULONG ulSrcIP;                  /* 指定会话的源IP地址；主机序；*/
    ULONG ulDstIP;                  /* 指定会话的目的IP地址；主机序；*/
...
*               （主要检查参数有效性，调用CBB实现功能）
*        Input: ULONG ulDstIP      指定会话的目的IP地址；主机序；
*               ULONG ulSrcIP      指定会话的源IP地址；主机序；
*               ULONG ulOutIfIndex   单跳会话时为出接口索引，多跳时值为0；
...
*  2007-5-17  wujie(61195)         Modified for A82D15480，入参IP地址变为主机序
*******************************************************************************/
...
*
*******************************************************************************/
extern ULONG BFD_GetSessionConfigEntry(ULONG ulEntryWaitList,BFD_SESSION_CONFIG_INFO_S *pstConfigInfo);
/*******************************************************************************
...
*
*******************************************************************************/
extern ULONG BFD_GetSessionCountEntry(ULONG ulEntryWaitList,BFD_SESSION_COUNT_S *pstCount);
/*******************************************************************************
...
*
*******************************************************************************/
extern ULONG BFD_GetSessionInfoEntry(ULONG ulEntryWaitList,BFD_SESSION_ALL_INFO_S *pstSessionInfo);
/*******************************************************************************
...
*
*******************************************************************************/
extern ULONG BFD_GetSessionBriefEntry(ULONG ulEntryWaitList,BFD_SESSION_BRIEF_INFO_S *pstBriefInfo);
/*******************************************************************************
...
*
*******************************************************************************/
extern ULONG BFD_OpenSessionTable(ULONG *pulWaitListHandle,BFD_SESSION_FILTER_S *pstFilter);
/*******************************************************************************
...
*  2008-8-4     qinyun(62011)           Creat the first version.
*******************************************************************************/
extern ULONG BFD_CloseSessionTable(ULONG ulWaitListHandle);
/*******************************************************************************
...
*
*******************************************************************************/
extern ULONG BFD6_GetSessionConfigEntry(ULONG ulEntryWaitList,BFD6_SESSION_CONFIG_INFO_S *pstConfigInfo);
...
*
*******************************************************************************/
extern ULONG BFD6_GetSessionInfoEntry(ULONG ulEntryWaitList,BFD6_SESSION_ALL_INFO_S *pstSessionInfo);
...
*
*******************************************************************************/
extern ULONG BFD6_OpenSessionTable(ULONG *pulWaitListHandle,BFD6_SESSION_FILTER_S *pstFilter);
...
*  2009-4-8  wangchengyang-xujun62830-57575     Creat the first version.
*******************************************************************************/
extern ULONG BFD6_CloseSessionTable(ULONG ulWaitListHandle);
...
ULONG BFD_NSR_OpenSessionStatTable(ULONG *pulWaitListHandle,BFD_SESSION_FILTER_S *pstFilter);


ULONG BFD_NSR_GetSessionStateEntry(ULONG ulEntryWaitList,BFD_NSR_SESS_INFO_S *pstSessionNsrInfo);


ULONG BFD_NSR_CloseSessionStatTable(ULONG ulWaitListHandle);
...
*******************************************************************************/
ULONG BFD6_GetSessionCountEntry(ULONG ulEntryWaitList,BFD_SESSION_COUNT_S *pstCount);
...
*  2013-11-14   wangjiaqi               Creat the first version.
*******************************************************************************/
ULONG BFD6_GetSessionBriefEntry(ULONG ulEntryWaitList,BFD_SESSION_BRIEF_INFO_S *pstBriefInfo);
...
*
*******************************************************************************/
ULONG BFD6_NSR_OpenSessionStatTable(ULONG *pulWaitListHandle,BFD6_SESSION_FILTER_S *pstFilter);
/*******************************************************************************
...
*
*******************************************************************************/
ULONG BFD6_NSR_GetSessionStateEntry(ULONG ulWaitListHandle, BFD6_NSR_SESS_INFO_S *pstSessionNsrInfo);
/*******************************************************************************
...
*
*******************************************************************************/
ULONG BFD6_NSR_CloseSessionStatTable(ULONG ulWaitListHandle);
#ifdef __cplusplus
}
