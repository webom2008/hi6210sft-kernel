...
/*Added by zhangchunyu(Z62474) for VISP Support Multi-Instance at 2008/7/24*/
typedef struct tagBFD_CREATE_VRF_SESSION_BAK
{
    USHORT  usType;                /* 备份消息块类型 */
    USHORT  usLen;                 /* 备份消息块的总长度 */
    ULONG   ulSessId;              /* 会话ID */
    ULONG   pulDstIP[4];               /* 目的IP地址(网络序) */
    ULONG   pulSrcIP[4];               /* 源IP地址(网络序) */
    ULONG   ulOutIfIndex;          /* 出接口 */
    ULONG   ulIpVer;
    ULONG   ulVrfIndex;            /* 会话所属得VPN*/
}BFD_CREATE_VRF_SESSION_BAK_S;
/*End of Added by zhangchunyu(Z62474) at 2008/7/24*/
