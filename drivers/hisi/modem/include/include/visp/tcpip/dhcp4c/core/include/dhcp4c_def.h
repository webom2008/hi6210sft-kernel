...
#define DHCP4C_INTERFAC_LOW    0    /* 通过DHCP获取的IP地址优先级高于接口原有的地址优先级 */
#define DHCP4C_INTERFAC_HIG    1    /* 通过DHCP获取的IP地址优先级低于接口原有的地址优先级 */
...
/* Added by w60786 for A82D24357 2008-03-18 */
...
/* Added by y62007 for V1R5C02 DHCP default address,2007/05/16 */
