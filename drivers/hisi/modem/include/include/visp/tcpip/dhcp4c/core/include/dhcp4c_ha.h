...
#define DHCP4C_CFG_DEFAULTIP_SET_BAK       80    /* 设置DHCP默认IP地址 */
#define DHCP4C_CFG_DEFAULTIP_DEL_BAK       81    /* 删除DHCP默认IP地址 */
...
/* 设置HA报文的头(外部总体) */
/* Modify by w60786 for A82D25065 2008-04-17 */
...
ULONG DHCP4C_OpenEntry (ULONG *pulWaitListHandle, ULONG ulWaitId);
ULONG DHCP4C_GetEntry (ULONG ulEntryWaitList, UCHAR *ucData, ULONG ulDataSize, ULONG ulType);
ULONG DHCP4C_CloseObject (ULONG ulWaitListHandle);
