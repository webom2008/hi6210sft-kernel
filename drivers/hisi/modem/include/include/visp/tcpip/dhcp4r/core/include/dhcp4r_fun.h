...
/* dhcp4r_sh_init.c */
VOID DHCP4R_SH_TaskEntry(ULONG ulArg0, ULONG ulArg1, ULONG ulArg2, ULONG ulArg3);
...
ULONG DHCP4R_OpenEntryByVrf(ULONG ulVrfIndex, ULONG *pulWaitListHandle);
ULONG DHCP4R_GetEntryByVrf(ULONG ulVrfIndex, ULONG ulEntryWaitList, DHCP4R_CFG_NODE_S *pstDhcp4rCfgNode);
ULONG DHCP4R_CloseObject (ULONG ulWaitListHandle);
