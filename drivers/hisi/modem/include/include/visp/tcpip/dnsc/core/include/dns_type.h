...
typedef struct DNS_Res_State 
{
    ...
    struct sockaddr_in      nsaddr_list[DNS_DOMAIN_SERVER_NUM]; /* address of name server */
    #define  nsaddr  nsaddr_list[0]      /* for backward compatibility */

    LONG     ns6count;                   /* number of name servers  ipv6*/
    SOCKADDR_IN6_S      nsaddr6_list[DNS_DOMAIN_SERVER_NUM]; /* address of ipv6 name server */
    #define  nsaddr6  nsaddr6_list[0]           /* for first element access*/
