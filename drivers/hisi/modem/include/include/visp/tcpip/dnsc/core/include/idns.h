...
DECLARE_INTERFACE(IIF_COMP_DNSC_ComIntCFG)
{
    ...
    METHOD_(ULONG, pfDNS_OpenDynamicHostTbl)(ULONG *ulDnsCacheHandle,WAITLIST_GETNEXTFUNC pfGetNextFunc);
    METHOD_(ULONG, pfDNS_CloseDynamicHostTbl)(ULONG ulDnsCacheHandle);
    METHOD_(DNS_CACHE_S *,pfDNS_GetDynamicHostFirst)(ULONG ulDnsCacheHandle);
    METHOD_(ULONG, pfDNS_GetDynamicHostNext)(ULONG ulDnsCacheHandle,DNS_CACHE_S **ppstDnsCache);
