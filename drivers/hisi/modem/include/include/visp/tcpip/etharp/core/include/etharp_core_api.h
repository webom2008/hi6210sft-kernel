...
ULONG  ETHARP_LookupArpItem(ULONG ulIfIndex, ULONG ulIpAddr, UCHAR ucMacAddr[ ]);
...
/* End of Added by z00208058, 2013/1/17 */
...
ULONG TCPIP_SetARPExpireTimeByIf_IN( ULONG ulTime, ULONG ulIfIndex);
