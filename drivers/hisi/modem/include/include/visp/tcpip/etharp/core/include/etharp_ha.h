...
/* ARP备份结构 */
typedef struct tag_ARP_BAK
{
    ULONG     ulIfIndex;        /* 接口索引 */
    ULONG     ulIpAddr;         /* IP地址 */
    ULONG     ulRtExpire;       /* 超时时间 */
    UCHAR     szMac[MACADDRLEN];/* MAC地址 */
    UCHAR     ucFlags;          /* ARP标记*/
    UCHAR     ulReserved2;      /* 保留 */
}ARP_BAK_S;

/* Begin: Add by h54884 2008/05/03 VISP Support multi-instance project */
...
/*Added by zhangchunyu(Z62474) for VISP Support Multi-Instance at 2008/5/8*/
...
/* Add by z62474 for BC3D00619 2008-11-09 */
...
/* modify: Add by h54884 2008/05/03 VISP Support multi-instance project */
