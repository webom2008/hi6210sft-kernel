...
extern ULONG IF_AfterEncap( ULONG pIf , ULONG ulShutdown ) ;
extern ULONG IF_BeforeEncap( ULONG pIf , ULONG *ulShutdown, ULONG ulExecID, ULONG ulNewProtocol) ;
...
extern ULONG IF_GetIfLineState(IFNET_S *pstIf, ULONG *pulIfState); /*Added by z36377 for SWFD12089,20050715*/
...
/*Added by x36317 for SWID00122, 2006-02-07*/
