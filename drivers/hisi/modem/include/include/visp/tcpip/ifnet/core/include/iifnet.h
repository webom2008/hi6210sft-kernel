...
DECLARE_INTERFACE(IIF_IFNET_ComIntFUN)
{
    ...
    /*封装前预处理*/
    METHOD_( ULONG, pfIF_BeforeEncap) ( ULONG pIf , ULONG *ulShutdown, ULONG ulExecID, ULONG ulNewProtocol);
    METHOD_( ULONG, pfIF_AfterEncap) ( ULONG pIf , ULONG ulShutdown ); /*封装后处理*/
