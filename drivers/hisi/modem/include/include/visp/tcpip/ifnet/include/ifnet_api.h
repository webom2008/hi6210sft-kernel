...
enum enIfnetErrInfo
{
    ...
    /* Added by f54882, for A82D21993, 2007/12/18 */
...
/* End of Added by z00208058, 2012/12/7 */
...
enum  enumPhyIoCtl
{
    ...
    PHY_SETMACADDR,                     /* 10 配置mac地址 */
    PHY_SETMACTABLE,                    /* 11 配置mac表，VISP暂不使用（预留） */
    PHY_GETMACADDR,                     /* 12 获取mac地址，VISP暂不使用（预留） */
    ...
    /*2003/06/02 zhangwei29537,add for ima,end*/ 
    /*Added by z36377 for VISP3 2005/10/05*/
    PHY_LOOPBACK_STATE,                 /* 69 PHY_LOOPBACK_STATE */
    /*Added by z36377 for SWFD12089 syn VRPD038,20050715*/
    ...
    /*Add by z62474 for BC3D00382 2008-09-18*/
    ...
    /*Added by zhangchunyu(Z62474) for MP/PPP KeepAlive at 2008/8/12*/
    PHY_GETINTFSTATUS,                  /* 82 查询接口状态命令字 */
    PHY_GETINTFTYPE,                    /* 83 查询接口类型命令字 */
    /*End of Added by zhangchunyu(Z62474) at 2008/8/12*/
...
enum enumLowToUp
{
    ...
    ISLATMOAMSTATE,         /* 12 更改ATM可维可测状态命令字，VISP暂不处理此命令字（预留） */
     ...
     /*Added by x36317 for OSP,2004-11-10*/
    ...
    /* Add by z62474 for OSP BC3D00622, 2008-10-26 */
    ...
    /* Modified by l00213099, for setting line status */
    ISSETLINESTATUS,		/*23 设置链路状态 */
    /* End of modified by l00213099, for setting line status */
...
/* modified by z171897/xkf34549 2011-01-22 for 3Dimension preconfig Begin */
#define IF_1D_MODE 0                 /* 表示一维接口 */
#define IF_3D_MODE_DISTRIBUTE 1      /* 表示三维分步式接口 */
#define IF_3D_MODE_CENTRAL 2         /* 表示三维集中式接口 */
/* modified by z171897/xkf34549 2011-01-22 for 3Dimension preconfig End */
...
*  Description: 注册钩子函数，以获取出接口为VI的报文源IP地址
*        Input: TCPIP_GETVIADDR_HOOK_FUNC pfHookFunc: 钩子函数,返回IP地址为网络序
*       Output: NA
*       Return: VOS_OK: 成功
*      Caution: NA
*------------------------------------------------------------------------------
