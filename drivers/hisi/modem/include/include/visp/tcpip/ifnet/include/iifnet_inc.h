...
/* 以下为转发特性 */
    ...
    UINTPTR if_ulCryptMapOut;                 /* 加密出策略控制块 */
...
/* 以太网与PPPOE之间传递控制流程的函数指针 */
    ...
    ULONG if_ulSAstatus; /*标志同异步串口的同步/异步状态*/
    ...
    /* vrrp扩展 */
    ULONG  if_ulStandbyPointer; /* 指向该接口下的第一个vrrp备份组 */
    ...
    ULONG ulHost6RtReserved;  /*IPV6保留主机路由标记 ，IPV4已经在IP
                             控制块中，但IPV6控制块由IR管理*/
    ULONG ulMacChangeFlag;   /* Mac地址改变标记*/                          
}IFNET_S, *PIFNET_S;
...
/*Added for VISP3,z36377,20051021*/
