...
/*This structure is used in callback function to fill the source IP address. */
...
/*This structure is used in TCPIP_GetMGInfo to get the IP address for a particular interface.*/
...
* IP address for outgoing IGMP packets.
...
*
*******************************************************************************/
ULONG TCPIP_OpenMGInfoTable (ULONG *pulHandle, IGMPMGFILTER_S *pstFilter);
...
*
*******************************************************************************/
ULONG TCPIP_GetMGInfo (ULONG ulHandle, IGMPMGINFO_S *pstMgInfo);
...
*
*******************************************************************************/
ULONG TCPIP_CloseMGInfoTable (ULONG ulHandle);
