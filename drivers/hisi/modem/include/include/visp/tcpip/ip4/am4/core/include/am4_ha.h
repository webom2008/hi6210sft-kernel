...
#define IP4_CFG_ADD_MAIN_ADDR_BAK          1    /*增加配置主IP地址 */
#define IP4_CFG_ADD_SEC_ADDR_BAK           2    /*增加配置从IP地址 */
#define IP4_CFG_DEL_MAIN_ADDR_BAK          3    /*删除接口的主IP地址 */
#define IP4_CFG_DEL_SEC_ADDR_BAK           4    /*删除配置的从IP地址 */
#define IP4_UNNUMBER_ADDR_BAK              5    /* 借用接口IP地址标志 */

#define IP4_UNNUMBER_DEL_ADDR_BAK          10   /* 删除借用接口IP地址标志 */
...
/* Added by f54882, for A82D24630, 2008/03/26 */
...
typedef struct tagIP4_CFG_PACKET_HEAD_BAK
{
    ...
    USHORT  usLen;              /* 备份消息块的总长度 */
    ULONG    ulIfIndex;          /* 配置块所属的接口索引 */
    ULONG    ulIpAddr;           /* 配置的IP地址*/
    ULONG    ulIpMask;           /* 配置的IP地址掩码*/
