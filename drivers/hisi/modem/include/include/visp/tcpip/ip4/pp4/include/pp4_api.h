...
#endif
#ifndef IPPROTO_UDP
#define IPPROTO_UDP     17      /* 用户数据协议  user datagram protocol */
#endif
#ifndef IPPROTO_IDP
...
/* Added by w60786 for A82D22367 2008-01-15 */
...
/* 在MBUF的TAG域里设置，表示该IP报文的目地地址是本机某个接口的IP地址 */
...
{
    ULONG ulNextHopIPAddr;  /* 下一跳IP地址, 网络序 */
...
{
    ULONG ulSrcIPAddr; /* 报文的源IP地址,网络序     */
    ULONG ulDstIPAddr; /* 报文的目的IP地址,网络序   */
    ULONG ulVrfIndex;
} SRC_RT_PKT_S;
