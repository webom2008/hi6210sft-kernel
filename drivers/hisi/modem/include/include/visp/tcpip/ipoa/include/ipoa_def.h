...
#define IPOA_INARP_SEND_PAC_MAX_LEN          20     /* 带目标IP地址时20字节 */
#define IPOA_INARP_SEND_PAC_LEN_WITH_DST_IP  20     /* 带目标IP地址时20字节 */
#define IPOA_INARP_SEND_PAC_LEN_NO_DST_IP    16     /* 不带目标IP地址时16字节 */
