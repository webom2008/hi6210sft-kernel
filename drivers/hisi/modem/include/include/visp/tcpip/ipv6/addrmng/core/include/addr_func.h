...
ULONG IP6_Addr_IF_IsAddrOnIpIf(VOID *pstIfNet, IN6ADDR_S stIn6Addr);

ULONG IP6_Addr_IsLocalIfAddr(IN6ADDR_S  *pstAddr, USHORT usVrfIndex);
...
ULONG IP6_Addr_In6Addr2ZoneID (VOID *pstIf, IN6ADDR_S stAdr);
...
ULONG SCOPE6_InterfaceLinkIn(ULONG ulScopeZoneId,
       SCOPE_INTERFACE_S *pstScopeIf, SCOPE_NODE_S *pstScopeLinkHead);

ULONG SCOPE6_InterfaceLinkOut(ULONG ulScopeZoneId,
       SCOPE_NODE_S *pstScopeLinkHead, ULONG ulIfIndex,
       SCOPE_INTERFACE_S **ppstScopeIf);

ULONG SCOPE6_Attach(VOID *pstIf);

ULONG SCOPE6_Detach(VOID *pstIf);
...
/* Added by likaikun 00213099,2014-01-21 */
...
ULONG IP6_Addr_GetLinkLocalIfIndexByAddr(ULONG ulVrfIndex, IN6ADDR_S *pstIn6Addr, 
                                                        ULONG *pulIfIndex);
/* End of Added by likaikun 00213099,2014-01-21 */
