...
#include "ipv6/addrmng/core/include/addr_scope_pub.h"
...
/* Global pointer to site local scope node */
extern SCOPE_NODE_S    *g_pstScopeSiteLocal;


/* Global pointer to link local scope node */
extern SCOPE_NODE_S    *g_pstScopeLinkLocal;
...
extern ULONG g_ulAddrNeedBackup;
