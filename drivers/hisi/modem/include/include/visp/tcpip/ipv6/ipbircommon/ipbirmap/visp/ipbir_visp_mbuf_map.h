...
/*Modified to re-arrange IPB IR mapping headfile for VISP and IPOS.
     1.Files in folder common/func and ipv6/ipbirmap should be componded;
     2.VISP MBUF headfile should be directly included, adapt function can be ignored.
   Modified by w39621 for ipbir mapping, 2006-12-02*/
