...
#define IPB_IR_IP6_ADDR_ISLOCALIFADDR(pstIn6Addr, usVrfIndex)  \
    IP6_Addr_IsLocalIfAddr((VOID *)pstIn6Addr,usVrfIndex)
...
#define IPB_IR_UDP6_PRODUCT_PREPROCESS_HOOK(ppstMBuf, pulOff, ulProto, pulStat,\
                                                                    pulRet)

#define IPB_IR_RAWIP6_PRODUCT_PREPROCESS_HOOK(ppstMBuf, pulOff, ulProto,\
                                                            pulStat, pulRet)
