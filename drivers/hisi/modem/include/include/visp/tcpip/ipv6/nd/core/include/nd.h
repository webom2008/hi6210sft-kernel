...
#define DEBUG_RCV_SAME_IP       6   /* target address is same as ip address */
...
#define ND_MEM_ZERO(m_pBufPtr, m_ulBufLen)\
                        (VOID)VOS_Mem_Zero((CHAR *)(m_pBufPtr),(m_ulBufLen))
...
/* Modified by zhaojianchun z00218831, 2012/11/12 
