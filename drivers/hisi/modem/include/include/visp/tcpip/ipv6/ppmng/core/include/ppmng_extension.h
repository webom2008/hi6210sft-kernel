...
{\
    ...
    prevq->ip6q_pstqNext->ip6q_pstqPrev = (VOID *)newq;\
    prevq->ip6q_pstqNext = (VOID *)newq;\
    g_ulIP6ReassQueNum ++;\
}
#else
#define FRAG6_INSQUE(newq, prevq)\
...
{\
    ...
    /* modified by chenxia for SWFD07007, 2005/03/09 */\
...
ULONG IP6_PP_Route_Hdr_Type0 (MBUF_S *pstMBuf, IP6_S *pstIp6, IP6_ROUTE_TYPE0_S *pstIp6Rt0);
