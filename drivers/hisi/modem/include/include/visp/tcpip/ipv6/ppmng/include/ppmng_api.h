...
#define PP_INPUT_TYPE                     1
#define PP_OUTPUT_TYPE                  2
#define PP_IO_TYPE                           4
#define PP_IFOUTPUT_TYPE               8

#define PP_QOSOUTPUT_TYPE            0x10

/* Added by likaikun 00213099,2014-01-23 */
#define PR_ATOMIC       0x01        /* 只交换少量的信息    exchange atomic messages only */
#define PR_ADDR         0x02        /* 消息中包含地址      addresses given with messages */
/* End of Added by likaikun 00213099,2014-01-23 */
...
{
    IN6ADDR_S ulNextHopIPAddr;  /* 下一跳IP地址, 网络序 */
...
/* Added by likaikun(l00213099) for user-defined RM at 2013-12-06 */
typedef struct tagSrcRt6Packet
{
    IN6ADDR_S ulSrcIPAddr; /* 报文的源IP地址,网络序     */
    IN6ADDR_S ulDstIPAddr; /* 报文的目的IP地址,网络序   */
    ULONG ulVrfIndex;
} SRC_RT6_PKT_S;
...
/* End of added by likaikun(l00213099) for user-defined RM at 2013-12-06 */
...
typedef struct tagIp6multi {
    ...
    VOID *pstIfNet;                    /* back pointer to ifnet */
} IP6Multi;
