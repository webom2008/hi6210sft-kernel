...
DECLARE_INTERFACE( IIF_IP6_SOCK_ComIntFUN)
{
        ...
        METHOD_(ULONG ,pfSOCK6_GetDebugFlag)(); /*Modified by x36317 for IPOS D00072, 2005-12-23*/
        ...
        METHOD_(LONG, pfHeadCache6_SendData)(SOCKET_S *pSocket, struct tagUIO *pUio, ULONG *pulEntryAddr);
};
...
typedef struct tagIPV6_SOCK_INT_OBJ_S
{
    ...
    struct IIF_IP6_SOCK_ComIntFUN * g_IComInt_SOCK6_FUN;/*added by x36308 2005-9-21*/
} IPV6_SOCK_INT_OBJ_S;
