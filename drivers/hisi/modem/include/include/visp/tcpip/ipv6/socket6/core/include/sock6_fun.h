...
/*add by x36308 2005-10-9*/
ULONG SOCK6_GetDebugFlag(VOID); /*Modified by x36317 for IPOS D00072, 2005-12-23*/
...
LONG HeadCache6_SendData(SOCKET_S *pSocket,  UIO_S *pUio, ULONG *pulEntryAddr);
