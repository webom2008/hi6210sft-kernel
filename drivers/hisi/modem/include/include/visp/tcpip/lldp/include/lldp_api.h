...
/******* Class ID TLV  *******/
#define LLDP_MAC_ADDR_LEN      6    /*Mac地址的长度*/
...
typedef struct tagLLDP_PORTID_INFO_S
{
    ...
    CHAR   szPortId[LLDP_STR_LEN_256];   /* PortId，固定MAC地址  */
}LLDP_PORTID_INFO_S;
...
#define LLDP_IF_CMD_MAC           6    /*上报MAC地址更新*/
...
*
*******************************************************************************/
ULONG LLDP_RemTableOpen(ULONG *pulHandle, LLDP_REM_FILTER_S *pstFilter);
...
*
*******************************************************************************/
ULONG LLDP_RemTableGet(ULONG ulHandle, LLDP_REM_INFO_S * pstRemInfo);
...
*
*******************************************************************************/
ULONG LLDP_RemTableClose(ULONG ulHandle);
