...
DECLARE_INTERFACE (IIF_COMP_POES_ComIntFUN)
{
    ...
    METHOD_(ULONG, pfPOES_OpenList)(ULONG *pulPOESWaitListHandle);
    METHOD_(ULONG, pfPOES_GetPoesCB)(ULONG ulPOESWaitListHandle, POES_CB_S *pstPoesCb);
    METHOD_(ULONG, pfPOES_CloseList)(ULONG ulPOESWaitListHandle);
