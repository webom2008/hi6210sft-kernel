...
ULONG POES_EtherIoCtl(ULONG ulHandle, ULONG ulCmd, CHAR *pcPara);
ULONG POES_PppIoCtl(ULONG ulHandle, ULONG ulCmd, CHAR *pcPara);
ULONG POES_VTIsBinded(IFNET_S *pstIf, ULONG *pulEthIfIndex);
ULONG POES_OpenList(ULONG *pulPOESWaitListHandle);
ULONG POES_GetPoesCB(ULONG ulPOESWaitListHandle, POES_CB_S *pstPoesCb);
ULONG POES_CloseList(ULONG ulPOESWaitListHandle);
...
extern ULONG POES_SessionOutput (IFNET_S *pstIfEth,ULONG ulSesPointer,MBUF_S *pstMbuf);
