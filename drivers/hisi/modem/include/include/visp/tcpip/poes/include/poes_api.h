...
typedef struct tagPoesSessionInfo
{
    ...
    UCHAR  aucLocalMac[POES_MAC_LEN];   /* 本端MAC地址 */
    UCHAR  aucRemoteMac[POES_MAC_LEN];  /* 远端MAC地址 */
} POES_SESSION_INFO_S;
