...
/*add by y36299 for IPOS D00036 2005/12/08*/
...
/* Added by t45114 for MC, 2006/02/20 */
...
/*add by y36299 for SWFD09334 2005/05/31*/
...
enum enumPPP_EVENT_ShellToCore
{
    ...
    PPPISDOWNALL,  /*Added by x36317 for OSP,2004-11-10*/
    /* Added by z43740 for PPPMUX, 2006/05/08 */
...
enum enumPPP_EVENT_CoreToShell
{
    ...
    /* Added by z43740 for PPPMUX,2006/05/09 */
    ,PPP_MUXCP_UP,
    PPP_MUXCP_DOWN
    /* End of addition */
};
...
/* added by z43740 for PPPMUX,2006/05/8 */
...
#define PPP_SECP                0x8053          /* 单链路ppp加密控制协议 ppp encrypt control protocol on single link */
#define PPP_SEP                 0x0053          /* 单链路ppp加密协议 PPP encrypt protocol on single link */
#define PPP_MECP                0x8055          /* 多链路ppp加密控制协议 PPP encrypt control protocol on multilink */
#define PPP_MEP                 0x0055          /* 多链路ppp加密协议 PPP encrypt protocol on multilink */
...
/* Modified by z43740 for MC 2006/05/08 */
...
/*add by y36299 for visp3 2005/10/12*/
...
/*Add by z62474 for BC3D00622 2008-11-09*/
...
/* Added by z43740 for MC, 2006/05/08 */
/* 分配前缀省略映射表并进行内容拷贝 */
...
{\
    ...
    {\
        ...
        {\
            (VOID)VOS_Mem_Zero((CHAR *)pstDestInfo->pstPrefixE, sizeof(MC_PREFIXE_S)*MC_PREFIXE_MAX_NUM);\
        }\
    }\
}
...
/*add by y36299 for SWFD05286 2005/06/22*/
    ...
    {\
        ...
        { \
            ...
            { \
                ...
                {\
                    /*add by y36299 for debug 2004/07/27*/\
                    CHAR szBuf[LEN_192];\
                    (VOID)VOS_nsprintf(szBuf, LEN_192, "the times of nak is %d\r\n", pstFsm->usNakloops);\
...
/*add by y36299 for verbose debugging 2004/11/17*/
...
#define PPP_DEBUG_ALL         4   /*Added by Z34981 for D23718, 2003/06/09*/
#define PPP_DEBUG_ACTION      5

#define PPP_DEBUG_VERBOSE     6   /* Add by y62007 print verbose info 2007/7/26*/
...
#define PPP_DEF_GLOBALTIME 1000    /* Modified by x36317 for SWFD08651, 2005-5-9 */
...
/* Added by z43740 for PPPMUX,2006/05/11*/
...
/*Add by z62474 2008-1-11 for A82d22606 */
/********************* PPP模块相关SID相关宏(BEGIN)**********************/
...
/* Add by z62474 for BC3D00622 2008-11-18 */
