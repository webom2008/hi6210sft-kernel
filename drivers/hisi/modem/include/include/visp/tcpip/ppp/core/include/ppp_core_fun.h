...
/* Added by z43740 for A82D02470, 2006/06/24 */
...
/* Added by z43740 for PPP HeaderCompression,2006/05/09*/
...
ULONG PPP_GetInterfaceNego(ULONG ulIfIndex, ULONG* pulNegoLCP,ULONG* pulNegoNCP); /*added by x44006 2005-09-20 */
...
CHAR *PPP_Debug_GetValueStr(UCHAR * , ULONG );
...
CHAR *PPP_Debug_GetString(UCHAR *, ULONG );
...
/*modify by y36299 for IPOS D00036 2005/12/08*/
...
/* Added by z43740 for MC, 2006/05/09 */
...
/*add by y36299 for pc-lint warning*/
extern ULONG TCPIP_ADP_NotifyPppDns(ULONG ulIfIndex, ULONG ulSetYes,ULONG ulPriDns, ULONG ulSecDns);

/**************************外部函数**********************************/

/*Added by x36317, 2005-9-26*/
ULONG PPP_SetDebugSwitch_PT(ULONG ulPppDebugFlag);
ULONG PPP_OpenPPPEntry(ULONG *pulWaitListHandle);
ULONG PPP_GetPPPEntry (ULONG ulEntryWaitList, PPPINFO_S *pstPppInfo);
ULONG PPP_ClosePPPEntry ( ULONG ulWaitListHandle );
ULONG PPP_OpenPPPEntry_PT(ULONG *pulWaitListHandle);
ULONG PPP_GetPPPEntry_PT (ULONG ulEntryWaitList, PPPINFO_S *pstPppInfo);
...
/* Added by z43740 for PPP HeaderCompression, 2006/05/12*/
