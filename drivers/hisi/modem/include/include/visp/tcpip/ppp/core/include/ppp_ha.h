...
/*Begin: add by z62474 for HA 2008-02-28*/
...
/*Add by z62474 for A82D24592 2008-03-25*/
...
/*End: add by z62474 for HA 2008-02-28*/

/*为了处理简单，重新定义一个结构*/
typedef struct tagPppConfigInfoBak
{
    /*Modify this struct by z62474 for A82D22005 2007-12-18*/
...
typedef struct tagPppChapInfoBak 
{
    ...
    UCHAR szHostPwd[PPP_MAXUSERPWDLEN + 2];   /* 口令 */
} PPPCHAPINFO_BAK_S ;
...
typedef struct tagPppPapInfoBakOld
{
    ...
    UCHAR ucAuthClient ;               /* 本端作为被认证端 */ 
    UCHAR szPapUsrName[PPP_MAXUSERNAMELEN + 2];  /* 用户名  */ 
    UCHAR szPapUsrPwd[PPP_MAXUSERPWDLENOLD + 2];    /* 用户口令 */ 
...
typedef struct tagPppChapInfoBakOld 
{
    ...
    UCHAR ucAuthClient ;         /* 本端作为被认证端 */
    UCHAR szHostName[PPP_MAXUSERNAMELEN + 2]; /* 主机名 */
    UCHAR szHostPwd[PPP_MAXUSERPWDLENOLD + 2];   /* 口令 */
