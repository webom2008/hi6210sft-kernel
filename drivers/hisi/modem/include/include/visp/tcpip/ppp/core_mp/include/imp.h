...
DECLARE_INTERFACE (IIF_MP_ComIntFUN)
{
    ...
    /* Modified by z43740 for PPP HeaderCompression, 2006/05/29 */
    ...
    METHOD_(ULONG, pfMP_OpenUserInfoObject)(ULONG *pulWaitListHandle);
    METHOD_(ULONG, pfMP_CloseObject)(ULONG ulWaitListHandle);
    METHOD_(ULONG, pfMP_GetUserInfo)(ULONG ulHandle,\
    ...
    METHOD_(ULONG, pfMP_OpenMpGroupList)( ULONG *pulWaitlistHandle);
    METHOD_(ULONG, pfMP_GetMpGroup)( ULONG ulWaitlistHandle, MPGROUP_LIST_INFO_S**ppstMpGroupListInfo);
    METHOD_(ULONG, pfMP_CloseMpGroupList)( ULONG ulWaitlistHandle);
...
DECLARE_INTERFACE (IIF_MP_ComIntCFG)
{
    ...
    /* Modified for MP User Interface by l48923 2006-05-12 */
