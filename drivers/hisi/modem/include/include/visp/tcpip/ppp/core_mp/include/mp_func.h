...
ULONG MP_GroupPhyIOCtl(ULONG ulPhyLink, ULONG ulCmdIndex, char *pData);
...
/* Added by z43740 for MC, 2006/05/11*/
...
/* mp_cfg.c */
/* Modified for Adjusting of MP User Interface by l48923 2006-05-12 */
...
/* Added by z43740 for MC, 2006/05/10 */
...
ULONG  MP_OpenUserInfoObject(ULONG *pulWaitListHandle);
ULONG  MP_GetUserInfo(ULONG ulHandle, 
                        CHAR szUserName[MP_USERNAME_LEN + 2], ULONG *pulVTNo);
ULONG  MP_CloseObject(ULONG ulWaitListHandle);
...
ULONG MP_OpenMpGroupList(ULONG *pulWaitlistHandle);
ULONG MP_GetMpGroup(ULONG ulWaitlistHandle, MPGROUP_LIST_INFO_S**ppstMpGroupListInfo);
ULONG MP_CloseMpGroupList(ULONG ulWaitlistHandle);
...
extern VOID IF_LogicPhy_GetInfo(COMMON_PHY_MSG * msg, CHAR *Info);
...
extern ULONG TCPIP_MPQOS_TransmitDone(ULONG ulIfIndex, ULONG ulPointerToDcb, MBUF_S * pstMBuf);
