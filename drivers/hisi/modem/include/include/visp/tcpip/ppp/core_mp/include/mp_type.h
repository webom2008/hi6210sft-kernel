...
/* MP父通道控制块结构 */
/* Modified by z43740 for MC,2006/05/10*/
 ...
 typedef struct tagMP_ModInfo
{
    ...
    ULONG ulQUE_PPPMUX_INPUT; /* Added by z43740 for PPPMUX, 2006/05/11 */
...
typedef struct tagMP_SHELL_CALLBACK
{
    ...
    ULONG(*pfMPQOS_QM_TransmitDone)(ULONG ulIfIndex, ULONG ulPointerToDcb, MBUF_S *pstMBuf);
    ULONG(*pfQOS_QM_TransmitDone)(ULONG ulIfIndex, ULONG ulPointerToDcb, MBUF_S *pstMBuf);
