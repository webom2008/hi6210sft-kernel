...
VOID  PPPMUX_Schedule(ULONG ulArg0, ULONG ulArg1,ULONG ulArg2,ULONG ulArg3);
...
ULONG PPPMUX_OpenPPPEntry(ULONG *pulWaitListHandle);
ULONG PPPMUX_GetPPPEntry(ULONG ulEntryWaitList, PPPINFO_S** pstPppInfo);
ULONG PPPMUX_ClosePPPEntry(ULONG ulWaitListHandle);
