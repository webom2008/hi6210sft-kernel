...
DECLARE_INTERFACE ( IIF_PPPOE_CLIENT_ComIntFUN ) 
{
    ...
    METHOD_( ULONG, pfPPPOE_Client_PppIoctl ) ( ULONG ulLinkHandle, ULONG ulCmd, char *pcPara);
    ...
    METHOD_( ULONG, pfPPPOE_Client_GetPoecSession ) ( ULONG ulBundleNumber );
    ...
    METHOD_(VOID, pfPOEC_GR_DealMsg)(ULONG aulMsg[4]);
};
