...
ULONG  PPPOE_Client_PppIoctl ( ULONG ulLinkHandle, ULONG ulCmd, char *pcPara);
...
ULONG PPPOE_Client_GetPoecSession ( ULONG ulBundleNumber );
...
VOID POEC_GR_DealMsg(ULONG aulMsg[4]);
