...
*
*******************************************************************************/
VOID PTP_TaskMain(ULONG ul1, ULONG ul2, ULONG ul3, ULONG ul4);
...
*  DATE         NAME                    DESCRIPTION
*  ----------------------------------------------------------------------------
*  2011-12-15   z00187023/wKF61331/j00169178   Create
*
*******************************************************************************/
VOID PTP_FreeAllAddrVrfNodes(USHORT usPortNum);

/*******************************************************************************
*    Func Name: PTP_FreeAllVrfSockNodes
* Date Created: 2011-12-15
*       Author: z00187023/wKF61331/j00169178 
*  Description: 
*        Input: 
