...
/* PTP多播目的主IP地址，主机序:224.0.1.129,All except peer delay mechanism messages */
#define PTP_PRIMARY_MULTICAST_IP        0xE0000181L

/* PTP-Pdelay多播目的IP地址，主机序，该地址现在不用:224.0.0.107,Peer delay mechanism messages */
...
typedef enum tagPTP_ERR_E
{
    ...
    PTP_ERR_IP_NOT_EXIST,              /* 54.源IP地址不在本机 */
    PTP_ERR_CLRSOCKETMULTICAST,        /* 55.清除多播选项 */
    PTP_ERR_GET_PORTADDR,              /* 56.获取IP地址非法 */
    ...
    PTP_ERR_MAC_NOT_CFG,                /* 107 Mac地址没有配置 */
    PTP_ERR_INTF_NOT_EXIST,             /* 108 适合Mac地址的接口不存在 */
...
typedef struct tagPTP_PORT_ADDR_S
{
    ...
    {
        ULONG   ulIpv4;        /* 主机字节序 */
        UCHAR   ucMacAddr[8];  /*MAC地址 8字节为了对齐*/
...
/* End of Added by z00208058, 2012/8/31 */
...
*Description : 查询某一IP地址是否在UnicastSalveTable中
...
*Description : 查询某一IP地址是否在AcceptMasterTable中
*Input       : *pstPortAddr: 查询的IP地址
...
*       Author: z00187023/wKF61331/j00169178 
*  Description: 查询某一地址是否在UnicastMasterTable中
*        Input: PTP_PORT_ADDR_S *pstPortAddr:  查询的IP地址
*               CHAR *pcVrfName: vrf名称
*       Output: 
...
/*******************************************************************************
*    Func Name: PTP_SetMasterWeightWithVrf
* Date Created: 2011-12-10
*       Author: z00187023/wKF61331/j00169178 
*  Description: Set the weigth(in new profile is priority) of the UnicastMaster
*        Input: PTP_PORT_ADDR_S *pstMaster: UnicastMaster
*               CHAR *pcVrfName: UnicastMaster's vrf name
*               ULONG ulWeight: new profile's priority,the lesser value has high priority,no range
*       Output: NA
*       Return: success: PTP_OK,
*               failure:respective error code
...
/*******************************************************************************
*    Func Name: PTP_GetMasterWeightWithVrf
* Date Created: 2011-12-10
*       Author: z00187023/wKF61331/j00169178 
*  Description: Get the weigth(in new profile is priority) of the UnicastMaster
*        Input: PTP_PORT_ADDR_S *pstMaster:  UnicastMaster
*               CHAR *pcVrfName: UnicastMaster's vrf name
*       Output: 
*               ULONG *pulWeight: to get new profile's priority
*       Return: success: PTP_OK,
*               failure:respective error code
*      Caution: 
*------------------------------------------------------------------------------
...
/*******************************************************************************
*    Func Name: PTP_SetPTSFByTypeWithVrf
* Date Created: 2011-12-10
*       Author: z00187023/wKF61331/j00169178 
*  Description: Set the PTSF value of Unicast Master for different types
*        Input: PTP_PORT_ADDR_S *pstMaster: Master's Address
*               CHAR *pcVrfName: Master's vrf name
*               ULONG ulType: (Sync/Unusable)
*               ULONG ulPTSFValue:  0       - none PTSF
*                                   non zero- PTSF happened
*       Output: NA
...
/*******************************************************************************
*    Func Name: PTP_GetPTSFByTypeWithVrf
* Date Created: 2011-12-10
*       Author: z00187023/wKF61331/j00169178 
*  Description: Set the PTSF value of Unicast Master for different types
*        Input: PTP_PORT_ADDR_S *pstMaster: Master's Address
...
*               ULONG ulType:(Sync/Unusable/Announce)
*       Output: 
*               ULONG *pulPTSFValue: to get PTSFValue
*       Return: success: PTP_OK,
*               failure:respective error code
*      Caution: 
*------------------------------------------------------------------------------
