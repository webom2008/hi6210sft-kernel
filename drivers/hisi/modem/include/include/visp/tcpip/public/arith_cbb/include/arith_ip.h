...
*  Description: 作为IP地址合法性判断的公共函数
*               非法地址有: 全网广播、0.X.X.X 、D类E类IP地址
...
/*******************************************************************************
*    Func Name: InetAddr
*  Description:将点分十进制形式的IP地址转换为网络字节序的二进制形式 
*        Input: CHAR *pIpChar:点分十进制IP地址字符串
*       Output: 
*       Return: 成功:转换之后的IP地址 失败:返回错误码
*      Caution: 
*------------------------------------------------------------------------------
*  Modification History
*  DATE         NAME                    DESCRIPTION
