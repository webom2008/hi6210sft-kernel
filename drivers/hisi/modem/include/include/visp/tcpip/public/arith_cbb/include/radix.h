...
/* Radix Tree Internal node structure for IP Address/mask search. */
...
/* Radix Tree External node structure for IP Address/Mask search. */
...
/* Prototypes of the API'S provided by Radix tree for IP Address/Mask search */
/*TCIP.SafeModify.Delete #if 0, Modify by guojianjun178934, 2014/5/21*/
/****************************************************************************
*    Func Name: VOS_RDX_AddNode()
*  Description: Add a radix tree external node containing IP address and mask as well
...
*  Description: Gets the parent for the given IP Address/Mask. 
...
*  Description: Get the children of the network specified by the ip address. The
...
*  Description: Gets the list of all the parents for a given Ip address.The output
