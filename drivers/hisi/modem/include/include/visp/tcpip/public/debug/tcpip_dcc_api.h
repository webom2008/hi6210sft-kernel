...
{
    ULONG   ulSipAddr;                               /* 源IP地址,主机序 */
    ULONG   ulDipAddr;                               /* 目的IP地址,主机序 */
    USHORT  usSport;                                 /* 源端口号 */
...
typedef enum enumDccErrCode
{
    ...
    DCC_ERR_SIP,                    /* 9,源IP地址不合法 */
    DCC_ERR_DIP,                    /* 10,目的IP地址不合法 */
    DCC_ERR_DIPISLOC,               /* 11,目的IP地址不能是本机IP地址 */
    DCC_ERR_SIPNOTLOC,              /* 12,源IP地址不是本机IP地址 */
