...
#define PCAP_MACADDRLEN                  6 /* MAC地址长度 */

/*Added by wangchengyang62830 for VISPV1R8C01-252, 2009/6/23 */
#define PCAP_DIRECTION_IN                2 /* 支持报文接收方向上抓包 */
#define PCAP_DIRECTION_OUT               1 /* 支持报文发送方向上抓包 */
#define PCAP_DIRECTION_ALL               0 /* 支持报文接收和发送方向上抓包 */
...
* Date Created: 2009-04-08
*       Author: wuhailan103194
*  Description: 分层抓包功能接口设置及过滤规则设置接口
