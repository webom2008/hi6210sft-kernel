...
/*******************************************************************************
*    Func Name: SLL_Insert_In_Middle
*  Description: Inserts the Node 'pMid' in between 'pPrev' and 'pNext' and updates the node    
*        Input: SLL_S *pList:      Pointer to the Singly Linked List
*               SLL_NODE_S *pPrev: Pointer to previous Node
*               SLL_NODE_S *pMid:  Pointer to Node which needs to be added
*               SLL_NODE_S *pNext: Pointer to the Next Node
*       Output: None
*       Return: VOID
*      Caution: 
*------------------------------------------------------------------------------
...
/*******************************************************************************
*    Func Name: SLL_Delete
*  Description: Deletes the 'pNode' from the singly linked list 'pList'    
*        Input: SLL_S *pList:      Pointer to the Singly Linked List
*               SLL_NODE_S *pNode: Pointer to Node which needs to be deleted from the list
*       Output: None
*       Return: VOID
*      Caution: 
*------------------------------------------------------------------------------
