...
#define TASK_MONITOR_KEEPLIVE_TIME  5000  /*MBSC 定制需求: 线程监控 心跳周期 5秒*/
#define TASK_NONITOR_MAX_LOST_TIME  6     /*线程监控 最多丢失次数*/
#define TASK_MONITOR_TASK_MAX_NUM   5    /*定义需要监控的任务个数*/
...
typedef ULONG (*ACL_CLASSIFYBYIPINFO_HOOK_FUNC)(MBUF_S *pstMBUF, ULONG ulGroupNum, ULONG * pulRuleIndex, BOOL_T* pbLog);

typedef ULONG (*ACL_CLASSIFYBYIFINFO_HOOK_FUNC)(MBUF_S *pstMBUF, ULONG ulIfType, ULONG ulGroupNum, ULONG * pulRuleIndex, BOOL_T* pbLog);
typedef ULONG (* ACL_CLASSIFYBYLINKINFO_HOOK_FUNC)(MBUF_S *pstMBUF, ULONG ulGroupNum,
...
ULONG TCPIP_LinkCtlMsgCount(ULONG aulMsg[4]);
