...
*       Return: 成功: TCPIP_SFE_ICMP_OK
*               失败: 错误码
*      Caution: 目前数据面接口没有维护IP地址,在发送报文的时候,
...
*
*******************************************************************************/
extern VOID TCPIP_SFE_ShowAllStatistic(VOID);
...
*
*******************************************************************************/
extern VOID TCPIP_SFE_ShowAutoStatistic(VOID);
...
*
*******************************************************************************/
extern VOID TCPIP_SFE_ShowManualStatistic(VOID);
...
* Date Created: 2009-11-2
*       Author: w60786
*  Description: 数据面维测信息串口输出开关,该接口不是对外API接口,只是用于维测调试
...
extern VOID TCPIP_SFE_ShowOneArpInfo(UINT32 u32VrfIndex, INT8 *pu8IpAddr);
...
extern VOID TCPIP_SFE_ShowFibInfoByIP(UINT32 u32VrfIndex, INT8 *pi8IpAddr);
