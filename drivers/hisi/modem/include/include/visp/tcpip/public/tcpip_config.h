...
#define DOPRA_VISP_VERSION "DOPRA IP V300R002C10SPC030B020"
...
/* B022 -> B023 (5 -> 6) SPC020B001版本新增mac地址备份 */
...
/* Added by likaikun00213099 for SafeModify at 20140529 */
...
#if (TCPIP_VOS_FUNC_TYPE == VOS_FUNC_TYPE_SAFE)     /*安全预编译*/
   #include "vos_safedef.h"
#elif (TCPIP_VOS_FUNC_TYPE == VOS_FUNC_TYPE_BALONG) /*balong 预编译*/
   #include "vos_redef.h"
#else
   #include "vos_olddef.h"                          /*旧的vos定义方式*/
#endif
/* Added by likaikun00213099 for SafeModify at 20140529 */
...
#define TCPIP_MODULE_SFIB6_RM   VRP_YES /* Added by z36377, 20041008 */
#define VRP_MODULE_FIB6CONTR    VRP_YES /* Added by z36377, 20041009 */
...
#define VRP_MODULE_LINK_PPP_CBCP    VRP_NO  /*modified by x36308 2005-9-24*/
#define VRP_MODULE_LINK_PPP_DNS     VRP_YES /*add by y36299 for D00606  2004/08/31*/
#define VRP_MODULE_LINK_PPP_MPLSCP  VRP_NO  /*Added by z43740 for SWID00102,2006/01/04*/

/*Added by z36377 for VISP3,20050906*/
...
#define VRP_MODULE_IP_ARP_PROXY   VRP_YES  /*add by y36299 2004/09/30*/
#define VRP_MODULE_VJCOMP         VRP_YES  /*add by y36299 for vjcomp  2004/11/17*/


#define TCPIP_MODULE_FIBA         VRP_YES
#define VRP_MODULE_DNS_CLIENT     VRP_YES  /*Added by x36317 for D01056 2004-9-16*/
...
#define VRP_MODULE_SEC_ACLACC     VRP_NO   /*added by x36308 2005-9-24*/
