...
*/
/*TCIP.SafeModify.Delete #if 0, Modify by guojianjun178934, 2014/5/21*/
...
**********************************************************/
/*added by x36317 for D00518 2004-9-23*/
...
typedef enum TCPIP_PRECONFIG_INFO_Etag
{
    ...
    /*接收报文时是否先与本机IP地址比较的开关。打开则在接收报文先与本机IP地址链比较，
    ...
    /*接口MAC地址的设置方式，0-发送免费ARP,1-直接设置(主备一致，倒换后生效),2-主备一致，备份后立即生效 */
   ...
   默认值:0   */
    ...
    DCL_DIAG_MOMORY_TRACE,           /* 70 是否使能DCL提供的内存跟踪功能，默认不使能。
    ...
    ETH_ARPMISS_NOTNET_TIMEOUT,      /* 86 用户上报ARP MISS,如果IP地址和接口不是同一网段哑元老化时间, 0~300s,默认是0,即等待超时定时器 */
    ...
    /* 为支持RPU特殊应用场景增加该预配置 */
    ETHARP_FREEARP_REPLY_UNICAST,            /* 98, 是否对IP地址冲突的免费ARP采用单播应答，缺省为0(广播)，1(单播) */
    ...
    TCPIP_TRACE_ROUTE_USE_DIP_FOR_SIP, /* 110 0:ICMP响应的源IP地址是入接口最匹配的IP地址，1:ICMP响应的源IP地址是接收到的报文的目的IP*/
    ...
    /* End of Added by z00208058/w00207740, 2012-4-16 */
    /*Added by z00208058/w00207740, BFD会话规格扩展, 2012/5/8 */
    BFD_MAX_SESSION_NUM,            /*112  BFD会话规格扩展1000~5120*/
    /* End of Added by z00208058/w00207740, 2012/5/8 */
    ...
    SKT_TASK_SOCK_LINUX_STACKSIZE, /* 122 linux??è???????′óD??￡è??μ·??§8K~16M￡???è??μ?a8M*//* Add By for LinuxStatckSize l00103192*/    
    ...
    /* End of Added by w00207740, 2013/8/2 */
    /* Added by w00132333, mem optimize  2013/9/2 */
    ...
    /* End of Added by w00132333, 2013/9/2 */
    ...
    /* End of Added by w00207740, 2014/1/9 */
    /*Added by fengjing209023, TCP4 cookie开关 2014/1/21 */
    ...
    IPV4_ADDR_SUPPORT_SAME_SUBNET, /* 152 IPV4地址支持不同接口同网段IP地址配置(0 不支持 1 支持，默认不支持)
