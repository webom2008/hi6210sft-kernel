...
#define TCPIP_Mem_Copy(pDstPtr, dst_size, pSrcPtr, copy_size)   RTOSCK_Mem_Copy(pDstPtr, pSrcPtr, copy_size)
#define TCPIP_Mem_Set(pDstPtr, uChar, ulSetLen )                RTOSCK_Mem_Set(pDstPtr, uChar, ulSetLen )
#define TCPIP_strncpy(pDstPtr, dst_size, pSrcPtr, copy_size)    RTOSCK_strncpy(pDstPtr, pSrcPtr, copy_size)
#define TCPIP_StrNCat(pDstPtr, dst_size, pSrcPtr, copy_size)    RTOSCK_StrNCat(pDstPtr, pSrcPtr, copy_size)
#define TCPIP_nsprintf                                          RTOSCK_nsprintf
#define TCPIP_nvsprintf                                         RTOSCK_nvsprintf
