...
{\
    (pstRtMsg)->usZoneID = (pstRoute6)->usZoneID; \
    FIB6_ADDRESS_COPY( (pstRtMsg)->aulDestination, (pstRoute6)->aulDestination); \
    FIB6_ADDRESS_COPY(  (pstRtMsg)->aulLocalAddress, (pstRoute6)->aulLocalAddress); \
    FIB6_ADDRESS_COPY(  (pstRtMsg)->aulNexthop, (pstRoute6)->aulNexthop); \
    FIB6_ADDRESS_COPY(  (pstRtMsg)->aulNexthop_Relay, (pstRoute6)->aulNexthop); \
    (pstRtMsg)->ucDestPrefixLength = (pstRoute6)->ucDestPrefixLength; \
    (pstRtMsg)->ucLocalPrefixLength = (pstRoute6)->ucLocalPrefixLength; \
    (pstRtMsg)->ulFlags = (pstRoute6)->ulFlags; \
    (pstRtMsg)->ulIfIndex = (pstRoute6)->ulIfIndex; \
    (pstRtMsg)->ulATIndex= (pstRoute6)->ulATIndex; \
    (pstRtMsg)->ulSlot = (pstRoute6)->ulSlot; \
    /* Guru: Added for 6PE implementation 26th Mar'04 */\
