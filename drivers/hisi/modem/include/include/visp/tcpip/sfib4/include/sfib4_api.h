...
#define FIB_ERR_VRF_NAMELONG       (VOS_ERR + 47)    /*VRF名字长度大于31*/
...
/*Added by zhangchunyu(Z62474) for VISP Support Multi-Instance at 2008/4/28*/
/* 该数据结构只能PTN特殊场景使用 */
typedef ULONG (*TCPIP_SEARCH_VPN_FIB_FUN)(ROUTE4_S* pstRoute);
/*End of Added by zhangchunyu(Z62474) at 2008/4/28*/
...
*        Input: ULONG ulDstIpAddr:目的IP地址
...
*  Description: 根据目的IP地址查找出接口索引
*        Input: ULONG ulDIP:  32位网络字节序的IP地址值
...
*  Description: 添加静态路由
*        Input: ULONG ulIpAddress:目的IP地址(主机序)
...
*  Description: 删除静态路由
*        Input: ULONG ulIpAddress:目的IP地址
*               ULONG ulMaskLen:掩码长度
