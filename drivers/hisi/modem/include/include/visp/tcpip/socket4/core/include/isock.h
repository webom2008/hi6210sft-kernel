...
DECLARE_INTERFACE( IIF_IP4_SOCK_ComIntFun)
{
    ...
    METHOD_ (VOID ,pfSB_Append)(SOCKET_S *pSocket, LONG iKind, struct tagMBuf *pstMTail); /*Modified by x36317 for SWFD10618, 2005-6-22*/
    METHOD_ (VOID ,pfSB_Flush)(SOCKET_S *pSocket, LONG iKind);  /*Modified by x36317 for SWFD10618, 2005-6-22*/
    ...
    METHOD_(ULONG, pfHC_OpenEntry)(ULONG ulTaskId, LONG iFd, ULONG *pulWaitListHandle);
    METHOD_(ULONG, pfHC_GetEntry)(ULONG ulEntryWaitList, struct tag_HeadCache *pstEntry);
    METHOD_(VOID, pfHC_CloseObject)( ULONG ulWaitListHandle );
    /*设置head cache的功能开关*/
    ...
    /*Added by x43050 for A82D01932, 2006-6-3*/
...
#define IP4_SOCK_EXT_COMIF_CNT 11
