...
/*add by y36299 for SWFD10728 2005/06/22*/
#ifndef _UTLDLL_H_
...
/* modified by l57500. add 3 IN6ADDR_S fields for support ipv6.
   and add 2 statistic fields for statistics normal send flow times and hc send flow times. 2006/12/11 */
typedef struct tag_HeadCache
{
    ...
    IN6ADDR_S  stSrcIP6;              /* IPv6 源IP地址   */
    IN6ADDR_S  stDstIP6;              /* IPv6 目的IP地址 */
    ULONG      ulIpPro;               /* 协议号*/
...
typedef struct tagIP_SOCK_SH_CALLBACUP_SET_S
{
    ...
    ULONG (*pfVOS_Que_Write)(ULONG ulQueID,ULONG *ulMsg,ULONG ulFlag, ULONG ulTimeOutInmillsec);
    ULONG (*pfVOS_Que_Read)(ULONG ulQueID,ULONG *ulRetMsg,ULONG ulFlag, ULONG ulTimeOutInmillsec);
