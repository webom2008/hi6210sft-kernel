...
VOID SB_Append(SOCKET_S *pSocket, LONG iKind, MBUF_S *pstMTail);  /*Modified by x36317 for SWFD10618, 2005-6-22*/
VOID SBFlush(SOCKBUF_S *pSb);
VOID SB_Flush(SOCKET_S *pSocket, LONG iKind); /*Modified by x36317 for SWFD10618, 2005-6-22*/
...
ULONG HeadCache_OpenEntry (ULONG ulTaskId, LONG iFd, ULONG *pulWaitListHandle);
ULONG HeadCache_GetEntry(ULONG ulEntryWaitList, HEADCACHE_ENTRY_S *pstEntry);
VOID  HeadCache_CloseObject ( ULONG ulWaitListHandle );
