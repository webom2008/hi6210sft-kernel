...
extern LONG HeadCache_SendData(SOCKET_S *pSocket,  const UIO_S *pUio, ULONG *pulEntryAddr);
extern LONG HeadCache6_SendData(SOCKET_S *pSocket,  UIO_S *pUio, ULONG *pulEntryAddr);
