...
/* Modify by w60786 for A82D23080 2008-02-25 */
...
#define FD_SETSIZE      128*1024 /*Modified by x36317, 2005-1-5*/
#else
...
{
    in_addr imr_mcastaddr;  /*  IP multicast address of group  */
    in_addr imr_msrcaddr;   /*  IP address of source for group */
    ULONG   imr_ifindex;    /*  local IP address of interface   */
}ip_mreq_source;
...
{
    struct sockaddr_in *pstLaddr; /* 32-bit Local IP address + local port*/
    struct sockaddr_in *pstFaddr; /* 32-bit Remote IP address + Remote port*/
...
#define    send(a,b,c,d) vrp_send(a,b,c,d)  /*Modified by x36317 for SWFD08837, 2005-5-24*/
#endif
