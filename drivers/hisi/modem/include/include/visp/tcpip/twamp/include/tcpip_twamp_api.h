...
*
* @param[in] ulTWAMPTaskPri Indicates the TWAMP task Priority.[NA]
* @param[out] NA NA [NA]
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned [NA]
*
* @type API Type
* Synchronous.
*
...
*
* @param[in] pstReflConfig Contains the Reflector Global configuration.[NA]
* @param[out] NA NA [NA]
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned  [NA]
...
*
* @param[in]  [NA]
* @param[out] pstReflConfig Contains the Reflector global configuration [NA]
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned  [NA]
*
...
*
* @param[in] ulResponderId Contains the Responder Id[NA]
* @param[in] pstReflConf Contains the Reflector Configuration[NA]
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned  [NA]
*
...
*
* @param[in] uResponderId Responder Id to identify the particular reflector[NA]
* @param[out] [NA]
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned  [NA]
...
*
* @param[in] uResponderId Responder Id to identify the particular reflector[NA]
* @param[out] pulWaitListHandle  Waitlist handle[NA]
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned  [NA]
*
...
*
* @param[in] uResponderId Responder Id to identify the particular reflector[NA]
* @param[in] ulEntryWaitList Waitlist handleI[NA]
* @param[out] pstTestSessionInfo Test SessionInfo[NA]
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned  [NA]
*
...
*
* @param[in] ulWaitListHandle Waitlist handle[NA]
* @param[out] [NA]
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned [NA]
...
*
* @param[in] uResponderId Responder Id to identify the particular reflector[NA]
* @param[out] pstStats Reflector stats[NA]
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned [NA]
*
...
*
* @param[in] ulClientId Client Id [NA]
* @param[in] pstCtrlConf Configuration to be used for the connection to the reflector[NA]
* @param[out] [NA]
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned [NA]
...
*
* @param[in] uClientId Client Id [NA]
* @param[out] [NA]
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned [NA]
...
*
* @param[in] uClientId Client Id [NA]
* @param[out] pstCtrlSessInfo Contains the session information [NA]
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned [NA]
*
...
*
* @param[in] uClientId Client Id [NA]
* @param[in] ulSenderId Contains the Sender Id[NA]
* @param[in] pstSenderConf Sender Configuration[NA]
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned [NA]
*
...
*
* @param[in] uClientId Client Id [NA]
* @param[in] uSenderId Sender Id[NA]
* @param[out][NA]
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned [NA]
...
* @param[in] uClientId Client Id [NA]
* @param[in] uSenderId Sender Id[NA]
* @param[out]pstTestSessionInfo Session Info [NA]
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned [NA]
*
...
*
* @param[in] pfnRefltHook Hook details Id[NA]
* @param[out][NA]
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned [NA]
...
*
* @param[in] pfnCtrlHook Client Hook function Id[NA]
* @param[out][NA]
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned [NA]
...
*
* @param[in] pfnSessHook test session Hook function Id[NA]
* @param[out][NA]
*
* @type API Type
* Synchronous.
...
*
* @param[in] TCPIP_TWAMP_PPI_HOOK_S *pstHookFunc [NA]
*
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned [NA]
...
*
* @param[in] ulResponderId Contains the Responder Id[NA]
* @param[OUT] pstReflConf Contains the Reflector Configuration[NA]
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned  [NA]
*
...
* Retrieves the Reflector Configuration for the Corresponding Responder ID.
*
* @param[in] ulClientId Contains client Id of the main control connection[NA]
* @param[in]SenderId sender Id for test session for which the session should be renegotiated[NA]
* @param[in]ulEvent Event given by the user based on which the functionality will take place[NA
...
* VOS_T_Create
*
* @param[in] pstHookFunc Hook functions[NA]
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned  [NA]
*
...
* @par Prototype
* @code
* ULONG TCPIP_TWAMP_OpenCtrlSessTable(ULONG ulResponderId, ULONG *pulWaitListHandle)
* @endcode
*
* @par Description
...
*/
extern ULONG TCPIP_TWAMP_OpenCtrlSessTable(ULONG ulResponderId, ULONG *pulWaitListHandle);
...
* @param[in] uResponderId Responder Id to identify the particular reflector[NA]
* @param[in] ulEntryWaitList Waitlist handleI[NA]
* @param[out] pstCtrlSessionInfo Control SessionInfo[NA]
*
* @retval ULONG On Success [TWAMP_OK|NA]
* @retval ULONG On Failure  non Zero value will be returned  [NA]
*
...
*
*/
extern ULONG TCPIP_TWAMP_GetCtrlSessInfo(ULONG ulResponderId, ULONG ulEntryWaitList,
                       TCPIP_TWAMP_REFL_SESS_S *pstCtrlSessionInfo);
...
*
*/
extern ULONG TCPIP_TWAMP_CloseCtrlSessTable(ULONG ulWaitListHandle);
