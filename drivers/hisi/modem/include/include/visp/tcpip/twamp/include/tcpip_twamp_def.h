...
#define TWAMP_ENCRYPT_MODE      0x0004  /* TWAMP Encryption mode.    */
...
typedef struct tagTcpipTwampReflSessInfo
{
    ...
    ULONG ulSrcIp;          /* Server IP address */
    ULONG ulDestIp;         /* Client IP address */
...
typedef enum enumTwampErrorCode
{
    ...
    TWAMP_ERR_REFLECTOR_DUPLICATE_IPADDR,                              /*0x0E440020 - Ip address is already existing*/
    ...
    TWAMP_ERR_INVALID_REFLECTOR_IP,                                    /*0x0E440051 - Invalid reflector IP Address*/
