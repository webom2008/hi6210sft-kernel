...
extern ULONG EHTVLAN_HA_OpenWaitList(ULONG *pulWaitListHandle);
extern ULONG EHTVLAN_HA_CloseWtLstObject(ULONG ulWaitListHandle);
extern ULONG EHTVLAN_HA_GetWtLstEntry(ULONG ulWaitListHandle, ETHVLAN_VID_NODE_S *pstVidNode);
