...
/* super vlan接口最小需要支持的VLAN数量,即一个接口至少需要配置的该数量及其以上的vlan才是super vlan接口 */
...
typedef enum enVlanConsitencyWarningRecoverReason
{
    ...
    VLAN_WARNING_NUM_DECREASE,              /* 告警节点规格调小,包括去使能VLAN一致性监控告警功能,即将告警次数设置为0 */
