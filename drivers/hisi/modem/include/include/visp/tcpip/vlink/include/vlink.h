...
*  2009-06-09   q62011                  Modify for BC3D01667,move VLINKERR_E to vlink.c 
*******************************************************************************/
#ifndef _VLINK_H_
#define _VLINK_H_
...
#define VLINK_SET_RT4_ENTRY(VLINKRTNODE,RTNODE,VLINKNODE,VID)  \
                                         (VOID)VOS_Mem_Zero ((CHAR*)VLINKRTNODE, sizeof(VLINK_RT4_ENTRY_S));\
