...
typedef struct tagVlink6CfgRt
{
    ...
    IN6ADDR_S stIP6Addr;     /* IPv6 Address :主机序*/
} VLINK6_CFG_RT_S; /*IPv6 对端路由配置结构*/

ULONG TCPIP_OpenVlinkRtTable(ULONG *pulWaitListHandle,VLINK_ENTRY_FILTER_S *pstFilter);
ULONG TCPIP_GetVlinkRtEntry(ULONG ulEntryWaitList, VLINK_ROUTE_INFO_S *pstVlinkRtInfo);
ULONG TCPIP_CloseVlinkRtTable( ULONG ulWaitListHandle );
