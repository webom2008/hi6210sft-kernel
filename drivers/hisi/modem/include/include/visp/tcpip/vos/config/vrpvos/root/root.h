...
#if 0
#define	VRP_TASK_SOCK_PRIO			VOS_T_PRIORITY_NORMAL
#endif
...
/*deleted by pengjimei for ipx 2003-05-19
#if( VRP_MODULE_LINK_IPX == VRP_YES )
#define VRP_SOCKTASK_IPX			(1 << 8)
#define VRP_SOCKTASK_RIP			(1 << 9)
#endif
*/
...
#define	VRP_SchedSock( ulTask ) \
{ \
	ulSchedSockFlag |= ulTask; \
	VOS_Ev_Write( ulVRPTID_SOCK, VRP_SOCK_EVENT_DATAREQ ); \
}
#endif
...
#endif
#if 0 /* Added by Suraj as DNS is already regsitered through VRPV5 AppInit Mechanism */
/*Added by wangkaixiong for dns client transplant 8070->VRP 2004-03-29*/
#if (VRP_MODULE_DNS_CLIENT == VRP_YES)
extern ULONG  Dns_Init(VOID);
extern VOID DNS_RegCmd(VOID);
#endif
...
#if 0
extern	VOID	IPX_Intr( VOID );
extern	VOID	RIPSAP_Intr( VOID );
#endif
...
#endif
/*Modified by f54882, for A82D23227, 2008/02/04 */
#if( VRP_MODULE_SAN_RTP == VRP_YES)
