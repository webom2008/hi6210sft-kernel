...
ULONG DumpLastSysTraceToFile( VOS_FILE * pFile, ULONG ulLastNo );
#endif
#endif
/* Modified by f54882, for A82D20473, 2007-09-30 */
#if 0
/* Satya: Systrace is disabled for IO board, to improve the performance. 20040422 */
#if (VRP_YES == VRP_DISTRIBUTED && VRP_YES == VRP_IO_BOARD)
#define SYSTRACE(  ulModuleNo,  ulSrcFileID,  ulPara0,  ulPara1,  ulPara2,  ulPara3 ) 
#else
#define SYSTRACE(  ulModuleNo,  ulSrcFileID,  ulPara0,  ulPara1,  ulPara2,  ulPara3 ) \
			SysTrace(  ulModuleNo,  (ulSrcFileID<<16 |__LINE__),  (ULONG)(ulPara0),  (ULONG)(ulPara1),  (ULONG)(ulPara2), (ULONG)(ulPara3) )
#endif
#else
#define SYSTRACE(  ulModuleNo,  ulSrcFileID,  ulPara0,  ulPara1,  ulPara2,  ulPara3 ) 
#endif
