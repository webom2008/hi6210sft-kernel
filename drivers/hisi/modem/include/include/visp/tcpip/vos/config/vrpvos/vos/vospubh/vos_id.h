...
#if 0
#define SID_IPADDCHECK_S      0x42a  Modified by Housen Wu, 2002-04-16, has defined before;*/
#endif
...
#if 0
#define MID_IP6_ADDR_DADProc      0x046c0000
#endif
...
#if 0
/*guofanglu*/
#define TID_IPC_QOS     54 /* not used in NE80 */
#define TID_IPC_VOS     55 /* for VOR time sync ,don't user by NE80 */
#endif
...
#if 0 /* Multiple redefinitions. Removed by Satya 2004-08-14 */
#if (VRP_MODULE_NATPT == VRP_YES)
#define NATPT_IPC_CHNL_ID   77
#endif
#endif 
...
#if 0
#define WAITLIST_NE80_QOS_ACLIF_TYPE    2001
#define WAITLIST_NE80_QOS_TBL_TYPE      2002    /**added by tshi for QOS_WaitList_TBL**/
#endif
