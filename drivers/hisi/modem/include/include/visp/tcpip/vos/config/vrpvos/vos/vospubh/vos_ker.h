...
#if 0
/* Overriding of VOS_DBGASSERT() in this file is not allowed 
   Satya 2004-08-14 */
#if (VRP_VERSION_RELEASE == VRP_YES)
...
#else
#ifndef VOS_DBGASSERT
#define VOS_DBGASSERT(lExpression)  VOS_Assert((LONG)(lExpression))
#endif
#endif
#else
#define VOS_DBGASSERT(lExpression) \
...
/*Added by x36317 for VISP AutoTest, 2007-11-22*/
