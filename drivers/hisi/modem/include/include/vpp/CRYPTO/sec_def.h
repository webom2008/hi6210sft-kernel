...
/* Commented by Satish to check DOPRA seperation - 2009-08-25
#ifdef SEC_DOPRA
#include "sec_def_dopra.h"
#else
#include <stdio.h>
#include <string.h>
#endif

End by Satish to check DOPRA seperation - 2009-08-25 */
...
//#endif // Satish - 2009-08-25

/*
#if !defined( SEC_DOPRA ) || defined (SEC_NO_VFS)
PSELINKDLL SEC_INT32 SEC_VFS_FileLength(SEC_CHAR* pcfileName);
#endif
*/
#ifdef __cplusplus
}
