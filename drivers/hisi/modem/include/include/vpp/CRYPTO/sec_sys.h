...
// typedef ipsi_time_t SEC_TIME_T; Commented by satish. Moved to ipsi_types.h
...
/*
    Func Name:  SEC_fprintf
*/

/** 
* @defgroup SEC_fprintf
* @ingroup sec_sysFunctions
* @par Prototype
* @code
* SEC_INT32 SEC_fprintf( SEC_FILE_F *pFile, const SEC_CHAR *format, ...);
* @endcode
*
* @par Purpose
* This is used to write to an open file.
*
* @par Description
* SEC_fprintf function writes to an open file. It uses standard 
file functions from dopra library.
*
* @param[in] pFile The file handled to the destination File [N/A]
* @param[in] format The char string giving format as variable Arguments [N/A]
*
* @retval SEC_INT32 The number of bytes written to file [The number of 
character written to file|N/A]
*
* @par Required Header File
* sec_sys.h
*
