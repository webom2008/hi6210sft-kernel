...
#if (OSA_CPU_CCPU == VOS_OSA_CPU)
VOS_UINT32 VOS_DrxCheckTimer( HTIMER *phTm, VOS_UINT32 ulFileID, VOS_UINT32 usLineNo )
{
    VOS_UINT32                i;
    ...
    VOS_ProtectionReboot(VOS_ERRNO_DRXTIME_ERROR_TIMERHANDLE, (VOS_INT)ulFileID, (VOS_INT)usLineNo, VOS_NULL_PTR, VOS_NULL);
