...
/* 获取ADS上行发送保护定时器时长 */
#define ADS_UL_GET_STAT_TIMER_LEN()     (g_stAdsCtx.stAdsIpfCtx.stThresholdStatInfo.ulStatTmrLen)

#define ADS_UL_ADD_STAT_PKT_NUM(n)      (g_stAdsCtx.stAdsIpfCtx.stThresholdStatInfo.ulStatPktNum += n)

#define ADS_UL_GET_STAT_PKT_NUM()       (g_stAdsCtx.stAdsIpfCtx.stThresholdStatInfo.ulStatPktNum)

#define ADS_UL_CLR_STAT_PKT_NUM()       (g_stAdsCtx.stAdsIpfCtx.stThresholdStatInfo.ulStatPktNum = 0)

/* 获取上行数据包水线等级 */
#define ADS_UL_GET_WATER_LEVEL_ONE()    (g_stAdsCtx.stAdsIpfCtx.stThresholdCtrlInfo.stWaterMarkLevel.ulWaterLevel1)

#define ADS_UL_GET_WATER_LEVEL_TWO()    (g_stAdsCtx.stAdsIpfCtx.stThresholdCtrlInfo.stWaterMarkLevel.ulWaterLevel2)

#define ADS_UL_GET_WATER_LEVEL_THREE()  (g_stAdsCtx.stAdsIpfCtx.stThresholdCtrlInfo.stWaterMarkLevel.ulWaterLevel3)

#define ADS_UL_GET_WATER_LEVEL_FOUR()   (g_stAdsCtx.stAdsIpfCtx.stThresholdCtrlInfo.stWaterMarkLevel.ulWaterLevel4)

/* 获取上行赞包门限 */
#define ADS_UL_DATA_THRESHOLD_ONE       (g_stAdsCtx.stAdsIpfCtx.stThresholdCtrlInfo.stThresholdLevel.ulThreshold1)

#define ADS_UL_DATA_THRESHOLD_TWO       (g_stAdsCtx.stAdsIpfCtx.stThresholdCtrlInfo.stThresholdLevel.ulThreshold2)

#define ADS_UL_DATA_THRESHOLD_THREE     (g_stAdsCtx.stAdsIpfCtx.stThresholdCtrlInfo.stThresholdLevel.ulThreshold3)

#define ADS_UL_DATA_THRESHOLD_FOUR      (g_stAdsCtx.stAdsIpfCtx.stThresholdCtrlInfo.stThresholdLevel.ulThreshold4)
...
#endif
    ADS_NV_DYNAMIC_THRESHOLD_STRU       stThresholdCtrlInfo;
