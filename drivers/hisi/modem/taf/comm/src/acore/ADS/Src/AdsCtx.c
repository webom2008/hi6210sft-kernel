...
VOS_VOID ADS_ResetIpfCtx(VOS_VOID)
{
    ...
    /* 默认上行数据统计定时器时长为100ms */
    g_stAdsCtx.stAdsIpfCtx.stThresholdStatInfo.ulStatTmrLen = 100;
    g_stAdsCtx.stAdsIpfCtx.stThresholdStatInfo.ulStatPktNum = 0;
...
{
    VOS_UINT32                          ulRst;
    ADS_NV_DYNAMIC_THRESHOLD_STRU      *pstThreshold;
    ...
    pstThreshold = &g_stAdsCtx.stAdsIpfCtx.stThresholdCtrlInfo;
    ...
    if(NV_OK != ulRst)
    {
        pstThreshold->stWaterMarkLevel.ulWaterLevel1    = 80;
        pstThreshold->stWaterMarkLevel.ulWaterLevel2    = 150;
        pstThreshold->stWaterMarkLevel.ulWaterLevel3    = 500;
        pstThreshold->stWaterMarkLevel.ulWaterLevel4    = 0xFFFFFFFF;

        pstThreshold->stThresholdLevel.ulThreshold1     = 1;
        pstThreshold->stThresholdLevel.ulThreshold2     = 13;
        pstThreshold->stThresholdLevel.ulThreshold3     = 60;
        pstThreshold->stThresholdLevel.ulThreshold4     = 64;
