...
VOS_VOID ADS_ShowULProcStats(VOS_VOID)
{
    ...
    vos_printf("上行赞包门限1                                   %d\n",g_stAdsCtx.stAdsIpfCtx.stThresholdCtrlInfo.stThresholdLevel.ulThreshold1);
    vos_printf("上行赞包门限2                                   %d\n",g_stAdsCtx.stAdsIpfCtx.stThresholdCtrlInfo.stThresholdLevel.ulThreshold2);
    vos_printf("上行赞包门限3                                   %d\n",g_stAdsCtx.stAdsIpfCtx.stThresholdCtrlInfo.stThresholdLevel.ulThreshold3);
    vos_printf("上行赞包门限4                                   %d\n",g_stAdsCtx.stAdsIpfCtx.stThresholdCtrlInfo.stThresholdLevel.ulThreshold4);
