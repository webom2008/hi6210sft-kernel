...
int freadProxy(RFILE_MNTN_HEADER *mnt_h, char * data)
{
    ...
    /*获取读数据的文件指针*/
    fp    = (FILE *)fp_check_file(pread_head->fp);
...
int fwriteProxy(RFILE_MNTN_HEADER *mnt_h, char * data)
{
    ...
    */
    ...
    /*获取fopen时打开的文件操作符*/
    fp = (FILE *)fp_check_file(pwrite_head->fp);
...
int fseekProxy(RFILE_MNTN_HEADER *mnt_h, char * data)
{
    ...
    /*获取fopen时返回的FILE**/
    fp=(FILE *)fp_check_file(pseek_head->fp);
...
int ftellProxy(RFILE_MNTN_HEADER *mnt_h, char * data)
{
    ...
    fp=(FILE *)fp_check_file(ptell_head->fp);
...
int freaddirProxy( RFILE_MNTN_HEADER *mnt_h, char * data )
{
    ...
    pdir = (DRV_DIR_STRU*)fp_check_dir(preaddir_head->dir);
    if (NULL == pdir)
    {
...
int fclosedirProxy( RFILE_MNTN_HEADER *mnt_h, char * data )
{
    ...
    pdir =  (DRV_DIR_STRU *)fp_check_dir(pclosedir_head->dir);
    if (NULL == pdir)
    {
