...
int acm_dump_show(void)
{
	...
	acm_dump_print(	" | 0x0006	|| acm_dump_gps   | acm_dump 0	|| ttyGS6   	|| GPS interface		|| LTE-GPS	|\n"); 
	acm_dump_print(	" | 0x0003	|| acm_dump_app   | acm_dump 1	|| ttyGS5   	|| Application Interface	|| LTE-OM	|\n"); 
	acm_dump_print(	" | 0x0004	|| acm_dump_3gapp | acm_dump 2	|| ttyGS3   	|| 3G Application Interface	|| OM		|\n"); 
	acm_dump_print(	" | 0x0001	|| acm_dump_pcui  | acm_dump 3	|| ttyGS1   	|| 3G PC UI Interface		|| AT		|\n"); 
	acm_dump_print(	" | 0x0000	|| acm_dump_ctrl  | acm_dump 4	|| ttyGS2	|| Control Interface		|| AT-CTRL	|\n"); 
	acm_dump_print(	" | 0x0002	|| acm_dump_bt    | acm_dump 5	|| ttyGS4   	|| Bluetooth Interface		|| cshell     	|\n"); 
	acm_dump_print(	" | NA		|| acm_dump_3ggps | acm_dump 6 	|| ttyGS0 	|| 3G GPS Interface		|| ashell     	|\n"); 
	acm_dump_print(	" |=============================================================================================================|\n"); 
	return NCPY_OK;
}
/*****************************************************************************
...
int acm_dump(int acm_idx)
{
	...
	acm_ncpy = acm_ncopy_get_ctx(acm_idx); 
	if(NULL == acm_ncpy) {
		return NCPY_ERROR;
	}
