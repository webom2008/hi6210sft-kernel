 ...
 * Author: p00223746
 *
 * This software is licensed under the Hisilicon Chipset Verification Dept
 *  
 *
...
#include <linux/chipverification.h>
...
/*******************************************************************************
 Prototype    : Chip_Verification_Set_Debug
 Description  : Set Chip verification Debug Flag
 Input        : DebugFlag
 Output       : None
 Return Value :
...
/*******************************************************************************
 Prototype    : Chip_Verification_Check_Debug
 Description  : Check if inputted module is in the Chip verification Debug Flag
 Input        : ModuleFlag
 Output       : None
 Return Value :
...
/*******************************************************************************
 Prototype    : Chip_Verification_Uart_LB_Test
 Description  : uart loopback test
 Input        : UartIndex
                TxData
                times
 Output       : None
...
/*begin add wangjing for sio*/
/*******************************************************************************
 Prototype    : Chip_Verification_SIO_LB_Test
 Description  : SIO loopback test
 Input        : SIOBusIndex
                SIOTxData
                times
 Output       : None
...
/*end add wangjing for sio*/

/*begin add wangjing for ssi*/
