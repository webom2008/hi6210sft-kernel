...
static void bq2419x_check_battery_full(struct bq2419x_device_info *di)
{
    if(di->battery_present){
...
static ssize_t bq2419x_show_chargelog_head(struct device *dev,
                  struct device_attribute *attr,
                  char *buf)
{
                  ...
                  const char *buf, size_t count)
{
    ...
    di->bat_compohm = (unsigned int)val;
    bq2419x_config_thernal_regulation_reg(di);
                  ...
                  const char *buf, size_t count)
{
    ...
    di->comp_vclampmV = (unsigned int)val;
    bq2419x_config_thernal_regulation_reg(di);
                  ...
                  const char *buf, size_t count)
{
    ...
    hwlog_info("set temp_current_iin = %u\n", input_current_iin);
                  ...
                  const char *buf, size_t count)
{
    ...
    hwlog_info("set temp_current_ichg = %u\n", input_current_ichg);
                           ...
                           const struct i2c_device_id *id)
{
    ...
    charge_class = hw_power_get_class();
    new_dev = device_create(charge_class, NULL, 0, NULL,"charger");
