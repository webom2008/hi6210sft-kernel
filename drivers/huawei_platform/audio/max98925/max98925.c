...
static int max98925_open(struct inode *inode, struct file *filp)
{
	...
	max98925_data->spk_gain = 0x07;//调试阶段使用0dB，算法上去后使用13dB
	...
	regmap_write(max98925_data->regmapL, MAX98925_R020_FORMAT, M98925_DAI_DLY_MASK);
	...
	regmap_write(max98925_data->regmapL, MAX98925_R02C_FILTERS, 0xD8);
