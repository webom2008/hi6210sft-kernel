...
#include "effect_ov13850_liteon_cherry.h"
};
...
//2080x1560, 30fps
	{0, 0, 2080, 1560, 4736, 1786, 30, 30, 0x214, 0x1bb, 0x100, VIEW_FULL, RESOLUTION_4_3, false, false, {ov13850_framesize_quater, ARRAY_SIZE(ov13850_framesize_quater)}, CLK_500M},
//4160x3120, 10fps
...
//4160x3120, 13fps
    {0, 0, 4160, 3120, 5704, 3328, 13, 13, 0x1B0, 0x168, 0xD0, VIEW_FULL, RESOLUTION_4_3, false, false, {ov13850_framesize_fullsize_nonzsl, ARRAY_SIZE(ov13850_framesize_fullsize_nonzsl)}, CLK_500M}
};
...
static int ov13850_check_sensor(void)
{
	...
	ov13850_sensor.vcm = &vcm_dw9714a_param;
...
/* **************************************************************************
  * FunctionName: ov13850_foxconn_dump_reg_debug;
...
static void ov13850_set_default(void)
{
	...
	ov13850_sensor.frmsize_list = ov13850_framesizes;
