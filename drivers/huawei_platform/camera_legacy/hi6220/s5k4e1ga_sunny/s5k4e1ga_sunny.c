...
static effect_params effect_s5k4e1ga_sunny = {
#include "effect_s5k4e1ga_sunny_cherry.h"
};
...
static framesize_s s5k4e1ga_sunny_framesizes[] = {
	{0, 0, 1280, 960, 2982, 1100, 30, 30, 0x14b, 0x113, 0x100, VIEW_FULL, RESOLUTION_4_3, false, false,{s5k4e1ga_sunny_framesize_1280x960, ARRAY_SIZE(s5k4e1ga_sunny_framesize_1280x960)}, CLK_500M },
	...
	{0, 0, 2592, 1952, 2982, 2200, 15, 15, 0x14b, 0x113, 0x100, VIEW_FULL, RESOLUTION_4_3, false, false,{s5k4e1ga_sunny_framesize_full, ARRAY_SIZE(s5k4e1ga_sunny_framesize_full)}, CLK_500M },
};
...
static int s5k4e1ga_sunny_enum_framesizes(struct v4l2_frmsizeenum *framesizes)
{
	...
	u32 this_max_index = ARRAY_SIZE(s5k4e1ga_sunny_framesizes) - 1;
...
{
	int max_index = ARRAY_SIZE(s5k4e1ga_sunny_framesizes) - 1;
				 ...
				 struct v4l2_frmsize_discrete *fs, int flag, camera_setting_view_type view_type,bool zsl_preview)
{
	...
	if (VIEW_FULL == view_type) {
		for (i = 0; i < ARRAY_SIZE(s5k4e1ga_sunny_framesizes); i++) {
	...
	if (i >= ARRAY_SIZE(s5k4e1ga_sunny_framesizes)) {
...
static int s5k4e1ga_sunny_init_reg(void)
{
	...
	print_debug("Enter Function:%s  , initsize=%d",
		    __func__, sizeof(s5k4e1ga_sunny_init_regs));
#if 0
         size = CAMERA_MAX_SETTING_SIZE;
	s5k4e1ga_sunny_write_isp_seq(sensor->effect->isp_settings, size);
#endif
	...
	size = ARRAY_SIZE(s5k4e1ga_sunny_init_regs);
...
static int s5k4e1ga_sunny_framesize_switch(camera_state state)
{
	...
	if (next_frmsize_index >= ARRAY_SIZE( s5k4e1ga_sunny_framesizes)){
...
/* **************************************************************************
  * FunctionName: s5k4e1ga_sunny_dump_reg_debug;
...
static void s5k4e1ga_sunny_set_default(void)
{
	...
	s5k4e1ga_sunny_sensor.frmsize_list = s5k4e1ga_sunny_framesizes;
...
//	s5k4e1ga_sunny_sensor.set_vts_change =  s5k4e1ga_sunny_set_vts_change;
	...
	s5k4e1ga_sunny_sensor.old_flip = 0;
	s5k4e1ga_sunny_sensor.effect = &effect_s5k4e1ga_sunny;
