 ...
 *
 *
 * File Name     : hwifi_regdb.c
 * Version       : Initial Draft
 * Author        : Hongjiujin HKF74032
 * Created       : 2012/11/1
 * Last Modified :
 * Description   : hwifi regulatory table
                   Notice:
                   hwifi_regdb.c generated by Linux_src/net/wireless/genregdb.awk
                   Usage:genregdb.awk db.txt >>XXX_regdb.c
                   db.txt from http://git.kernel.org/cgit/linux/kernel/git/linville/wireless-regdb.git/tree/db.txt
 * Function List :
 * History       :
 * 1.Date        : 2013/9/5
 *   Author      : hongjiujin hkf74032
