...
struct drv_hkadc_map g_hkadc_chan_map[] = {
    {HKADC_TEMP_BATTERY,		(unsigned int)HKADC_CHAN_INVALID,   en_NV_Item_BATTERY_TEMP_ADC,        28, 0, "battery"},
    {HKADC_TEMP_PA0,			(unsigned int)HKADC_CHAN_INVALID,   en_NV_Item_PA_TEMP_SENSOR_TABLE, 32, 0, "pa0"},
    {HKADC_TEMP_PA1,			(unsigned int)HKADC_CHAN_INVALID,   en_NV_Item_PA_TEMP_SENSOR_TABLE, 32, 1, "pa1"},
    {HKADC_TEMP_DCXO0,		(unsigned int)HKADC_CHAN_INVALID,   en_NV_Item_XO_TEMP_SENSOR_TABLE, 32, 0, "dcxo_0"},
...
//    {HKADC_TEMP_DCXO0_LOW,	HKADC_CHAN_INVALID,   en_NV_Item_XO_TEMP_SENSOR_TABLE,  32, 0, "dcxo_0_low"},
    {HKADC_TEMP_DCXO1,		(unsigned int)HKADC_CHAN_INVALID,   en_NV_Item_XO_TEMP_SENSOR_TABLE,  32, 1, "dcxo_1"},
