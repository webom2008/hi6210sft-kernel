...
static int hi6402es_rr_read(struct file *file, char __user *user_buf,
...
static int hi6402es_rr_write(struct file *file, const char __user *user_buf, size_t count, loff_t *ppos)
{
	char *kn_buf = NULL;
...
module_platform_driver(hi6402es_irq_driver);
