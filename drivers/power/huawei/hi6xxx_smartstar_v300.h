...
#define SMARTSTAR_NV_SAVE_SUCCESS  SOC_SMART_CLJ_RESERVED5_ADDR(0)  //use bit 0
#define SMARTSTAR_NV_READ_SUCCESS SOC_SMART_CLJ_RESERVED5_ADDR(0) //use bit 1
#define IGNORE_DELTA_RC_SCENE 0x23
#define USE_DELTA_RC_SCENE 0x00
#define SMARTSTAR_DELTA_RC_SCENE  SOC_SMART_CLJ_RESERVED6_ADDR(0)
#define SMARTSTAR_BATTERY_MOVE_ADDR  SOC_SMART_CLJ_RESERVED1_ADDR(0)
#define SMARTSTAR_SAVE_OCV_ADDR SOC_SMART_CLJ_RESERVED3_ADDR(0)
#define SMARTSTAR_DEBUG_REG SOC_SMART_CLJ_DEBUG_ADDR(0)
#define SMARTSTAR_OCV_TEMP_ADDR   SOC_SMART_CLJ_RESERVED2_ADDR(0)
...
#define DCXO_600          0
#define DCXO_586          1
#define NV_READ_BITMASK 0x02
#define NV_SAVE_BITMASK 0x01
