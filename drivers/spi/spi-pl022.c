...
static unsigned long peri_ctrl_base = 0;
static void  dwc_ssp_enable_clk(int enable)
{
	u32 gt_clk_ssp_value        = 0;
	u32 gt_clk_ssp_en_addr      = 0;
	u32 gt_clk_ssp_dis_addr     = 0;
	u32 gt_clk_ssp_stat_addr    = 0;
...
static void  dwc_ssp_dereset_controller(void)
{
	...
	u32 ssp_reset_ctrl_en_addr      = 0;
	u32 ssp_reset_ctrl_dis_addr     = 0;
	u32 ssp_reset_ctrl_stat_addr    = 0;
	

	peri_ctrl_base = (unsigned long)ioremap(SOC_PERI_SCTRL_BASE_ADDR, 0x1000);
	if (!peri_ctrl_base){
