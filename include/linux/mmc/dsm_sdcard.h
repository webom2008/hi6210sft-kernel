...
enum DSM_SDCARD_STATUS
{
	...
	DSM_SDCARD_REPORT_UEVENT 	= 15,
	DSM_SDCARD_CMD_MAX,
};

enum DSM_SDCARD_ERR
{
	DSM_SDCARD_CMD2_RESP_ERR 		= 24000,
	DSM_SDCARD_CMD3_RESP_ERR 		= 24001,
	DSM_SDCARD_CMD6_RESP_ERR        = 24002,
	DSM_SDCARD_CMD7_RESP_ERR 		= 24003,
	DSM_SDCARD_CMD8_RESP_ERR 		= 24004,
	DSM_SDCARD_CMD9_RESP_ERR 		= 24005,
	DSM_SDCARD_CMD55_RESP_ERR		= 24006,
	DSM_SDCARD_ACMD41_RESP_ERR		= 24007,
	DSM_SDCARD_NO_UEVENT_REPORT		= 24008,
};
