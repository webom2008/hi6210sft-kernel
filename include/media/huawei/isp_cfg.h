...
{
    int                                         buf_queue_size; 
    uint32_t                               		stream_type : 2; 
    uint32_t                               		stream_direction : 2; 
    int                                         fd_ispstream; 
...
typedef struct _tag_hwisp_stream_buf_info
{
    compat_caddr_t                              user_buffer_handle; 

    compat_ulong_t                               y_addr_phy;
    compat_ulong_t                               u_addr_phy;
    compat_ulong_t                               v_addr_phy;

    compat_ulong_t                               y_addr_iommu;
    compat_ulong_t                               u_addr_iommu;
    compat_ulong_t                               v_addr_iommu;

    int											ion_fd;
	compat_caddr_t								ion_vc_hdl;
	compat_caddr_t								ion_vaddr;
