...
enum hissc_jack_states {
	...
	HISSC_JACK_BIT_HEADSET_NO_MIC = 2, /* pluged without mic */
	HISSC_JACK_BIT_HEADPHONE = 3, /* pluged with 3 pole */
...
#define JACK_RPT_MSK_HDS (SND_JACK_HEADSET)
...
static const struct snd_soc_dapm_route hissc_route_map[] =
{
	...
	{"S1_IF_RX_ENA MIXER",          "ADC_LR",                             "I2S1_2_3 INPUT"},
	{"S1_IF_RX_ENA MIXER",          "DAC_LR",                             "I2S1_2_3 INPUT"},
	{"S1_IF_TX_ENA MIXER",          "FM_L",                                  "I2S1_2_3 INPUT"},
	{"S1_IF_TX_ENA MIXER",          "FM_R",                                  "I2S1_2_3 INPUT"},
	{"S1_IF_CLK_EN PGA",             NULL,                  "S1_IF_TX_ENA MIXER"},
	{"S1_IF_CLK_EN PGA",             NULL,                  "S1_IF_RX_ENA MIXER"},
	{"I2S1_2_3 OUTPUT",               NULL,                  "S1_IF_CLK_EN PGA"},
	{"S2_IF_TX_ENA MIXER",          "VOICE_UL",        "I2S1_2_3 INPUT"},
	{"S2_IF_TX_ENA MIXER",          "VOICE_UR",       "I2S1_2_3 INPUT"},
	{"S2_IF_RX_ENA MIXER",         "DACL",                "I2S1_2_3 INPUT"},
	{"S2_IF_RX_ENA MIXER",         "VOICE_DLINK",   "I2S1_2_3 INPUT"},
	{"S2_IF_CLK_EN PGA",             NULL,                  "S2_IF_TX_ENA MIXER"},
	{"S2_IF_CLK_EN PGA",             NULL,                  "S2_IF_RX_ENA MIXER"},
	{"I2S1_2_3 OUTPUT",               NULL,                  "S2_IF_CLK_EN PGA"},
	{"S3_IF_TX_ENA MIXER",          "VOICE_UP",       "I2S1_2_3 INPUT"},
	{"S3_IF_RX_ENA MIXER",          "VOICE_DL",        "I2S1_2_3 INPUT"},
	{"S3_IF_RX_ENA MIXER",          "VOICE_DR",       "I2S1_2_3 INPUT"},
...
static inline int hissc_hkadc_read(struct snd_soc_codec *codec)
{
	...
	DRV_HKADC_GET_TEMP(HKADC_TEMP_CODEC, &priv->adc_voltage, NULL, 0);
...
static int hs_plug_in_detect_func(struct snd_soc_codec *codec)
{
	...
	if ((HISSC_JACK_BIT_NONE != priv->hs_status) && (priv->hs_status != priv->old_hs_status)) {
		...
		/*report headset info */
		logi("report plugin, hs_status=0x%x\n", priv->hs_status);
...
static int hs_plug_out_detect_func(struct snd_soc_codec *codec)
{
	...
	/*report headset info */
	logi("report plugout, hs_status=0x%x\n", priv->hs_status);
	switch_set_state(&priv->hs_jack->sdev, priv->hs_status);
...
static int hissc_suspend(struct platform_device *dev, pm_message_t state)
{
	...
	if (0 == priv->ibias_work) {
		...
		ret = hissc_reg_read(g_codec,HISSC_IF_CLK_EN_CFG_ADDR);
		if (ret & 0x110100) {
...
static int hissc_soc_init(struct snd_soc_codec *codec)
{
	...
	/* ABB reset */
	hissc_set_reg_bits(HISSC_PSCTRL_CLKEN12_ADDR, 0x1 << HISSC_CODEC_SOC_BIT_START);
	usleep_range(100,150);
	...
	logi("CLKEN12=0x%x, CLKEN1=0x%x, RSTDIS=0x%x",
		hissc_reg_read(g_codec, 0x1<<HISSC_CODEC_SOC_BIT_START) ,
		hissc_reg_read(g_codec, 0x1<<HISSC_CLKEN1_DIGACODEC_BIT_START) ,
		hissc_reg_read(g_codec, 0x1<<HISSC_RSTDIS1_DIGACODE_BIT_START));
